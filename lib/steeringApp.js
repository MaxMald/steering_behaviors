...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_9, uiBox_2, uiLabel_3, uiSlider_1, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIForceSeek = (function (_super) {
        ...
        function UIForceSeek(_scene, _force) {
            ...
            title.setTint(stEnums_9.ST_COLOR_ID.kGold);
            _this._m_title = title;
            box.add(title);
...
define("managers/uiManager/uiControllers/UIForceFactory", ["require", "exports", "commons/stEnums", "managers/uiManager/uiControllers/UIForceSeek"], function (require, exports, stEnums_10, UIForceSeek_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIForceFactory = (function () {
        function UIForceFactory() {
            ...
            aFactories.set(stEnums_10.ST_STEER_FORCE.kSeek, this.createUIForceSeek);
            return;
        }
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceFactory"], function (require, exports, stEnums_11, uiBox_3, uiComboBox_1, uiImage_1, uiLabel_4, uiSlider_2, uiSpeedometer_1, UIController_2, UIForceFactory_1) {
    ...
    var UIForceController = (function (_super) {
        ...
        function UIForceController(_x, _y, _scene, _target) {
            ...
            actorName.setTint(stEnums_11.ST_COLOR_ID.kGold);
            box.add(actorName);
            ...
            _this._ui_actualSpeed.setTint(stEnums_11.ST_COLOR_ID.kSkyBlueNeon);
            box.add(_this._ui_actualSpeed);
            _this._ui_maxSpeed = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "#");
            _this._ui_maxSpeed.setTint(stEnums_11.ST_COLOR_ID.kSkyBlueNeon);
            ...
            _this._ui_mass.setTint(stEnums_11.ST_COLOR_ID.kSkyBlueNeon);
        ...
        UIForceController.prototype.setTarget = function (_actor) {
            ...
            var forceController = _actor.getComponent(stEnums_11.ST_COMPONENT_ID.kForceController);
...
define("managers/uiManager/uiControllers/UIMessageBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIDialogBox"], function (require, exports, stEnums_12, uiBox_4, uiButton_1, uiText_1, UIDialogBox_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIMessageBox = (function (_super) {
        ...
        UIMessageBox.CreateAccept = function (_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_12.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        UIMessageBox.CreateYesNo = function (_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_12.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_12.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("scenes/sims/devMax", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_1, stEnums_13, cmpforceController_1, cmpSpriteController_1, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_4, forceSeek_1) {
    ...
    var ScnDevMax = (function (_super) {
        ...
        ScnDevMax.prototype.create = function () {
            ...
            var simManager = master.getManager(stEnums_13.ST_MANAGER_ID.kSimManager);
            ...
            shipActor.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            targetActor.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            var seek = new forceSeek_1.SeekForce();
            seek.init(shipSprite, targetSprite, 125);
            var forceControl = shipActor.getComponent(stEnums_13.ST_COMPONENT_ID.kForceController);
            ...
            var uiManager = master.getManager(stEnums_13.ST_MANAGER_ID.kUIManager);
        ...
        ScnDevMax.prototype.update = function (_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            return;
        };
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_14, master_5, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var FollowPathForce = (function () {
        ...
        FollowPathForce.prototype.init = function (_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_5.Master.GetInstance().getManager(stEnums_14.ST_MANAGER_ID.kDebugManager);
        ...
        FollowPathForce.prototype.updateDebug = function (_dt) {
            ...
            var radius = this.m_radius;
            for (var i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, 3, stEnums_14.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, 3, stEnums_14.ST_COLOR_ID.kPurple);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, 3, stEnums_14.ST_COLOR_ID.kPurple);
                }
            }
            return;
        };
        ...
        FollowPathForce.prototype.getType = function () {
            return stEnums_14.ST_STEER_FORCE.kFollowPath;
        };
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_15, master_6) {
    ...
    var PursueForce = (function () {
        ...
        PursueForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawLine(this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, this._m_v2_actualVelocity.x + pos.x, this._m_v2_actualVelocity.y + pos.y, 3, stEnums_15.ST_COLOR_ID.kRed);
            debugManager.drawLine(pos.x, pos.y, this._m_v2_forceMagnitude.x + pos.x, this._m_v2_forceMagnitude.y + pos.y, 3, stEnums_15.ST_COLOR_ID.kBlue);
            debugManager.drawLine(pos.x, pos.y, this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, 3, stEnums_15.ST_COLOR_ID.kBlack);
            var target = this._m_target;
            debugManager.drawCircle(target.x + this._m_targetDir.x, target.y + this._m_targetDir.y, 5, 2, stEnums_15.ST_COLOR_ID.kYellow);
            return;
        };
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_7, stEnums_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var WanderForce = (function () {
        ...
        WanderForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_16.ST_COLOR_ID.kPurple);
            ...
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_16.ST_COLOR_ID.kBlack);
            var displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_16.ST_COLOR_ID.kRed);
            return;
        };
        ...
        WanderForce.prototype.getType = function () {
            return stEnums_16.ST_STEER_FORCE.kWander;
        };
...
define("scenes/sims/devSumano", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, baseActor_2, stEnums_17, cmpforceController_2, cmpSpriteController_2, master_8, forceFollowPath_1) {
    ...
    var ScnDevSumano = (function (_super) {
        ...
        ScnDevSumano.prototype.create = function () {
            ...
            fleeActor0.init();
            pursueActor0.init();
            pursueActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetMaxSpeed, 100);
            fleeActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetMaxSpeed, 80);
            pursueActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.125, 0.125));
            fleeActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            pursueActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.45));
            fleeActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.55));
            fleeActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetMass, 75);
            pursueActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetMass, 75);
            var forceControlP = pursueActor0.getComponent(stEnums_17.ST_COMPONENT_ID.kForceController);
            var forceControlF = fleeActor0.getComponent(stEnums_17.ST_COMPONENT_ID.kForceController);
            ...
            pathActor6.init();
            pathActor7.init();
            pathActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor1.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor2.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor3.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor4.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor5.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor6.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor7.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor0.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.1));
            pathActor1.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.33, height * 0.5));
            pathActor2.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.9));
            pathActor3.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            pathActor4.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.8));
            pathActor5.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.9));
            pathActor6.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.1));
            pathActor7.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.33));
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_9, stEnums_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ArrivalForce = (function () {
        ...
        ArrivalForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawCircle(target.x, target.y, this._m_slowingRadius, 2, stEnums_18.ST_COLOR_ID.kPurple);
...
define("scenes/sims/devAlex", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceArrival", "steeringBehavior/forceWander"], function (require, exports, baseActor_3, stEnums_19, cmpforceController_3, cmpSpriteController_3, master_10, forceArrival_1, forceWander_1) {
    ...
    var ScnDevAlex = (function (_super) {
        ...
        ScnDevAlex.prototype.create = function () {
            ...
            shipActor.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            shipActor.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            ...
            var shipControl = shipActor.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var targetControl = targetActor.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneArrival", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiButton", "master/master", "steeringBehavior/forceArrival"], function (require, exports, baseActor_4, stEnums_20, cmpforceController_4, cmpSpriteController_4, uiButton_2, master_11, forceArrival_2) {
    ...
    var ScnArrival = (function (_super) {
        ...
        ScnArrival.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_20.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_20.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            ...
            shipActor.sendMessage(stEnums_20.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            var targetSprite = this.add.sprite(0, 0, 'space_ship');
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_20.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_20.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            targetActor.sendMessage(stEnums_20.ST_MESSAGE_ID.kSetMass, 1);
            targetActor.sendMessage(stEnums_20.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
...
define("scenes/sims/sceneWander", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiButton", "master/master", "steeringBehavior/forceWander"], function (require, exports, baseActor_5, stEnums_21, cmpforceController_5, cmpSpriteController_5, uiButton_3, master_12, forceWander_2) {
    ...
    var ScnWander = (function (_super) {
        ...
        ScnWander.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            shipActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            ...
            var shipController = shipActor.getComponent(stEnums_21.ST_COMPONENT_ID.kForceController);
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_13, stEnums_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ObstacleAvoidanceForce = (function () {
        ...
        ObstacleAvoidanceForce.prototype.init = function (_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_13.Master.GetInstance().getManager(stEnums_22.ST_MANAGER_ID.kDebugManager);
        };
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiButton", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, baseActor_6, stEnums_23, cmpforceController_6, cmpSpriteController_6, uiButton_4, master_14, forceObstacleAvoidance_1, forceWander_3) {
    ...
    var ScnObstacleAvoidance = (function (_super) {
        ...
        ScnObstacleAvoidance.prototype.create = function () {
            ...
            shipActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            ...
            obstacleActor6.init();
            obstacleActor7.init();
            obstacleActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor1.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor2.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor3.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor4.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor5.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor6.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor7.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor1.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor2.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor3.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor4.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor5.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor6.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor7.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            var obstacle0Controller = obstacleActor0.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            var obstacle1Controller = obstacleActor1.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            var obstacle2Controller = obstacleActor2.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            var obstacle3Controller = obstacleActor3.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            var obstacle4Controller = obstacleActor4.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            var obstacle5Controller = obstacleActor5.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            var obstacle6Controller = obstacleActor6.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            var obstacle7Controller = obstacleActor7.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
