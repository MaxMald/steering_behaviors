...
define("components/cmpInteractiveActor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_8, master_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.cmpInteractiveActor = void 0;
    class cmpInteractiveActor {
        constructor() {
            const master = master_3.Master.GetInstance();
...
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_9, master_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SeekForce {
        init(_self, _target, _force, _controller) {
            ...
            let master = master_4.Master.GetInstance();
...
define("components/cmpShipPropulsor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_10, master_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiComboBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabelBox", "managers/uiManager/uiObject"], function (require, exports, stEnums_13, uiLabelBox_1, uiObject_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_6, stEnums_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceArrival", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_15, uiBox_2, uiLabel_2, uiSlider_1, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceEvade", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_16, master_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_17, master_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        init(_self, _target, _maxForceMagnitude) {
            ...
            this._m_targetVelocity = new Phaser.Math.Vector2();
            this._m_steerForce = new Phaser.Math.Vector2();
            this._m_debugManager = master_8.Master.GetInstance().getManager(stEnums_17.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
...
define("managers/uiManager/uiControllers/UIForceEvade", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_18, uiBox_3, uiLabel_3, uiSlider_2, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForcePursuit", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_19, uiBox_4, uiLabel_4, uiSlider_3, UIForce_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_9, stEnums_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_9.Master.GetInstance().getManager(stEnums_20.ST_MANAGER_ID.kDebugManager);
        }
        setController(_controller) {
            this._m_controller = _controller;
            return;
...
define("managers/uiManager/uiControllers/UIForceObstacleAvoidance", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_21, uiBox_5, uiLabel_5, uiSlider_4, UIForce_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_22, uiBox_6, uiLabel_6, uiSlider_5, UIForce_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_10, stEnums_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        init(_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_10.Master.GetInstance().getManager(stEnums_23.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
...
define("managers/uiManager/uiControllers/UIForceWander", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_24, uiBox_7, uiLabel_7, uiSlider_6, UIForce_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceEvade", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceObstacleAvoidance", "managers/uiManager/uiControllers/UIForceSeek", "managers/uiManager/uiControllers/UIForceWander"], function (require, exports, stEnums_25, uiBox_8, uiComboBox_1, uiImage_1, uiLabel_8, uiSlider_7, uiSpeedometer_1, UIController_1, UIForceArrival_1, UIForceEvade_1, UIForcePursuit_1, UIForceObstacleAvoidance_1, UIForceSeek_1, UIForceWander_1) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_x, _y, _scene, _target) {
            ...
            this._ui_box = box;
            box.setElementsGap(7.5);
            const actorName = uiLabel_8.UILabel.CreateStyleA(0, 0, _scene, "", 32);
            this._ui_actorName = actorName;
            actorName.setTint(stEnums_25.ST_COLOR_ID.kGold);
            box.add(actorName);
            ...
            box.add(speedometer);
            this._ui_actualSpeed = uiLabel_8.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_actualSpeed.setTint(stEnums_25.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_actualSpeed);
            this._ui_maxSpeed = uiLabel_8.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_maxSpeed.setTint(stEnums_25.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_maxSpeed);
            this._ui_maxSpeedSlider = new uiSlider_7.UISlider(0, 0, _scene, 1, 300);
            ...
            this._ui_mass = uiLabel_8.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_mass.setTint(stEnums_25.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_mass);
            this._ui_massSlider = new uiSlider_7.UISlider(0, 0, _scene, 1, 10);
            ...
            const steerTitle = uiLabel_8.UILabel.CreateStyleB(0, 0, _scene, "Steer Force", 25);
            box.add(steerTitle);
            box.add(new uiImage_1.UIImage(0, 0, _scene, "game_art", "separator_a.png"));
            steerTitle.setTint(stEnums_25.ST_COLOR_ID.kGold);
            const selectForce = uiLabel_8.UILabel.CreateStyleB(0, 0, _scene, "Select Steer Force");
            selectForce.setTint(stEnums_25.ST_COLOR_ID.kSkyBlueNeon);
            box.add(selectForce);
            ...
            this._addUIForce(stEnums_25.ST_STEER_FORCE.kSeek, new UIForceSeek_1.UIForceSeek(_scene));
            this._addUIForce(stEnums_25.ST_STEER_FORCE.kArrive, new UIForceArrival_1.UIForceArrival(_scene));
            this._addUIForce(stEnums_25.ST_STEER_FORCE.kPursue, new UIForcePursuit_1.UIForcePursuit(_scene));
            this._addUIForce(stEnums_25.ST_STEER_FORCE.kEvade, new UIForceEvade_1.UIForceEvade(_scene));
            this._addUIForce(stEnums_25.ST_STEER_FORCE.kWander, new UIForceWander_1.UIForceWander(_scene));
            this._addUIForce(stEnums_25.ST_STEER_FORCE.kObstacleAvoidance, new UIForceObstacleAvoidance_1.UIForceObstacleAvoidance(_scene));
            this.setTarget(undefined);
            return;
        }
        update() {
        ...
        setTarget(_actor) {
            ...
            const forceController = _actor.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_9, uiLabel_9, UIController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIDialogBox extends UIController_2.UIController {
        constructor(_x, _y, _scene, _title) {
            super();
            const box = uiBox_9.UIBox.CreateBorderBoxB(_x, _y, _scene);
            this._m_box = box;
            const title = uiLabel_9.UILabel.CreateH1(0, 0, _scene, _title);
            this._m_title = title;
            box.add(title);
            box.setCenterAlignment();
            return;
...
define("managers/uiManager/uiControllers/UIMessageBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton", "managers/uiManager/uiButtonImg", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIDialogBox"], function (require, exports, stEnums_26, uiBox_10, uiButton_2, uiButtonImg_1, uiText_1, UIDialogBox_1) {
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            const buttonsBox = uiBox_10.UIBox.CreateContentBoxB(0, 0, _scene);
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_26.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_26.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_26.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_27, master_11, uiBox_11, uiButtonImg_2, uiImage_2, uiLabel_10, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title, _target) {
            super();
            const box = uiBox_11.UIBox.CreateBorderBox(_x, _y, _scene);
            box.setAnchor(0.5, 0);
            this._m_box = box;
            ...
            this._m_boxTitle = uiLabel_10.UILabel.CreateStyleA(0, 0, _scene, this._ui_boxTitle, 32);
            this._m_boxTitle.setTint(stEnums_27.ST_COLOR_ID.kGold);
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox.m_master = master_11.Master.GetInstance();
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_27.ST_MANAGER_ID.kSimManager);
            const buttonsBox = uiBox_11.UIBox.CreateContentBoxB(0, 0, _scene);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_27.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_27.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_27.ST_SIM_SATE.kPaused) {
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_28, master_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ForceConstant {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_28.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_28.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_28.ST_STEER_FORCE.kConstant;
        }
        setRelative() {
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forceSeek"], function (require, exports, stEnums_29, shipFactory_1, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_13, forceConstant_1, forceSeek_1) {
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            const targetFController = targetActor.getComponent(stEnums_29.ST_COMPONENT_ID.kForceController);
            ...
            targetActor.sendMessage(stEnums_29.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_29.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_29.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            ...
            let forceControl = blueShip.getComponent(stEnums_29.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_30, shipFactory_2, uiButton_3, UIForceController_2, UISimulationController_2, master_14, forceArrival_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnArrival extends Phaser.Scene {
        create() {
            ...
            shipActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_2.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 50);
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_31, shipFactory_3, uiButton_4, UIForceController_3, UISimulationController_3, master_15, forceWander_1) {
    ...
    class ScnWander extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            let simManager = master.getManager(stEnums_31.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_31.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            let wander = new forceWander_1.WanderForce();
            wander.init(shipActor.getWrappedInstance(), 75, 25, 5, 45, 100);
            let shipController = shipActor.getComponent(stEnums_31.ST_COMPONENT_ID.kForceController);
            ...
            const uiManager = master.getManager(stEnums_31.ST_MANAGER_ID.kUIManager);
            uiManager.addUIController("forceUI", uiForceController);
            uiManager.addUIController("mediaSimUI", uiSimController);
            uiManager.setTarget(shipActor);
            this._m_master.enableDebugging();
...
define("scenes/sims/sceneEvade", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceEvade", "steeringBehavior/forceSeek"], function (require, exports, stEnums_32, shipFactory_4, UIForceController_4, UIMessageBox_2, UISimulationController_4, master_16, forceEvade_1, forceSeek_2) {
    ...
    class SceneEvade extends Phaser.Scene {
        create() {
            ...
            targetActor.sendMessage(stEnums_32.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            const blueShip = shipFactory_4.ShipFactory.CreateBlueShip(this, "Blue Ship");
            simManager.addActor(blueShip);
            const blueFController = blueShip.getComponent(stEnums_32.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_33, shipFactory_5, uiButton_5, UIForceController_5, UISimulationController_5, master_17, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            ...
            obstacleActor0.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            let obstacle0Controller = obstacleActor0.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            let obstacle1Controller = obstacleActor1.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            let obstacle2Controller = obstacleActor2.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            let obstacle3Controller = obstacleActor3.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            let obstacle4Controller = obstacleActor4.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            let obstacle5Controller = obstacleActor5.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            let obstacle6Controller = obstacleActor6.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            let obstacle7Controller = obstacleActor7.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            ...
            const uiForceController = new UIForceController_5.UIForceController(20, 20, this);
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_34, forceSeek_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_35, shipFactory_6, uiButton_6, UISimulationController_6, master_18, forceFlee_1) {
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_35.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_35.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_35.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_6.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_35.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_35.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
...
define("scenes/sims/scenePursuit", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forcePursue"], function (require, exports, stEnums_36, shipFactory_7, UIForceController_6, UIMessageBox_3, UISimulationController_7, master_19, forceConstant_2, forcePursue_1) {
    ...
    class ScenePursuit extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(blueShip);
            const blueFController = blueShip.getComponent(stEnums_36.ST_COMPONENT_ID.kForceController);
            ...
            const uiForceController = new UIForceController_6.UIForceController(20, 20, this);
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_37, debugManager_2, master_20, forceSeek_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        init(_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_20.Master.GetInstance().getManager(stEnums_37.ST_MANAGER_ID.kDebugManager);
        ...
        updateDebug(_dt) {
            ...
            let radius = this.m_radius;
            for (let i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, debugManager_2.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_37.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_37.ST_COLOR_ID.kBlue);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_37.ST_COLOR_ID.kBlue);
                }
            }
            return;
        }
        ...
        getType() {
            return stEnums_37.ST_STEER_FORCE.kFollowPath;
        }
        getMaxMagnitude() {
