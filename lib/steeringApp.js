...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_27, master_12, uiBox_11, uiButtonImg_2, uiImage_2, uiLabel_10, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox.m_master = master_12.Master.GetInstance();
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_28, master_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("factories/ambienceFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpSpriteController"], function (require, exports, baseActor_2, stEnums_37, cmpforceController_2, cmpInteractiveActor_2, cmpSpriteController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class AmbienceFactory {
        static CreateSatellite(_x, _y, _scene, _name) {
            ...
            actor.init();
            actor.sendMessage(stEnums_37.ST_MESSAGE_ID.kPlayAnimation, "satellite_a");
            actor.sendMessage(stEnums_37.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(_x, _y));
            return actor;
        }
    }
    exports.AmbienceFactory = AmbienceFactory;
});
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek", "master/master"], function (require, exports, stEnums_38, forceSeek_4, master_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        init(_self, _force, _radius, _looping) {
            ...
            const master = master_21.Master.GetInstance();
            this._m_debugManager = master.getManager(stEnums_38.ST_MANAGER_ID.kDebugManager);
            ...
            const seek = new forceSeek_4.SeekForce();
            this._m_seek = seek;
        ...
        updateDebug(_dt) {
            ...
            const forceToPath = this._m_forceToPath;
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + actualVelocity.x + forceToPath.x, self.y + actualVelocity.y + forceToPath.y, 2, stEnums_38.ST_COLOR_ID.kYellow);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        getType() {
            return stEnums_38.ST_STEER_FORCE.kFollowPath;
        }
        setMaxMagnitude(_magnitude) {
...
define("scenes/sims/sceneFollowPath", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_39, ambienceFactory_1, shipFactory_8, UIForceController_7, UIMessageBox_4, UISimulationController_8, master_22, forceFollowPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SceneFollowPath extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            const simManager = master.getManager(stEnums_39.ST_MANAGER_ID.kSimManager);
            ...
            const blueShipFController = blueShip.getComponent(stEnums_39.ST_COMPONENT_ID.kForceController);
            blueShipFController.addForce("Follow Path", followPath);
            const uiForceController = new UIForceController_7.UIForceController(20, 20, this);
            const uiMessageBox = UIMessageBox_4.UIMessageBox.CreateYesNo(400, 200, this, "Hello World", "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.", function (_buttonKey) {
                return;
            }, this);
            const uiSimController = UISimulationController_8.UISimulationController.CreateSimControlBox(hWidth, 20, this);
