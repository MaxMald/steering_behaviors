...
define("managers/uiManager/uiImage", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_7) {
    ...
    class UIImage extends uiObject_7.UIObject {
...
define("managers/uiManager/uiSlider", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_8) {
    ...
    class UISlider extends uiObject_8.UIObject {
...
define("managers/uiManager/uiControllers/UIForceConstant", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_28, uiBox_9, uiLabel_9, uiSlider_8, UIForce_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_29, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FleeForce extends forceSeek_2.SeekForce {
        ...
        getType() {
            return stEnums_29.ST_STEER_FORCE.kFlee;
        }
    }
    exports.FleeForce = FleeForce;
});
define("managers/uiManager/uiControllers/UIForceFlee", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_30, uiBox_10, uiLabel_10, uiSlider_9, UIForce_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceFlee extends UIForce_9.UIForce {
        ...
        setTarget(_force) {
            this._m_flee = _force;
            if (this._m_flee !== undefined) {
                if (_force.getType() !== stEnums_30.ST_STEER_FORCE.kFlee) {
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceEvade", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceObstacleAvoidance", "managers/uiManager/uiControllers/UIForceSeek", "managers/uiManager/uiControllers/UIForceWander", "managers/uiManager/uiControllers/UIForceFollowPath", "managers/uiManager/uiControllers/UIForceConstant", "managers/uiManager/uiControllers/UIForceFlee"], function (require, exports, stEnums_31, uiBox_11, uiComboBox_1, uiImage_1, uiLabel_11, uiSlider_10, uiSpeedometer_1, UIController_1, UIForceArrival_1, UIForceEvade_1, UIForcePursuit_1, UIForceObstacleAvoidance_1, UIForceSeek_1, UIForceWander_1, UIForceFollowPath_1, UIForceConstant_1, UIForceFlee_1) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_x, _y, _scene, _target) {
            ...
            actorName.setTint(stEnums_31.ST_COLOR_ID.kGold);
            box.add(actorName);
            ...
            this._ui_actualSpeed.setTint(stEnums_31.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_actualSpeed);
            this._ui_maxSpeed = uiLabel_11.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_maxSpeed.setTint(stEnums_31.ST_COLOR_ID.kSkyBlueNeon);
            ...
            this._ui_mass.setTint(stEnums_31.ST_COLOR_ID.kSkyBlueNeon);
            ...
            box.add(steerTitle);
            box.add(new uiImage_1.UIImage(0, 0, _scene, "game_art", "separator_a.png"));
            steerTitle.setTint(stEnums_31.ST_COLOR_ID.kGold);
            ...
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kFlee, new UIForceFlee_1.UIForceFlee(_scene));
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_12, uiLabel_12, UIController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_32.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_32.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_32.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_33, master_14, uiBox_14, uiButtonImg_2, uiImage_2, uiLabel_13, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title, _target) {
            super();
            const box = uiBox_14.UIBox.CreateBorderBox(_x, _y, _scene);
            box.setAnchor(0.5, 0);
            this._m_box = box;
            ...
            this._m_boxTitle = uiLabel_13.UILabel.CreateStyleA(0, 0, _scene, this._ui_boxTitle, 32);
            this._m_boxTitle.setTint(stEnums_33.ST_COLOR_ID.kGold);
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_33.ST_MANAGER_ID.kSimManager);
            const buttonsBox = uiBox_14.UIBox.CreateContentBoxB(0, 0, _scene);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_33.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_33.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_33.ST_SIM_SATE.kPaused) {
                this.m_master.resumeSimulation();
            }
            return;
        }
        _onSimulationStop() {
            if (this._m_simulationManager.getState() !== stEnums_33.ST_SIM_SATE.kStopped) {
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButtonImg", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forceSeek"], function (require, exports, stEnums_34, shipFactory_1, uiButtonImg_3, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_15, forceConstant_1, forceSeek_3) {
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButtonImg_3.UIButtonImg.CreateHomeButtonImg(width * 0.9, height * 0.1, this);
            ...
            let forceControl = blueShip.getComponent(stEnums_34.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButtonImg", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_35, shipFactory_2, uiButtonImg_4, UIForceController_2, UISimulationController_2, master_16, forceArrival_1) {
    ...
    class ScnArrival extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButtonImg_4.UIButtonImg.CreateHomeButtonImg(width * 0.9, height * 0.1, this);
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButtonImg", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_36, shipFactory_3, uiButtonImg_5, UIForceController_3, UISimulationController_3, master_17, forceWander_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnWander extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButtonImg_5.UIButtonImg.CreateHomeButtonImg(width * 0.9, height * 0.1, this);
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
...
define("scenes/sims/sceneEvade", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButtonImg", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceEvade", "steeringBehavior/forceSeek"], function (require, exports, stEnums_37, shipFactory_4, uiButtonImg_6, UIForceController_4, UIMessageBox_2, UISimulationController_4, master_18, forceEvade_1, forceSeek_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SceneEvade extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButtonImg_6.UIButtonImg.CreateHomeButtonImg(width * 0.9, height * 0.1, this);
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButtonImg", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_38, shipFactory_5, uiButtonImg_7, UIForceController_5, UISimulationController_5, master_19, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButtonImg_7.UIButtonImg.CreateHomeButtonImg(width * 0.9, height * 0.1, this);
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButtonImg", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_39, shipFactory_6, uiButtonImg_8, UIForceController_6, UISimulationController_6, master_20, forceFlee_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButtonImg_8.UIButtonImg.CreateHomeButtonImg(width * 0.9, height * 0.1, this);
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
...
define("scenes/sims/scenePursuit", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButtonImg", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forcePursue"], function (require, exports, stEnums_40, shipFactory_7, uiButtonImg_9, UIForceController_7, UIMessageBox_3, UISimulationController_7, master_21, forceConstant_2, forcePursue_1) {
    ...
    class ScenePursuit extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButtonImg_9.UIButtonImg.CreateHomeButtonImg(width * 0.9, height * 0.1, this);
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
...
define("factories/ambienceFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpSpriteController"], function (require, exports, baseActor_2, stEnums_41, cmpforceController_2, cmpInteractiveActor_2, cmpSpriteController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class AmbienceFactory {
        static CreateSatellite(_x, _y, _scene, _name) {
            ...
            actor.init();
            actor.sendMessage(stEnums_41.ST_MESSAGE_ID.kPlayAnimation, "satellite_a");
            actor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(_x, _y));
            return actor;
        }
    }
    exports.AmbienceFactory = AmbienceFactory;
});
define("scenes/sims/sceneFollowPath", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "managers/uiManager/uiButtonImg", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_42, ambienceFactory_1, shipFactory_8, uiButtonImg_10, UIForceController_8, UIMessageBox_4, UISimulationController_8, master_22, forceFollowPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SceneFollowPath extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            const simManager = master.getManager(stEnums_42.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButtonImg_10.UIButtonImg.CreateHomeButtonImg(width * 0.9, height * 0.1, this);
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
            ...
            const blueShipFController = blueShip.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            blueShipFController.addForce("Follow Path", followPath);
            const uiForceController = new UIForceController_8.UIForceController(20, 20, this);
