...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_37, debugManager_2, master_21, forceSeek_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        init(_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_21.Master.GetInstance().getManager(stEnums_37.ST_MANAGER_ID.kDebugManager);
