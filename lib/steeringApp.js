...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_5, stEnums_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ArrivalForce = (function () {
        ...
        ArrivalForce.prototype.updateDebug = function (_dt) {
            ...
            var target = this._m_target;
            debugManager.drawLine(this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, this._m_v2_actualVelocity.x + sprite.x, this._m_v2_actualVelocity.y + sprite.y, 3, stEnums_8.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_8.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(target.x, target.y, this._m_slowingRadius, 2, stEnums_8.ST_COLOR_ID.kPurple);
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_6, stEnums_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var WanderForce = (function () {
        ...
        WanderForce.prototype.updateDebug = function (_dt) {
            var debugManager = this._m_debugManager;
            var sprite = this._m_self;
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_9.ST_COLOR_ID.kPurple);
            debugManager.drawLine(this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, this._m_v2_actualVelocity.x + sprite.x, this._m_v2_actualVelocity.y + sprite.y, 3, stEnums_9.ST_COLOR_ID.kRed);
            ...
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_9.ST_COLOR_ID.kBlack);
            var displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_9.ST_COLOR_ID.kRed);
            return;
        };
...
define("scenes/sims/devAlex", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceArrival", "steeringBehavior/forceWander"], function (require, exports, baseActor_3, stEnums_10, cmpforceController_3, cmpSpriteController_3, master_7, forceArrival_1, forceWander_1) {
    ...
    var ScnDevAlex = (function (_super) {
        ...
        ScnDevAlex.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            ...
            shipActor.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetMass, 10);
            this._m_target_center = new Phaser.Math.Vector2(width * 0.5, height * 0.25);
            this._m_target_position = new Phaser.Math.Vector2();
            var targetSprite = this.add.sprite(0, 0, 'space_ship');
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            targetActor.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetMass, 10);
            ...
            var shipControl = shipActor.getComponent(stEnums_10.ST_COMPONENT_ID.kForceController);
            var targetControl = targetActor.getComponent(stEnums_10.ST_COMPONENT_ID.kForceController);
