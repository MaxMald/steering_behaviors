...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/arrivalInitState"], function (require, exports, master_11, debugManager_3, stEnums_18, arrivalInitState_1) {
    ...
    class ArrivalForce {
        ...
        updateDebug(_dt) {
            ...
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_3.DebugManager.FORCE_LINE_WIDTH, stEnums_18.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(target.x, target.y, this._m_arrivalRadius, debugManager_3.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_18.ST_COLOR_ID.kPurple);
...
define("steeringBehavior/forceEvade", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_20, debugManager_4, master_12, forceInitState_3) {
    ...
    class EvadeForce {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_4.DebugManager.FORCE_LINE_WIDTH, stEnums_20.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            ...
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, debugManager_4.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_20.ST_COLOR_ID.kOrange);
            return;
        }
        onDebugEnable() {
            return;
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_21, debugManager_5, master_13, forceInitState_4) {
    ...
    class PursueForce {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_5.DebugManager.FORCE_LINE_WIDTH, stEnums_21.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            ...
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, debugManager_5.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_21.ST_COLOR_ID.kOrange);
            return;
        }
        onDebugEnable() {
            return;
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/obstacleAvoidanceInitState"], function (require, exports, master_14, debugManager_6, stEnums_24, obstacleAvoidanceInitState_1) {
    ...
    class ObstacleAvoidanceForce {
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, debugManager_6.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_24.ST_COLOR_ID.kPurple);
        }
        onDebugEnable() {
        }
        onDebugDisable() {
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/forceInitState"], function (require, exports, master_15, debugManager_7, stEnums_27, forceInitState_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kPurple);
            ...
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, debugManager_7.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_27.ST_COLOR_ID.kOrange);
            let displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_42, shipFactory_5, uiSceneFactory_5, mapScene_8, master_25, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            obstacleActor0.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            let obstacle0Controller = obstacleActor0.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            let obstacle1Controller = obstacleActor1.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            let obstacle2Controller = obstacleActor2.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            let obstacle3Controller = obstacleActor3.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            let obstacle4Controller = obstacleActor4.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            let obstacle5Controller = obstacleActor5.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            let obstacle6Controller = obstacleActor6.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            let obstacle7Controller = obstacleActor7.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
