...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_7, uiBox_1, uiLabel_1, uiSlider_1, UIController_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIForceController = (function (_super) {
        ...
        function UIForceController(_x, _y, _scene, _target) {
            ...
            if (_target !== undefined) {
                _this.setActor(_target);
            }
            else {
                _this._m_target = undefined;
                _this._m_forceController = undefined;
            }
            var box = new uiBox_1.UIBox(_x, _y, _scene);
            box.setPadding(20);
            box.setElementsGap(5);
            _this._ui_box = box;
            var title = new uiLabel_1.UILabel(0, 0, _scene, "Force Controller", stEnums_7.ST_TEXT_TYPE.H2);
            box.add(title);
            _this._ui_actorName = new uiLabel_1.UILabel(0, 0, _scene, "Name: ", stEnums_7.ST_TEXT_TYPE.Normal);
            box.add(_this._ui_actorName);
            _this._ui_actualSpeed = new uiLabel_1.UILabel(0, 0, _scene, "Speed: 0.0 au/secs.", stEnums_7.ST_TEXT_TYPE.Normal);
            box.add(_this._ui_actualSpeed);
            _this._ui_maxSpeed = new uiLabel_1.UILabel(0, 0, _scene, "Max. Speed: 0.0 au/secs.", stEnums_7.ST_TEXT_TYPE.Normal);
            box.add(_this._ui_maxSpeed);
            _this._ui_maxSpeedSlider = new uiSlider_1.UISlider(0, 0, _scene, 0, 100);
            box.add(_this._ui_maxSpeedSlider);
            _this._ui_mass = new uiLabel_1.UILabel(0, 0, _scene, "Mass: 0.0 tg", stEnums_7.ST_TEXT_TYPE.Normal);
            box.add(_this._ui_mass);
            _this._ui_massSlider = new uiSlider_1.UISlider(0, 0, _scene, 0, 10);
            box.add(_this._ui_massSlider);
            return _this;
        }
        UIForceController.prototype.setActor = function (_actor) {
            if (_actor === undefined) {
            ...
            this._m_forceController = _actor.getComponent(stEnums_7.ST_COMPONENT_ID.kForceController);
            return;
        };
...
define("scenes/sims/devMax", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiControllers/UIForceController", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_1, stEnums_9, cmpforceController_1, cmpSpriteController_1, UIForceController_1, master_4, forceSeek_1) {
    ...
    var ScnDevMax = (function (_super) {
        ...
        ScnDevMax.prototype.create = function () {
            ...
            var uiForceController = new UIForceController_1.UIForceController(20, 20, this, shipActor);
            ...
            var forceControl = shipActor.getComponent(stEnums_9.ST_COMPONENT_ID.kForceController);
        ...
        ScnDevMax.prototype.update = function (_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_9.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            return;
        };
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_10, master_5, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var FollowPathForce = (function () {
        ...
        FollowPathForce.prototype.init = function (_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_5.Master.GetInstance().getManager(stEnums_10.ST_MANAGER_ID.kDebugManager);
        ...
        FollowPathForce.prototype.updateDebug = function (_dt) {
            ...
            var radius = this.m_radius;
            for (var i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, 3, stEnums_10.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, 3, stEnums_10.ST_COLOR_ID.kPurple);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, 3, stEnums_10.ST_COLOR_ID.kPurple);
                }
            }
            return;
        };
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_11, master_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var PursueForce = (function () {
        ...
        PursueForce.prototype.init = function (_self, _target, _force, _predictionSteps, _targetForceCtrl, _controller) {
            ...
            this._m_debugManager = master_6.Master.GetInstance().getManager(stEnums_11.ST_MANAGER_ID.kDebugManager);
            return;
        };
        ...
        PursueForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawLine(this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, this._m_v2_actualVelocity.x + pos.x, this._m_v2_actualVelocity.y + pos.y, 3, stEnums_11.ST_COLOR_ID.kRed);
            debugManager.drawLine(pos.x, pos.y, this._m_v2_forceMagnitude.x + pos.x, this._m_v2_forceMagnitude.y + pos.y, 3, stEnums_11.ST_COLOR_ID.kBlue);
            debugManager.drawLine(pos.x, pos.y, this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, 3, stEnums_11.ST_COLOR_ID.kBlack);
            var target = this._m_target;
            debugManager.drawCircle(target.x + this._m_targetDir.x, target.y + this._m_targetDir.y, 5, 2, stEnums_11.ST_COLOR_ID.kYellow);
            return;
        };
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_7, stEnums_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var WanderForce = (function () {
        ...
        WanderForce.prototype.init = function (_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_7.Master.GetInstance().getManager(stEnums_12.ST_MANAGER_ID.kDebugManager);
            return;
        };
        ...
        WanderForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_12.ST_COLOR_ID.kPurple);
            ...
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_12.ST_COLOR_ID.kBlack);
            var displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_12.ST_COLOR_ID.kRed);
            return;
        };
...
define("scenes/sims/devSumano", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, baseActor_2, stEnums_13, cmpforceController_2, cmpSpriteController_2, master_8, forceFollowPath_1) {
    ...
    var ScnDevSumano = (function (_super) {
        ...
        ScnDevSumano.prototype.create = function () {
            ...
            fleeActor0.init();
            pursueActor0.init();
            pursueActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetMaxSpeed, 100);
            fleeActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetMaxSpeed, 80);
            pursueActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.125, 0.125));
            fleeActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            pursueActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.45));
            fleeActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.55));
            fleeActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetMass, 75);
            pursueActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetMass, 75);
            var forceControlP = pursueActor0.getComponent(stEnums_13.ST_COMPONENT_ID.kForceController);
            var forceControlF = fleeActor0.getComponent(stEnums_13.ST_COMPONENT_ID.kForceController);
            ...
            pathActor6.init();
            pathActor7.init();
            pathActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor1.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor2.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor3.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor4.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor5.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor6.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor7.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor0.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.1));
            pathActor1.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.33, height * 0.5));
            pathActor2.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.9));
            pathActor3.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            pathActor4.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.8));
            pathActor5.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.9));
            pathActor6.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.1));
            pathActor7.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.33));
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_9, stEnums_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ArrivalForce = (function () {
        ...
        ArrivalForce.prototype.init = function (_self, _target, _slowingRadius, _force, _controller) {
            ...
            this._m_debugManager = master_9.Master.GetInstance().getManager(stEnums_14.ST_MANAGER_ID.kDebugManager);
            return;
        };
...
define("scenes/sims/devAlex", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceArrival", "steeringBehavior/forceWander"], function (require, exports, baseActor_3, stEnums_15, cmpforceController_3, cmpSpriteController_3, master_10, forceArrival_1, forceWander_1) {
    ...
    var ScnDevAlex = (function (_super) {
        ...
        ScnDevAlex.prototype.create = function () {
            ...
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            ...
            var shipControl = shipActor.getComponent(stEnums_15.ST_COMPONENT_ID.kForceController);
            var targetControl = targetActor.getComponent(stEnums_15.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneArrival", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceArrival"], function (require, exports, baseActor_4, stEnums_16, cmpforceController_4, cmpSpriteController_4, master_11, forceArrival_2) {
    ...
    var ScnArrival = (function (_super) {
        ...
        ScnArrival.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_16.ST_MESSAGE_ID.kSetSpeed, 75);
            ...
            var width = canvas.width;
            var height = canvas.height;
            shipActor.sendMessage(stEnums_16.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            var targetSprite = this.add.sprite(0, 0, 'space_ship');
            ...
            targetActor.sendMessage(stEnums_16.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
...
define("scenes/sims/sceneWander", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceWander"], function (require, exports, baseActor_5, stEnums_17, cmpforceController_5, cmpSpriteController_5, master_12, forceWander_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_13, stEnums_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ObstacleAvoidanceForce = (function () {
        ...
        ObstacleAvoidanceForce.prototype.init = function (_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_13.Master.GetInstance().getManager(stEnums_18.ST_MANAGER_ID.kDebugManager);
        };
        ...
        ObstacleAvoidanceForce.prototype.updateDebug = function (_dt) {
            var debugManager = this._m_debugManager;
            var sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, 2, stEnums_18.ST_COLOR_ID.kPurple);
        };
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, baseActor_6, stEnums_19, cmpforceController_6, cmpSpriteController_6, master_14, forceObstacleAvoidance_1, forceWander_3) {
    ...
    var ScnObstacleAvoidance = (function (_super) {
        ...
        ScnObstacleAvoidance.prototype.create = function () {
            ...
            obstacleActor6.init();
            obstacleActor7.init();
            obstacleActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor1.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor2.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor3.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor4.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor5.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor6.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor7.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor1.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor2.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor3.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor4.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor5.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor6.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor7.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            var obstacle0Controller = obstacleActor0.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var obstacle1Controller = obstacleActor1.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var obstacle2Controller = obstacleActor2.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var obstacle3Controller = obstacleActor3.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var obstacle4Controller = obstacleActor4.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var obstacle5Controller = obstacleActor5.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var obstacle6Controller = obstacleActor6.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var obstacle7Controller = obstacleActor7.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
