...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_8, uiBox_1, uiLabel_1, uiSlider_1, UIController_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIForceController = (function (_super) {
        ...
        function UIForceController(_x, _y, _scene, _target) {
            ...
            _this._ui_box = box;
            _this._ui_actorName = new uiLabel_1.UILabel(0, 0, _scene, "#", stEnums_8.ST_TEXT_TYPE.H2);
            box.add(_this._ui_actorName);
            _this._ui_actualSpeed = new uiLabel_1.UILabel(0, 0, _scene, "#", stEnums_8.ST_TEXT_TYPE.Normal);
            box.add(_this._ui_actualSpeed);
            _this._ui_maxSpeed = new uiLabel_1.UILabel(0, 0, _scene, "#", stEnums_8.ST_TEXT_TYPE.Normal);
            box.add(_this._ui_maxSpeed);
            _this._ui_maxSpeedSlider = new uiSlider_1.UISlider(0, 0, _scene, 1, 300);
            ...
            _this._ui_mass = new uiLabel_1.UILabel(0, 0, _scene, "#", stEnums_8.ST_TEXT_TYPE.Normal);
            box.add(_this._ui_mass);
            _this._ui_massSlider = new uiSlider_1.UISlider(0, 0, _scene, 1, 10);
        ...
        UIForceController.prototype.setTarget = function (_actor) {
            ...
            var forceController = _actor.getComponent(stEnums_8.ST_COMPONENT_ID.kForceController);
