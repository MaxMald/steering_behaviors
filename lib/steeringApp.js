...
define("steeringBehavior/forceWander", ["require", "exports"], function (require, exports) {
    ...
    var WanderForce = (function () {
        ...
        WanderForce.prototype.init = function (_self, _circleDistance, _circleRadius, _angleChange, _controller) {
            this._m_self = _self;
        ...
        WanderForce.prototype.update = function (_dt) {
            ...
            var speed = controller.getSpeed();
            var self = this._m_self;
            var circleDistance = this._m_circleDistance;
            var circlePos = new Phaser.Math.Vector2(self.x, self.y);
            var tempCircleVector = new Phaser.Math.Vector2(0, 0);
            ...
            var displacement = new Phaser.Math.Vector2(Phaser.Math.RND.integer(), Phaser.Math.RND.integer());
            ...
            var steerForce = new Phaser.Math.Vector2(0, 0);
            var displacementVector = new Phaser.Math.Vector2(circlePos.x + displacement.x, circlePos.y + displacement.y);
...
define("scenes/mainMenu", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "steeringBehavior/forceWander"], function (require, exports, baseActor_1, stEnums_3, cmpforceController_1, cmpSpriteController_1, forceWander_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var MainMenu = (function (_super) {
        ...
        MainMenu.prototype.create = function () {
            ...
            shipActor.sendMessage(stEnums_3.ST_MESSAGE_ID.kSetMass, 10);
            ...
            var seek = new forceWander_1.WanderForce();
            seek.init(shipSprite, 300, 1000, 10);
        ...
        MainMenu.prototype.update = function (_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_3.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            this._m_ship.update();
            return;
        };
        return MainMenu;
