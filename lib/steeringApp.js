...
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_13, debugManager_2, master_8, forceInitState_1) {
    ...
    class SeekForce {
        ...
        updateDebug(_dt) {
            ...
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_13.ST_COLOR_ID.kOrange);
            let actualVelocity = this._m_controller.getVelocity();
            const pX = self.x + actualVelocity.x;
            const pY = self.y + actualVelocity.y;
            this._m_debugManager.drawLine(pX, pY, pX + this._m_seekForce.x, pY + this._m_seekForce.y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_13.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
    ...
    class FollowPathForce {
        ...
        updateDebug(_dt) {
            ...
            while (nextNode !== firstNode && nextNode !== undefined) {
                ...
                this._m_debugManager.drawLine(activeSpr.x, activeSpr.y, nextSpr.x, nextSpr.y, debugManager_8.DebugManager.FORCE_LINE_WIDTH, stEnums_28.ST_COLOR_ID.kWhite);
                activeNode = nextNode;
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forceSeek"], function (require, exports, stEnums_37, shipFactory_1, uiSceneFactory_1, mapScene_4, master_21, forceConstant_1, forceSeek_3) {
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            blueShip.sendMessage(stEnums_37.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.6));
            const targetActor = shipFactory_1.ShipFactory.CreateRedShip(this, "Scarlet Mist");
            ...
            targetActor.sendMessage(stEnums_37.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.7, height * 0.6));
