...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_15, master_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        ...
        getType() {
            return stEnums_15.ST_STEER_FORCE.kPursue;
        }
        getMaxMagnitude() {
...
define("managers/uiManager/uiControllers/UIForcePursuit", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_16, uiBox_3, uiLabel_3, uiSlider_2, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIForcePursuit = void 0;
    class UIForcePursuit extends UIForce_2.UIForce {
        constructor(_scene) {
            super();
            const box = uiBox_3.UIBox.CreateForceBox(0, 0, _scene);
            this._m_box = box;
            const title = uiLabel_3.UILabel.CreateStyleA(0, 0, _scene, "Pursuit Force", 25);
            title.setTint(stEnums_16.ST_COLOR_ID.kGold);
            box.add(title);
        ...
        setTarget(_force) {
            ...
            if (pursuitForce !== undefined) {
                if (_force.getType() !== stEnums_16.ST_STEER_FORCE.kPursue) {
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_17, uiBox_4, uiLabel_4, uiSlider_3, UIForce_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIForceSeek = void 0;
    class UIForceSeek extends UIForce_3.UIForce {
        constructor(_scene) {
            super();
            const box = uiBox_4.UIBox.CreateForceBox(0, 0, _scene);
            this._m_box = box;
            const title = uiLabel_4.UILabel.CreateStyleA(0, 0, _scene, "Seek Force", 25);
        ...
        setTarget(_force) {
            this._m_seek = _force;
            if (this._m_seek !== undefined) {
                if (_force.getType() !== stEnums_17.ST_STEER_FORCE.kSeek) {
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceSeek"], function (require, exports, stEnums_18, uiBox_5, uiComboBox_1, uiImage_1, uiLabel_5, uiSlider_4, uiSpeedometer_1, UIController_1, UIForceArrival_1, UIForcePursuit_1, UIForceSeek_1) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_x, _y, _scene, _target) {
            ...
            this._ui_box = box;
            box.setElementsGap(7.5);
            const actorName = uiLabel_5.UILabel.CreateStyleA(0, 0, _scene, "", 32);
            this._ui_actorName = actorName;
            actorName.setTint(stEnums_18.ST_COLOR_ID.kGold);
            box.add(actorName);
            ...
            box.add(speedometer);
            this._ui_actualSpeed = uiLabel_5.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_actualSpeed.setTint(stEnums_18.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_actualSpeed);
            this._ui_maxSpeed = uiLabel_5.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_maxSpeed.setTint(stEnums_18.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_maxSpeed);
            this._ui_maxSpeedSlider = new uiSlider_4.UISlider(0, 0, _scene, 1, 300);
            ...
            this._ui_mass = uiLabel_5.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_mass.setTint(stEnums_18.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_mass);
            this._ui_massSlider = new uiSlider_4.UISlider(0, 0, _scene, 1, 10);
            ...
            const steerTitle = uiLabel_5.UILabel.CreateStyleB(0, 0, _scene, "Steer Force", 25);
            box.add(steerTitle);
            box.add(new uiImage_1.UIImage(0, 0, _scene, "game_art", "separator_a.png"));
            steerTitle.setTint(stEnums_18.ST_COLOR_ID.kGold);
            const selectForce = uiLabel_5.UILabel.CreateStyleB(0, 0, _scene, "Select Steer Force");
            selectForce.setTint(stEnums_18.ST_COLOR_ID.kSkyBlueNeon);
            box.add(selectForce);
            ...
            this._addUIForce(stEnums_18.ST_STEER_FORCE.kSeek, new UIForceSeek_1.UIForceSeek(_scene));
            this._addUIForce(stEnums_18.ST_STEER_FORCE.kArrive, new UIForceArrival_1.UIForceArrival(_scene));
            this._addUIForce(stEnums_18.ST_STEER_FORCE.kPursue, new UIForcePursuit_1.UIForcePursuit(_scene));
            this.setTarget(undefined);
            return;
        }
        update() {
        ...
        setTarget(_actor) {
            ...
            const forceController = _actor.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_6, uiLabel_6, UIController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIDialogBox extends UIController_2.UIController {
        constructor(_x, _y, _scene, _title) {
            super();
            const box = uiBox_6.UIBox.CreateBorderBoxB(_x, _y, _scene);
            this._m_box = box;
            const title = uiLabel_6.UILabel.CreateH1(0, 0, _scene, _title);
            this._m_title = title;
            box.add(title);
            box.setCenterAlignment();
            return;
...
define("managers/uiManager/uiControllers/UIMessageBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton", "managers/uiManager/uiButtonImg", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIDialogBox"], function (require, exports, stEnums_19, uiBox_7, uiButton_2, uiButtonImg_1, uiText_1, UIDialogBox_1) {
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            const buttonsBox = uiBox_7.UIBox.CreateContentBoxB(0, 0, _scene);
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_19.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_19.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_19.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_20, master_7, uiBox_8, uiButtonImg_2, uiImage_2, uiLabel_7, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title, _target) {
            super();
            const box = uiBox_8.UIBox.CreateBorderBox(_x, _y, _scene);
            box.setAnchor(0.5, 0);
            this._m_box = box;
            ...
            this._m_boxTitle = uiLabel_7.UILabel.CreateStyleA(0, 0, _scene, this._ui_boxTitle, 32);
            this._m_boxTitle.setTint(stEnums_20.ST_COLOR_ID.kGold);
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox.m_master = master_7.Master.GetInstance();
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_20.ST_MANAGER_ID.kSimManager);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_20.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_20.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_20.ST_SIM_SATE.kPaused) {
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_21, master_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ForceConstant {
        init(_self, _forceDirection, _forceMagnitude, _isRelative, _controller) {
            ...
            this._m_debugManager = master.getManager(stEnums_21.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setMaxMagnitude(_magnitude) {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_21.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_21.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_21.ST_STEER_FORCE.kConstant;
        }
        setRelative() {
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forceSeek"], function (require, exports, stEnums_22, shipFactory_1, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_9, forceConstant_1, forceSeek_1) {
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            const targetFController = targetActor.getComponent(stEnums_22.ST_COMPONENT_ID.kForceController);
            ...
            targetActor.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            ...
            let forceControl = blueShip.getComponent(stEnums_22.ST_COMPONENT_ID.kForceController);
            ...
            const uiManager = master.getManager(stEnums_22.ST_MANAGER_ID.kUIManager);
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_23, shipFactory_2, uiButton_3, UIForceController_2, UISimulationController_2, master_10, forceArrival_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnArrival extends Phaser.Scene {
        create() {
            ...
            shipActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_2.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            ...
            const uiManager = master.getManager(stEnums_23.ST_MANAGER_ID.kUIManager);
            uiManager.addUIController("forceUI", uiForceController);
            uiManager.addUIController("mediaSimUI", uiSimController);
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_11, stEnums_24) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        init(_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_11.Master.GetInstance().getManager(stEnums_24.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_24.ST_COLOR_ID.kPurple);
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_24.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_24.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_24.ST_COLOR_ID.kBlack);
            let displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_24.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_24.ST_STEER_FORCE.kWander;
        }
        getMaxMagnitude() {
            return this._m_forceMagnitude;
        }
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_13, stEnums_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_13.Master.GetInstance().getManager(stEnums_26.ST_MANAGER_ID.kDebugManager);
        }
        setController(_controller) {
            this._m_controller = _controller;
            return;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, 2, stEnums_26.ST_COLOR_ID.kPurple);
        }
        onDebugEnable() {
        }
        onDebugDisable() {
        ...
        getType() {
            return stEnums_26.ST_STEER_FORCE.kObstacleAvoidance;
        }
        getMaxMagnitude() {
            return this._m_forceMagnitude;
        }
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_27, shipFactory_4, uiButton_5, UISimulationController_4, master_14, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            let obstacleActor0 = shipFactory_4.ShipFactory.CreateRedShip(this, 'obstacle0');
            let obstacleActor1 = shipFactory_4.ShipFactory.CreateRedShip(this, 'obstacle1');
            let obstacleActor2 = shipFactory_4.ShipFactory.CreateRedShip(this, 'obstacle2');
            let obstacleActor3 = shipFactory_4.ShipFactory.CreateRedShip(this, 'obstacle3');
            let obstacleActor4 = shipFactory_4.ShipFactory.CreateRedShip(this, 'obstacle4');
            let obstacleActor5 = shipFactory_4.ShipFactory.CreateRedShip(this, 'obstacle5');
            let obstacleActor6 = shipFactory_4.ShipFactory.CreateRedShip(this, 'obstacle6');
            let obstacleActor7 = shipFactory_4.ShipFactory.CreateRedShip(this, 'obstacle7');
            ...
            obstacleActor0.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            let obstacle0Controller = obstacleActor0.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
            let obstacle1Controller = obstacleActor1.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
            let obstacle2Controller = obstacleActor2.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
            let obstacle3Controller = obstacleActor3.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
            let obstacle4Controller = obstacleActor4.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
            let obstacle5Controller = obstacleActor5.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
            let obstacle6Controller = obstacleActor6.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
            let obstacle7Controller = obstacleActor7.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_28, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_29, shipFactory_5, uiButton_6, UISimulationController_5, master_15, forceFlee_1) {
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            let simManager = master.getManager(stEnums_29.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_29.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_29.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_29.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_5.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_29.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_29.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            let flee = new forceFlee_1.FleeForce();
            flee.init(shipActor.getWrappedInstance(), targetActor.getWrappedInstance(), 100);
            let shipController = shipActor.getComponent(stEnums_29.ST_COMPONENT_ID.kForceController);
            ...
            const uiManager = master.getManager(stEnums_29.ST_MANAGER_ID.kUIManager);
            uiManager.addUIController("mediaSimUI", uiSimController);
            uiManager.setTarget(shipActor);
            this._m_master.enableDebugging();
            return;
...
define("scenes/sims/scenePursuit", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forcePursue"], function (require, exports, stEnums_30, shipFactory_6, UIForceController_3, UIMessageBox_2, UISimulationController_6, master_16, forceConstant_2, forcePursue_1) {
    ...
    class ScenePursuit extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            const targetActor = shipFactory_6.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            const targetFController = targetActor.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            const constantForce = new forceConstant_2.ForceConstant();
            constantForce.init(targetActor.getWrappedInstance(), new Phaser.Math.Vector2(0.4, 0.85), 300, true);
            targetFController.addForce("constant", constantForce);
            targetActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            const blueShip = shipFactory_6.ShipFactory.CreateBlueShip(this, "Blue Ship");
            simManager.addActor(blueShip);
            const blueFController = blueShip.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
...
define("game_init", ["require", "exports", "phaser3-nineslice", "scenes/preload", "scenes/boot", "scenes/mainMenu", "scenes/sims/sceneSeek", "scenes/sims/sceneArrival", "scenes/sims/sceneWander", "scenes/sims/sceneObstacleAvoidance", "scenes/sims/sceneFlee", "scenes/sims/scenePursuit"], function (require, exports, phaser3_nineslice_1, preload_1, boot_1, mainMenu_1, sceneSeek_1, sceneArrival_1, sceneWander_1, sceneObstacleAvoidance_1, sceneFlee_1, scenePursuit_1) {
    "use strict";
    class GameInit {
        constructor() { }
        start() {
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_31, debugManager_2, master_17, forceSeek_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        init(_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_17.Master.GetInstance().getManager(stEnums_31.ST_MANAGER_ID.kDebugManager);
            this.m_seek = new forceSeek_3.SeekForce();
        ...
        updateDebug(_dt) {
            ...
            let radius = this.m_radius;
            for (let i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, debugManager_2.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_31.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_31.ST_COLOR_ID.kBlue);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_31.ST_COLOR_ID.kBlue);
                }
            }
            return;
        }
        ...
        getType() {
            return stEnums_31.ST_STEER_FORCE.kFollowPath;
        }
        getMaxMagnitude() {
