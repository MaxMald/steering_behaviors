...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceEvade", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceObstacleAvoidance", "managers/uiManager/uiControllers/UIForceSeek", "managers/uiManager/uiControllers/UIForceWander", "managers/uiManager/uiControllers/UIForceFollowPath", "managers/uiManager/uiControllers/UIForceConstant"], function (require, exports, stEnums_29, uiBox_10, uiComboBox_1, uiImage_1, uiLabel_10, uiSlider_9, uiSpeedometer_1, UIController_1, UIForceArrival_1, UIForceEvade_1, UIForcePursuit_1, UIForceObstacleAvoidance_1, UIForceSeek_1, UIForceWander_1, UIForceFollowPath_1, UIForceConstant_1) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_x, _y, _scene, _target) {
            ...
            this._ui_box = box;
            box.setElementsGap(7.5);
            const actorName = uiLabel_10.UILabel.CreateStyleA(0, 0, _scene, "", 32);
            ...
            box.add(speedometer);
            this._ui_actualSpeed = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_actualSpeed.setTint(stEnums_29.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_actualSpeed);
            this._ui_maxSpeed = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_maxSpeed.setTint(stEnums_29.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_maxSpeed);
            this._ui_maxSpeedSlider = new uiSlider_9.UISlider(0, 0, _scene, 1, 300);
            ...
            this._ui_mass = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_mass.setTint(stEnums_29.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_mass);
            this._ui_massSlider = new uiSlider_9.UISlider(0, 0, _scene, 1, 10);
            ...
            const steerTitle = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "Steer Force", 25);
            box.add(steerTitle);
            box.add(new uiImage_1.UIImage(0, 0, _scene, "game_art", "separator_a.png"));
            steerTitle.setTint(stEnums_29.ST_COLOR_ID.kGold);
            const selectForce = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "Select Steer Force");
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_11, uiLabel_11, UIController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_30.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_30.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_30.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_31, master_14, uiBox_13, uiButtonImg_2, uiImage_2, uiLabel_12, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title, _target) {
            super();
            const box = uiBox_13.UIBox.CreateBorderBox(_x, _y, _scene);
            box.setAnchor(0.5, 0);
            this._m_box = box;
            ...
            this._m_boxTitle = uiLabel_12.UILabel.CreateStyleA(0, 0, _scene, this._ui_boxTitle, 32);
            this._m_boxTitle.setTint(stEnums_31.ST_COLOR_ID.kGold);
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_31.ST_MANAGER_ID.kSimManager);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_31.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_31.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_31.ST_SIM_SATE.kPaused) {
