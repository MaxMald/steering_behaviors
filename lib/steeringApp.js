...
define("components/cmpforceController", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_7, master_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("components/cmpShipPropulsor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_9, master_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpShipPropulsor {
        ...
        update(_actor) {
            const forceController = _actor.getComponent(stEnums_9.ST_COMPONENT_ID.kForceController);
        ...
        getID() {
            return stEnums_9.ST_COMPONENT_ID.kShipPropulsor;
        }
        destroy() {
...
define("components/cmpSpriteController", ["require", "exports", "commons/stEnums"], function (require, exports, stEnums_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpSpriteController {
        ...
        receive(_id, _obj) {
            switch (_id) {
                case stEnums_10.ST_MESSAGE_ID.kMove:
                    {
                        let v2 = _obj;
                        this.move(v2.x, v2.y);
                    }
                    return;
                case stEnums_10.ST_MESSAGE_ID.kSetPosition:
                    {
                        let v2 = _obj;
                        this.setPosition(v2.x, v2.y);
                    }
                    return;
                case stEnums_10.ST_MESSAGE_ID.kSetScale:
                    {
                        let v2 = _obj;
                        this.setScale(v2.x, v2.y);
                    }
                    return;
                case stEnums_10.ST_MESSAGE_ID.kSetAngle:
        ...
        getID() {
            return stEnums_10.ST_COMPONENT_ID.kSpriteController;
        }
        destroy() {
...
define("factories/shipFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpShipPropulsor", "components/cmpSpriteController"], function (require, exports, baseActor_1, stEnums_11, cmpforceController_1, cmpShipPropulsor_1, cmpSpriteController_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ShipFactory {
        static CreateBlueShip(_scene, _UniqueName) {
            ...
            shipActor.sendMessage(stEnums_11.ST_MESSAGE_ID.kSetMaxSpeed, 500);
            shipActor.sendMessage(stEnums_11.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            let canvas = _scene.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            shipActor.sendMessage(stEnums_11.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            shipActor.sendMessage(stEnums_11.ST_MESSAGE_ID.kSetMass, 1);
            return shipActor;
        }
...
define("managers/uiManager/uiLabelBox", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_4) {
    ...
    class UILabelBox extends uiObject_4.UIObject {
...
define("managers/uiManager/uiComboBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabelBox", "managers/uiManager/uiObject"], function (require, exports, stEnums_12, uiLabelBox_1, uiObject_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIComboBox = void 0;
    class UIComboBox extends uiObject_5.UIObject {
        ...
        _onOptionDown(_uiLabel, _args) {
            ...
            labelBox.setBoxTint(stEnums_12.ST_COLOR_ID.kBlack);
            labelBox.setTextTint(stEnums_12.ST_COLOR_ID.kWhite);
            return;
        }
        _onOptionUp(_uiLabel, _args) {
            const labelBox = _uiLabel;
            this.setSelection(labelBox.getText());
            labelBox.setBoxTint(stEnums_12.ST_COLOR_ID.kSkyBlueNeon);
            labelBox.setTextTint(stEnums_12.ST_COLOR_ID.kBlack);
            this.closeCombo();
            return;
        }
...
define("managers/uiManager/uiImage", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIImage = void 0;
    class UIImage extends uiObject_6.UIObject {
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_5, stEnums_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ArrivalForce {
        ...
        updateDebug(_dt) {
            ...
            debugManager.drawCircle(target.x, target.y, this._m_slowingRadius, 2, stEnums_13.ST_COLOR_ID.kPurple);
        ...
        getType() {
            return stEnums_13.ST_STEER_FORCE.kArrive;
        }
        getMaxMagnitude() {
...
define("managers/uiManager/uiControllers/UIForceArrival", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_14, uiBox_2, uiLabel_2, uiSlider_1, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceArrival extends UIForce_1.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_14.ST_COLOR_ID.kGold);
            box.add(title);
        ...
        setTarget(_force) {
            ...
            if (arrivalForce !== undefined) {
                if (_force.getType() !== stEnums_14.ST_STEER_FORCE.kArrive) {
...
define("steeringBehavior/forceEvade", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_15, master_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class EvadeForce {
        init(_self, _target, _maxForceMagnitude) {
            ...
            this._m_controller = _self.getComponent(stEnums_15.ST_COMPONENT_ID.kForceController);
            this._m_targetController = _target.getComponent(stEnums_15.ST_COMPONENT_ID.kForceController);
            ...
            this._m_debugManager = master_6.Master.GetInstance().getManager(stEnums_15.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_15.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_15.ST_COLOR_ID.kRed);
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, 5, stEnums_15.ST_COLOR_ID.kOrange);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_15.ST_STEER_FORCE.kEvade;
        }
        getMaxMagnitude() {
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_16, master_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        init(_self, _target, _maxForceMagnitude) {
            ...
            this._m_targetVelocity = new Phaser.Math.Vector2();
            this._m_steerForce = new Phaser.Math.Vector2();
            this._m_debugManager = master_7.Master.GetInstance().getManager(stEnums_16.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        getType() {
            return stEnums_16.ST_STEER_FORCE.kPursue;
        }
        getMaxMagnitude() {
            return this._m_maxForceMagnitude;
        }
...
define("managers/uiManager/uiControllers/UIForceEvade", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_17, uiBox_3, uiLabel_3, uiSlider_2, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceEvade extends UIForce_2.UIForce {
        ...
        setTarget(_force) {
            ...
            if (evadeForce !== undefined) {
                if (_force.getType() !== stEnums_17.ST_STEER_FORCE.kEvade) {
...
define("managers/uiManager/uiControllers/UIForcePursuit", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_18, uiBox_4, uiLabel_4, uiSlider_3, UIForce_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForcePursuit extends UIForce_3.UIForce {
        ...
        setTarget(_force) {
            ...
            if (pursuitForce !== undefined) {
                if (_force.getType() !== stEnums_18.ST_STEER_FORCE.kPursue) {
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_19, uiBox_5, uiLabel_5, uiSlider_4, UIForce_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIForceSeek = void 0;
    class UIForceSeek extends UIForce_4.UIForce {
        constructor(_scene) {
            super();
            const box = uiBox_5.UIBox.CreateForceBox(0, 0, _scene);
            this._m_box = box;
            const title = uiLabel_5.UILabel.CreateStyleA(0, 0, _scene, "Seek Force", 25);
        ...
        setTarget(_force) {
            this._m_seek = _force;
            if (this._m_seek !== undefined) {
                if (_force.getType() !== stEnums_19.ST_STEER_FORCE.kSeek) {
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceEvade", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceSeek"], function (require, exports, stEnums_20, uiBox_6, uiComboBox_1, uiImage_1, uiLabel_6, uiSlider_5, uiSpeedometer_1, UIController_1, UIForceArrival_1, UIForceEvade_1, UIForcePursuit_1, UIForceSeek_1) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_x, _y, _scene, _target) {
            super();
            const box = uiBox_6.UIBox.CreateBorderBox(_x, _y, _scene);
            this._ui_box = box;
            box.setElementsGap(7.5);
            const actorName = uiLabel_6.UILabel.CreateStyleA(0, 0, _scene, "", 32);
            this._ui_actorName = actorName;
            actorName.setTint(stEnums_20.ST_COLOR_ID.kGold);
            box.add(actorName);
            ...
            box.add(speedometer);
            this._ui_actualSpeed = uiLabel_6.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_actualSpeed.setTint(stEnums_20.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_actualSpeed);
            this._ui_maxSpeed = uiLabel_6.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_maxSpeed.setTint(stEnums_20.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_maxSpeed);
            this._ui_maxSpeedSlider = new uiSlider_5.UISlider(0, 0, _scene, 1, 300);
            ...
            this._ui_mass = uiLabel_6.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_mass.setTint(stEnums_20.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_mass);
            this._ui_massSlider = new uiSlider_5.UISlider(0, 0, _scene, 1, 10);
            ...
            const steerTitle = uiLabel_6.UILabel.CreateStyleB(0, 0, _scene, "Steer Force", 25);
            box.add(steerTitle);
            box.add(new uiImage_1.UIImage(0, 0, _scene, "game_art", "separator_a.png"));
            steerTitle.setTint(stEnums_20.ST_COLOR_ID.kGold);
            const selectForce = uiLabel_6.UILabel.CreateStyleB(0, 0, _scene, "Select Steer Force");
            selectForce.setTint(stEnums_20.ST_COLOR_ID.kSkyBlueNeon);
            box.add(selectForce);
            ...
            this._addUIForce(stEnums_20.ST_STEER_FORCE.kSeek, new UIForceSeek_1.UIForceSeek(_scene));
            this._addUIForce(stEnums_20.ST_STEER_FORCE.kArrive, new UIForceArrival_1.UIForceArrival(_scene));
            this._addUIForce(stEnums_20.ST_STEER_FORCE.kPursue, new UIForcePursuit_1.UIForcePursuit(_scene));
            this._addUIForce(stEnums_20.ST_STEER_FORCE.kEvade, new UIForceEvade_1.UIForceEvade(_scene));
            this.setTarget(undefined);
            return;
        }
        update() {
        ...
        setTarget(_actor) {
            ...
            const forceController = _actor.getComponent(stEnums_20.ST_COMPONENT_ID.kForceController);
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_7, uiLabel_7, UIController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIDialogBox = void 0;
    class UIDialogBox extends UIController_2.UIController {
        constructor(_x, _y, _scene, _title) {
            super();
            const box = uiBox_7.UIBox.CreateBorderBoxB(_x, _y, _scene);
            this._m_box = box;
            const title = uiLabel_7.UILabel.CreateH1(0, 0, _scene, _title);
            this._m_title = title;
            box.add(title);
            box.setCenterAlignment();
            return;
...
define("managers/uiManager/uiControllers/UIMessageBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton", "managers/uiManager/uiButtonImg", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIDialogBox"], function (require, exports, stEnums_21, uiBox_8, uiButton_2, uiButtonImg_1, uiText_1, UIDialogBox_1) {
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            const buttonsBox = uiBox_8.UIBox.CreateContentBoxB(0, 0, _scene);
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_21.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_21.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_21.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_22, master_8, uiBox_9, uiButtonImg_2, uiImage_2, uiLabel_8, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title, _target) {
            super();
            const box = uiBox_9.UIBox.CreateBorderBox(_x, _y, _scene);
            box.setAnchor(0.5, 0);
            this._m_box = box;
            ...
            this._m_boxTitle = uiLabel_8.UILabel.CreateStyleA(0, 0, _scene, this._ui_boxTitle, 32);
            this._m_boxTitle.setTint(stEnums_22.ST_COLOR_ID.kGold);
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox.m_master = master_8.Master.GetInstance();
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_22.ST_MANAGER_ID.kSimManager);
            const buttonsBox = uiBox_9.UIBox.CreateContentBoxB(0, 0, _scene);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_22.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_22.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_22.ST_SIM_SATE.kPaused) {
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_23, master_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ForceConstant {
        init(_self, _forceDirection, _forceMagnitude, _isRelative, _controller) {
            ...
            this._m_debugManager = master.getManager(stEnums_23.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setMaxMagnitude(_magnitude) {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_23.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_23.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_23.ST_STEER_FORCE.kConstant;
        }
        setRelative() {
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forceSeek"], function (require, exports, stEnums_24, shipFactory_1, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_10, forceConstant_1, forceSeek_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            let simManager = master.getManager(stEnums_24.ST_MANAGER_ID.kSimManager);
            ...
            const targetFController = targetActor.getComponent(stEnums_24.ST_COMPONENT_ID.kForceController);
            ...
            targetActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            let seek = new forceSeek_1.SeekForce();
            seek.init(blueShip.getWrappedInstance(), targetActor.getWrappedInstance(), 125);
            let forceControl = blueShip.getComponent(stEnums_24.ST_COMPONENT_ID.kForceController);
            ...
            const uiManager = master.getManager(stEnums_24.ST_MANAGER_ID.kUIManager);
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_25, shipFactory_2, uiButton_3, UIForceController_2, UISimulationController_2, master_11, forceArrival_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnArrival extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButton_3.UIButton.CreateThemeButton(width * 0.1, height * 0.9, this, 'Main menu');
            ...
            let debugButton = uiButton_3.UIButton.CreateColorButton(width * 0.9, height * 0.9, this, 'Debug Gizmos big text', 0x9000ff);
            ...
            shipActor.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_2.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            ...
            const uiForceController = new UIForceController_2.UIForceController(20, 20, this);
            const uiSimController = UISimulationController_2.UISimulationController.CreateSimControlBox(width * 0.5, 20, this);
            const uiManager = master.getManager(stEnums_25.ST_MANAGER_ID.kUIManager);
            uiManager.addUIController("forceUI", uiForceController);
            uiManager.addUIController("mediaSimUI", uiSimController);
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_12, stEnums_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        init(_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_12.Master.GetInstance().getManager(stEnums_26.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_26.ST_COLOR_ID.kPurple);
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_26.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_26.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_26.ST_COLOR_ID.kBlack);
            let displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_26.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_27, shipFactory_3, uiButton_4, UISimulationController_3, master_13, forceWander_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnWander extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            let simManager = master.getManager(stEnums_27.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_27.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            let wander = new forceWander_1.WanderForce();
            wander.init(shipActor.getWrappedInstance(), 75, 25, 5, 45, 100);
            let shipController = shipActor.getComponent(stEnums_27.ST_COMPONENT_ID.kForceController);
            shipController.addForce('wander_1', wander);
            const uiSimController = UISimulationController_3.UISimulationController.CreateSimControlBox(width * 0.5, 20, this);
            const uiManager = master.getManager(stEnums_27.ST_MANAGER_ID.kUIManager);
            uiManager.addUIController("mediaSimUI", uiSimController);
            uiManager.setTarget(shipActor);
            this._m_master.enableDebugging();
            return;
...
define("scenes/sims/sceneEvade", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceEvade", "steeringBehavior/forceSeek"], function (require, exports, stEnums_28, shipFactory_4, UIForceController_3, UIMessageBox_2, UISimulationController_4, master_14, forceEvade_1, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SceneEvade extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            let simManager = master.getManager(stEnums_28.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            const targetActor = shipFactory_4.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            const targetFController = targetActor.getComponent(stEnums_28.ST_COMPONENT_ID.kForceController);
            targetActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            const blueShip = shipFactory_4.ShipFactory.CreateBlueShip(this, "Blue Ship");
            simManager.addActor(blueShip);
            const blueFController = blueShip.getComponent(stEnums_28.ST_COMPONENT_ID.kForceController);
            ...
            const redSeek = new forceSeek_2.SeekForce();
            redSeek.init(targetActor.getWrappedInstance(), blueShip.getWrappedInstance(), 150);
            targetFController.addForce("seek", redSeek);
            const uiForceController = new UIForceController_3.UIForceController(20, 20, this);
            const uiMessageBox = UIMessageBox_2.UIMessageBox.CreateYesNo(400, 200, this, "Hello World", "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.", function (_buttonKey) {
                return;
            }, this);
            const uiSimController = UISimulationController_4.UISimulationController.CreateSimControlBox(width * 0.5, 20, this);
            const uiManager = master.getManager(stEnums_28.ST_MANAGER_ID.kUIManager);
            uiManager.addUIController("forceUI", uiForceController);
            uiManager.addUIController("messageBox", uiMessageBox);
            uiManager.addUIController("mediaSimUI", uiSimController);
            uiManager.setTarget(blueShip);
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_15, stEnums_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_15.Master.GetInstance().getManager(stEnums_29.ST_MANAGER_ID.kDebugManager);
        }
        setController(_controller) {
            this._m_controller = _controller;
            return;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, 2, stEnums_29.ST_COLOR_ID.kPurple);
        }
        onDebugEnable() {
        }
        onDebugDisable() {
        ...
        getType() {
            return stEnums_29.ST_STEER_FORCE.kObstacleAvoidance;
        }
        getMaxMagnitude() {
            return this._m_forceMagnitude;
        }
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_30, shipFactory_5, uiButton_5, UISimulationController_5, master_16, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            let simManager = master.getManager(stEnums_30.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButton_5.UIButton.CreateColorButton(width * 0.1, height * 0.9, this, 'Main menu', 0x2272F1);
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
            }, this);
            let debugButton = uiButton_5.UIButton.CreateColorButton(width * 0.9, height * 0.9, this, 'Debug', 0x9000ff);
            debugButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                if (master.isDebugEnable()) {
                    master.disableDebugging();
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            ...
            obstacleActor0.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_30.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            let shipController = shipActor.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            let obstacle0Controller = obstacleActor0.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            let obstacle1Controller = obstacleActor1.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            let obstacle2Controller = obstacleActor2.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            let obstacle3Controller = obstacleActor3.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            let obstacle4Controller = obstacleActor4.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            let obstacle5Controller = obstacleActor5.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            let obstacle6Controller = obstacleActor6.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            let obstacle7Controller = obstacleActor7.getComponent(stEnums_30.ST_COMPONENT_ID.kForceController);
            ...
            const uiSimController = UISimulationController_5.UISimulationController.CreateSimControlBox(width * 0.5, 20, this);
            const uiManager = master.getManager(stEnums_30.ST_MANAGER_ID.kUIManager);
            uiManager.addUIController("mediaSimUI", uiSimController);
            uiManager.setTarget(shipActor);
            this._m_master.enableDebugging();
            return;
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_31, forceSeek_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FleeForce = void 0;
    class FleeForce extends forceSeek_3.SeekForce {
        update(_dt) {
            let target = this._m_target;
            let self = this._m_self;
            let forceController = this._m_controller;
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_32, shipFactory_6, uiButton_6, UISimulationController_6, master_17, forceFlee_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButton_6.UIButton.CreateThemeButton(width * 0.1, height * 0.9, this, 'Main menu');
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
            }, this);
            let debugButton = uiButton_6.UIButton.CreateColorButton(width * 0.9, height * 0.9, this, 'Debug Gizmos big text', 0x9000ff);
            debugButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                if (master.isDebugEnable()) {
                    master.disableDebugging();
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_32.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_32.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_32.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_6.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_32.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            ...
            let shipController = shipActor.getComponent(stEnums_32.ST_COMPONENT_ID.kForceController);
            shipController.addForce('flee_1', flee);
            const uiSimController = UISimulationController_6.UISimulationController.CreateSimControlBox(width * 0.5, 20, this);
...
define("scenes/sims/scenePursuit", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forcePursue"], function (require, exports, stEnums_33, shipFactory_7, UIForceController_4, UIMessageBox_3, UISimulationController_7, master_18, forceConstant_2, forcePursue_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScenePursuit extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(blueShip);
            const blueFController = blueShip.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            ...
            const uiForceController = new UIForceController_4.UIForceController(20, 20, this);
            const uiMessageBox = UIMessageBox_3.UIMessageBox.CreateYesNo(400, 200, this, "Hello World", "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.", function (_buttonKey) {
                return;
            }, this);
            const uiSimController = UISimulationController_7.UISimulationController.CreateSimControlBox(width * 0.5, 20, this);
...
define("game_init", ["require", "exports", "phaser3-nineslice", "scenes/preload", "scenes/boot", "scenes/mainMenu", "scenes/sims/sceneSeek", "scenes/sims/sceneArrival", "scenes/sims/sceneWander", "scenes/sims/sceneEvade", "scenes/sims/sceneObstacleAvoidance", "scenes/sims/sceneFlee", "scenes/sims/scenePursuit"], function (require, exports, phaser3_nineslice_1, preload_1, boot_1, mainMenu_1, sceneSeek_1, sceneArrival_1, sceneWander_1, sceneEvade_1, sceneObstacleAvoidance_1, sceneFlee_1, scenePursuit_1) {
    "use strict";
    class GameInit {
        constructor() { }
        start() {
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_34, debugManager_2, master_19, forceSeek_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        init(_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_19.Master.GetInstance().getManager(stEnums_34.ST_MANAGER_ID.kDebugManager);
            this.m_seek = new forceSeek_4.SeekForce();
        ...
        update(_dt) {
            ...
            targetDistance.set(path[targetIndex].x - self.x, path[targetIndex].y - self.y);
        ...
        updateDebug(_dt) {
            ...
            let radius = this.m_radius;
            for (let i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, debugManager_2.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_34.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_34.ST_COLOR_ID.kBlue);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_34.ST_COLOR_ID.kBlue);
                }
            }
            return;
        }
        ...
        getType() {
            return stEnums_34.ST_STEER_FORCE.kFollowPath;
        }
        getMaxMagnitude() {
