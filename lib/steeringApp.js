...
define("managers/uiManager/uiButton", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabel", "managers/uiManager/uiObject"], function (require, exports, stEnums_7, uiLabel_1, uiObject_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIButton extends uiObject_3.UIObject {
        constructor(_x, _y, _scene, _frame, _label, _buttonTint, _labelTint, _labelSize) {
            ...
            this._m_buttonTint = stEnums_7.ST_COLOR_ID.kWhite;
            ...
            let labeltint = stEnums_7.ST_COLOR_ID.kWhite;
...
define("scenes/mainMenu", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton"], function (require, exports, stEnums_8, uiBox_1, uiButton_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class MainMenu extends Phaser.Scene {
        create() {
            ...
            const seek = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Seek", stEnums_8.ST_COLOR_ID.kWhite);
            seek.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneSeek');
                return;
            }, this);
            box.add(seek);
            const flee = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Flee", stEnums_8.ST_COLOR_ID.kWhite);
            flee.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneFlee');
                return;
            }, this);
            box.add(flee);
            const arrival = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Arrival", stEnums_8.ST_COLOR_ID.kWhite);
            arrival.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneArrival');
                return;
            }, this);
            box.add(arrival);
            const pursuit = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Pursuit", stEnums_8.ST_COLOR_ID.kWhite);
            pursuit.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('scenePursuit');
                return;
            }, this);
            box.add(pursuit);
            const evade = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Evade", stEnums_8.ST_COLOR_ID.kWhite);
            evade.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneEvade');
                return;
            }, this);
            box.add(evade);
            const wander = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Wander", stEnums_8.ST_COLOR_ID.kWhite);
            wander.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneWander');
                return;
            }, this);
            box.add(wander);
            const followPath = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Follow Path", stEnums_8.ST_COLOR_ID.kWhite);
            followPath.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneFollowPath');
                return;
            }, this);
            box.add(followPath);
            const oAvoidance = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Obstacle Avoidance", stEnums_8.ST_COLOR_ID.kWhite);
...
define("components/cmpforceController", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_9, master_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpForceController {
        ...
        init(_actor) {
            ...
            this._m_debugManager = this._m_master.getManager(stEnums_9.ST_MANAGER_ID.kDebugManager);
            this._m_actor = _actor;
            const simulationManager = this._m_master.getManager(stEnums_9.ST_MANAGER_ID.kSimManager);
            if (simulationManager.getState() === stEnums_9.ST_SIM_SATE.kRunning) {
        ...
        update(_actor) {
            ...
            this._m_actor.sendMessage(stEnums_9.ST_MESSAGE_ID.kMove, actualVelocityStepped);
            direction.copy(actualVelocity);
            direction.normalize();
            this._m_actor.sendMessage(stEnums_9.ST_MESSAGE_ID.kSetAngle, direction.angle());
            if (this._m_debug) {
                this.updateDebug(dt);
            }
            return;
        ...
        updateDebug(_dt) {
            ...
            let actualVelocity = this._m_actualVelocity;
            debugManager.drawLine(sprite.x, sprite.y, sprite.x + actualVelocity.x, sprite.y + actualVelocity.y, 3, stEnums_9.ST_COLOR_ID.kGreen);
            return;
        }
        receive(_id, _obj) {
            switch (_id) {
                case stEnums_9.ST_MESSAGE_ID.kSetMass:
                    this.setMass(_obj);
                    return;
                case stEnums_9.ST_MESSAGE_ID.kSetSpeed:
                    this.setSpeed(_obj);
                    return;
                case stEnums_9.ST_MESSAGE_ID.kSetMaxSpeed:
        ...
        getID() {
            return stEnums_9.ST_COMPONENT_ID.kForceController;
        }
...
define("components/cmpInteractiveActor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_10, master_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class cmpInteractiveActor {
        constructor() {
            ...
            this._m_uiManager = master.getManager(stEnums_10.ST_MANAGER_ID.kUIManager);
            return;
        }
        init(_actor) {
            this._m_self = _actor;
        ...
        getID() {
            return stEnums_10.ST_COMPONENT_ID.kInteractiveActor;
        }
        selectActor() {
        ...
        dragStart() {
            this._m_uiManager.setTarget(this._m_self);
            this._m_self.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetAlpha, 0.5);
            return;
        }
        dragEnd() {
            this._m_self.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetAlpha, 1.0);
            return;
        }
        dragActor(_pointer, _dragX, _dragY) {
            if (this._m_simulationManager.getState() === stEnums_10.ST_SIM_SATE.kStopped) {
                this._m_self.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetPosition, this._m_moveVector.set(_dragX, _dragY));
            }
            return;
        }
        destroy() {
...
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_11, master_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SeekForce {
        init(_self, _target, _force, _controller) {
            ...
            let master = master_6.Master.GetInstance();
            this._m_debugManager = master.getManager(stEnums_11.ST_MANAGER_ID.kDebugManager);
            return;
        }
        ...
        updateDebug(_dt) {
            ...
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_11.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_11.ST_STEER_FORCE.kSeek;
        }
        destroy() {
...
define("components/cmpShipPropulsor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_12, master_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpShipPropulsor {
        ...
        getID() {
            return stEnums_12.ST_COMPONENT_ID.kShipPropulsor;
        }
        destroy() {
...
define("components/cmpSpriteController", ["require", "exports", "commons/stEnums"], function (require, exports, stEnums_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("factories/shipFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpShipPropulsor", "components/cmpSpriteController"], function (require, exports, baseActor_1, stEnums_14, cmpforceController_1, cmpInteractiveActor_1, cmpShipPropulsor_1, cmpSpriteController_1) {
    ...
    class ShipFactory {
        static CreateBlueShip(_scene, _UniqueName) {
            ...
            shipActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetMaxSpeed, 500);
            shipActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            let canvas = _scene.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            shipActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            shipActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetMass, 1);
            return shipActor;
        }
...
define("managers/uiManager/uiComboBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabelBox", "managers/uiManager/uiObject"], function (require, exports, stEnums_15, uiLabelBox_1, uiObject_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIComboBox extends uiObject_6.UIObject {
        ...
        _onOptionDown(_uiLabel, _args) {
            ...
            labelBox.setBoxTint(stEnums_15.ST_COLOR_ID.kBlack);
            labelBox.setTextTint(stEnums_15.ST_COLOR_ID.kWhite);
            return;
        }
        _onOptionUp(_uiLabel, _args) {
            const labelBox = _uiLabel;
            this.setSelection(labelBox.getText());
            labelBox.setBoxTint(stEnums_15.ST_COLOR_ID.kSkyBlueNeon);
            labelBox.setTextTint(stEnums_15.ST_COLOR_ID.kBlack);
            this.closeCombo();
            return;
        }
...
define("factories/tiledMapFactory", ["require", "exports", "commons/stEnums", "commons/stPoint", "commons/stRectangle", "gameScene/motionImage", "managers/uiManager/uiButtonImg", "managers/uiManager/uiComboBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "master/master"], function (require, exports, stEnums_16, stPoint_1, stRectangle_1, motionImage_1, uiButtonImg_1, uiComboBox_1, uiLabel_2, uiSlider_1, uiSpeedometer_1, master_8) {
    ...
    class TiledMapFactory {
        static CreateMotionImage(_object, _scene) {
            ...
            const ambience = master.getManager(stEnums_16.ST_MANAGER_ID.kAmbienceManager);
...
define("managers/uiManager/uiControllers/UIForceArrival", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_18, uiBox_2, uiLabel_3, uiSlider_2, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceEvade", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_19, master_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_20, master_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        init(_self, _target, _maxForceMagnitude) {
            ...
            this._m_targetVelocity = new Phaser.Math.Vector2();
            this._m_steerForce = new Phaser.Math.Vector2();
            this._m_debugManager = master_11.Master.GetInstance().getManager(stEnums_20.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_20.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_20.ST_COLOR_ID.kRed);
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, 5, stEnums_20.ST_COLOR_ID.kOrange);
            return;
        }
        onDebugEnable() {
            return;
...
define("managers/uiManager/uiControllers/UIForceEvade", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_21, uiBox_3, uiLabel_4, uiSlider_3, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForcePursuit", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_22, uiBox_4, uiLabel_5, uiSlider_4, UIForce_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_12, stEnums_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_12.Master.GetInstance().getManager(stEnums_23.ST_MANAGER_ID.kDebugManager);
        }
        setController(_controller) {
            this._m_controller = _controller;
            return;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, 2, stEnums_23.ST_COLOR_ID.kPurple);
        }
        onDebugEnable() {
        }
        onDebugDisable() {
...
define("managers/uiManager/uiControllers/UIForceObstacleAvoidance", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_24, uiBox_5, uiLabel_6, uiSlider_5, UIForce_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_25, uiBox_6, uiLabel_7, uiSlider_6, UIForce_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_13, stEnums_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceWander", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_27, uiBox_7, uiLabel_8, uiSlider_7, UIForce_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek", "master/master"], function (require, exports, stEnums_28, forceSeek_1, master_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        ...
        updateDebug(_dt) {
            ...
            const forceToPath = this._m_forceToPath;
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + actualVelocity.x + forceToPath.x, self.y + actualVelocity.y + forceToPath.y, 2, stEnums_28.ST_COLOR_ID.kYellow);
            this._m_debugManager.drawCircle(self.x, self.y, this._m_radius, 1, stEnums_28.ST_COLOR_ID.kWhite);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
...
define("managers/uiManager/uiControllers/UIForceFollowPath", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_29, uiBox_8, uiLabel_9, uiSlider_8, UIForce_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_30, master_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceConstant", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_31, uiBox_9, uiLabel_10, uiSlider_9, UIForce_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceFlee", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_33, uiBox_10, uiLabel_11, uiSlider_10, UIForce_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceFlee extends UIForce_9.UIForce {
        constructor(_scene) {
            super();
            const box = uiBox_10.UIBox.CreateForceBox(0, 0, _scene);
            this._m_box = box;
            const title = uiLabel_11.UILabel.CreateStyleA(0, 0, _scene, "Flee Force", 25);
            title.setTint(stEnums_33.ST_COLOR_ID.kGold);
            this._m_title = title;
            box.add(title);
            this._m_labelForce = uiLabel_11.UILabel.CreateStyleB(0, 0, _scene, "#");
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_11.UILabel.CreateStyleB(0, 0, _scene, "#");
            box.add(this._m_maxMagnitude);
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceEvade", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceObstacleAvoidance", "managers/uiManager/uiControllers/UIForceSeek", "managers/uiManager/uiControllers/UIForceWander", "managers/uiManager/uiControllers/UIForceFollowPath", "managers/uiManager/uiControllers/UIForceConstant", "managers/uiManager/uiControllers/UIForceFlee", "managers/uiManager/uiGroup", "managers/uiManager/uiImage"], function (require, exports, stEnums_34, uiBox_11, uiComboBox_2, uiLabel_12, UIController_1, UIForceArrival_1, UIForceEvade_1, UIForcePursuit_1, UIForceObstacleAvoidance_1, UIForceSeek_1, UIForceWander_1, UIForceFollowPath_1, UIForceConstant_1, UIForceFlee_1, uiGroup_1, uiImage_1) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_uiScene, _scene) {
            ...
            this._ui_box = uiBox_11.UIBox.CreateContentBox(forceArea.x, forceArea.y, _scene);
            this._ui_box.setPadding(15, 20);
            const selectForce = uiLabel_12.UILabel.CreateStyleB(0, 0, _scene, "Select Force");
...
define("managers/uiManager/uiControllers/UIInfoBox", ["require", "exports", "commons/stEnums", "gameScene/mapScene", "master/master", "managers/uiManager/uiGroup", "managers/uiManager/uiImage", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_35, mapScene_1, master_16, uiGroup_2, uiImage_2, uiText_1, UIController_2) {
    ...
    class UIInfoBox extends UIController_2.UIController {
        constructor(_scene, _sceneMap) {
            ...
            const group = _scene.add.group();
            this._m_group = group;
            const uiGroup = new uiGroup_2.UIGroup();
            ...
            bg.setInteractive();
            group.add(bg);
            const map = mapScene_1.MapScene.CreateFromTiledMap(_sceneMap, _scene);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiGroup", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_36, master_17, uiGroup_3, UIController_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor() {
            super();
            this._m_group = new uiGroup_3.UIGroup();
            return;
        }
        static CreateSimControlBox(_mapScene) {
            const simControlBox = new UISimulationController();
            simControlBox.m_master = master_17.Master.GetInstance();
...
define("factories/uiSceneFactory", ["require", "exports", "gameScene/mapScene", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIInfoBox", "managers/uiManager/uiControllers/UISimulationController", "master/master"], function (require, exports, mapScene_2, UIForceController_1, UIInfoBox_1, UISimulationController_1, master_18) {
    ...
    class SceneUIFactory {
        static CreateSimulationUIScene(_uiSceneKey, _scene, _uiManager, _infoButtonCallback, _infoButtonContext) {
            const uiMap = mapScene_2.MapScene.CreateFromTiledMap(_uiSceneKey, _scene);
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forceSeek"], function (require, exports, stEnums_37, shipFactory_1, uiSceneFactory_1, mapScene_3, master_19, forceConstant_1, forceSeek_3) {
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            const ambienceMap = mapScene_3.MapScene.CreateFromTiledMap("ambience_01", this);
            ambienceMap.clear();
            ambienceMap.destroy();
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_38, shipFactory_2, uiSceneFactory_2, master_20, forceArrival_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_39, shipFactory_3, uiSceneFactory_3, master_21, forceWander_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_42, shipFactory_6, uiSceneFactory_6, master_24, forceFlee_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/scenePursuit", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forcePursue"], function (require, exports, stEnums_43, shipFactory_7, uiSceneFactory_7, master_25, forceConstant_2, forcePursue_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/sceneFollowPath", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_45, ambienceFactory_1, shipFactory_8, uiSceneFactory_8, master_26, forceFollowPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("gameScene/parallaxImage", ["require", "exports", "master/master"], function (require, exports, master_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_12, uiLabel_13, UIController_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIDialogBox extends UIController_4.UIController {
        constructor(_x, _y, _scene, _title) {
            super();
            const box = uiBox_12.UIBox.CreateBorderBoxB(_x, _y, _scene);
            this._m_box = box;
...
define("managers/uiManager/uiControllers/UIMessageBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton", "managers/uiManager/uiButtonImg", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIDialogBox"], function (require, exports, stEnums_46, uiBox_13, uiButton_2, uiButtonImg_3, uiText_2, UIDialogBox_1) {
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            const buttonsBox = uiBox_13.UIBox.CreateContentBoxB(0, 0, _scene);
