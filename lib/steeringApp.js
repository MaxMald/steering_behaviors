...
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_9, master_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SeekForce {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_9.ST_COLOR_ID.kBlack);
...
define("components/cmpShipPropulsor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_10, master_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_15, uiBox_3, uiLabel_3, uiSlider_2, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIForceSeek = void 0;
    class UIForceSeek extends UIForce_2.UIForce {
        constructor(_scene) {
            super();
            const box = uiBox_3.UIBox.CreateForceBox(0, 0, _scene);
            this._m_box = box;
            const title = uiLabel_3.UILabel.CreateStyleA(0, 0, _scene, "Seek Force", 25);
        ...
        setTarget(_force) {
            this._m_seek = _force;
            if (this._m_seek !== undefined) {
                if (_force.getType() !== stEnums_15.ST_STEER_FORCE.kSeek) {
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceSeek"], function (require, exports, stEnums_16, uiBox_4, uiComboBox_1, uiImage_1, uiLabel_4, uiSlider_3, uiSpeedometer_1, UIController_1, UIForceArrival_1, UIForceSeek_1) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_x, _y, _scene, _target) {
            super();
            const box = uiBox_4.UIBox.CreateBorderBox(_x, _y, _scene);
            this._ui_box = box;
            box.setElementsGap(7.5);
            const actorName = uiLabel_4.UILabel.CreateStyleA(0, 0, _scene, "", 32);
            this._ui_actorName = actorName;
            actorName.setTint(stEnums_16.ST_COLOR_ID.kGold);
            box.add(actorName);
            ...
            box.add(speedometer);
            this._ui_actualSpeed = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_actualSpeed.setTint(stEnums_16.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_actualSpeed);
            this._ui_maxSpeed = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_maxSpeed.setTint(stEnums_16.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_maxSpeed);
            this._ui_maxSpeedSlider = new uiSlider_3.UISlider(0, 0, _scene, 1, 300);
            ...
            this._ui_mass = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_mass.setTint(stEnums_16.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_mass);
            this._ui_massSlider = new uiSlider_3.UISlider(0, 0, _scene, 1, 10);
            ...
            const steerTitle = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "Steer Force", 25);
            box.add(steerTitle);
            box.add(new uiImage_1.UIImage(0, 0, _scene, "game_art", "separator_a.png"));
            steerTitle.setTint(stEnums_16.ST_COLOR_ID.kGold);
            const selectForce = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "Select Steer Force");
            selectForce.setTint(stEnums_16.ST_COLOR_ID.kSkyBlueNeon);
            box.add(selectForce);
            ...
            this._addUIForce(stEnums_16.ST_STEER_FORCE.kSeek, new UIForceSeek_1.UIForceSeek(_scene));
            this._addUIForce(stEnums_16.ST_STEER_FORCE.kArrive, new UIForceArrival_1.UIForceArrival(_scene));
            this.setTarget(undefined);
            return;
        }
        update() {
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_5, uiLabel_5, UIController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIDialogBox extends UIController_2.UIController {
        constructor(_x, _y, _scene, _title) {
            super();
            const box = uiBox_5.UIBox.CreateBorderBoxB(_x, _y, _scene);
            this._m_box = box;
            const title = uiLabel_5.UILabel.CreateH1(0, 0, _scene, _title);
            this._m_title = title;
            box.add(title);
            box.setCenterAlignment();
            return;
...
define("managers/uiManager/uiControllers/UIMessageBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton", "managers/uiManager/uiButtonImg", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIDialogBox"], function (require, exports, stEnums_17, uiBox_6, uiButton_2, uiButtonImg_1, uiText_1, UIDialogBox_1) {
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            const buttonsBox = uiBox_6.UIBox.CreateContentBoxB(0, 0, _scene);
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_17.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_17.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_17.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_18, master_6, uiBox_7, uiButtonImg_2, uiImage_2, uiLabel_6, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title, _target) {
            super();
            const box = uiBox_7.UIBox.CreateBorderBox(_x, _y, _scene);
            box.setAnchor(0.5, 0);
            this._m_box = box;
            ...
            this._m_boxTitle = uiLabel_6.UILabel.CreateStyleA(0, 0, _scene, this._ui_boxTitle, 32);
            this._m_boxTitle.setTint(stEnums_18.ST_COLOR_ID.kGold);
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox.m_master = master_6.Master.GetInstance();
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_18.ST_MANAGER_ID.kSimManager);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_18.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_18.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_18.ST_SIM_SATE.kPaused) {
...
define("scenes/sims/sceneSeek", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpSpriteController", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_2, stEnums_19, cmpSpriteController_2, shipFactory_1, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_7, forceSeek_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ScnSeek = void 0;
    class ScnSeek extends Phaser.Scene {
        create() {
            this._m_master = master_7.Master.GetInstance();
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            let simManager = master.getManager(stEnums_19.ST_MANAGER_ID.kSimManager);
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let seek = new forceSeek_1.SeekForce();
            seek.init(this._m_ship.getWrappedInstance(), targetSprite, 125);
            let forceControl = this._m_ship.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            ...
            const uiManager = master.getManager(stEnums_19.ST_MANAGER_ID.kUIManager);
        ...
        update(_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            return;
        }
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_20, debugManager_2, master_8, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        init(_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_8.Master.GetInstance().getManager(stEnums_20.ST_MANAGER_ID.kDebugManager);
        ...
        updateDebug(_dt) {
            ...
            let radius = this.m_radius;
            for (let i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, debugManager_2.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_20.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_20.ST_COLOR_ID.kBlue);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_20.ST_COLOR_ID.kBlue);
                }
            }
            return;
        }
        ...
        getType() {
            return stEnums_20.ST_STEER_FORCE.kFollowPath;
        }
        getMaxMagnitude() {
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_21, master_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        init(_self, _target, _force, _predictionSteps, _targetForceCtrl, _controller) {
            ...
            this._m_debugManager = master_9.Master.GetInstance().getManager(stEnums_21.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            ...
            debugManager.drawLine(this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, this._m_v2_actualVelocity.x + pos.x, this._m_v2_actualVelocity.y + pos.y, 3, stEnums_21.ST_COLOR_ID.kRed);
            debugManager.drawLine(pos.x, pos.y, this._m_v2_forceMagnitude.x + pos.x, this._m_v2_forceMagnitude.y + pos.y, 3, stEnums_21.ST_COLOR_ID.kBlue);
            debugManager.drawLine(pos.x, pos.y, this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, 3, stEnums_21.ST_COLOR_ID.kBlack);
            let target = this._m_target;
            debugManager.drawCircle(target.x + this._m_targetDir.x, target.y + this._m_targetDir.y, 5, 2, stEnums_21.ST_COLOR_ID.kYellow);
            return;
        }
        onDebugEnable() {
            return;
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_10, stEnums_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        init(_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_10.Master.GetInstance().getManager(stEnums_22.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_22.ST_COLOR_ID.kPurple);
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_22.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_22.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_22.ST_COLOR_ID.kBlack);
            let displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_22.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_22.ST_STEER_FORCE.kWander;
        }
        getMaxMagnitude() {
            return this._m_forceMagnitude;
        }
...
define("scenes/sims/devSumano", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_23, shipFactory_2, UISimulationController_2, master_11, forceFollowPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnDevSumano extends Phaser.Scene {
        create() {
            ...
            pursueActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 100);
            fleeActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMaxSpeed, 80);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            pursueActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.45));
            fleeActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.55));
            let forceControlP = pursueActor0.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            let forceControlF = fleeActor0.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
            ...
            pathActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor1.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor2.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor3.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor4.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor5.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor6.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor7.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor0.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.1));
            pathActor1.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.33, height * 0.5));
            pathActor2.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.9));
            pathActor3.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            pathActor4.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.8));
            pathActor5.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.9));
            pathActor6.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.1));
            pathActor7.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.33));
            let pathArray = new Array(pathActor0.getWrappedInstance(), pathActor1.getWrappedInstance(), pathActor2.getWrappedInstance(), pathActor3.getWrappedInstance(), pathActor4.getWrappedInstance(), pathActor5.getWrappedInstance(), pathActor6.getWrappedInstance(), pathActor7.getWrappedInstance());
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_24, shipFactory_3, uiButton_3, UIForceController_2, UISimulationController_3, master_12, forceArrival_1) {
    ...
    class ScnArrival extends Phaser.Scene {
        create() {
            ...
            shipActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_3.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            ...
            let shipController = shipActor.getComponent(stEnums_24.ST_COMPONENT_ID.kForceController);
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_14, stEnums_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_14.Master.GetInstance().getManager(stEnums_26.ST_MANAGER_ID.kDebugManager);
        }
        setController(_controller) {
            this._m_controller = _controller;
            return;
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_28, forceSeek_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("game_init", ["require", "exports", "phaser3-nineslice", "scenes/preload", "scenes/boot", "scenes/mainMenu", "scenes/sims/sceneSeek", "scenes/sims/sceneArrival", "scenes/sims/sceneWander", "scenes/sims/sceneObstacleAvoidance", "scenes/sims/sceneFlee"], function (require, exports, phaser3_nineslice_1, preload_1, boot_1, mainMenu_1, sceneSeek_1, sceneArrival_1, sceneWander_1, sceneObstacleAvoidance_1, sceneFlee_1) {
    "use strict";
    class GameInit {
        constructor() { }
        start() {
