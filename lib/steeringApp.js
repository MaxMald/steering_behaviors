...
define("master/master", ["require", "exports", "managers/ambienceManager/ambienceManager", "managers/debugManager/debugManager", "managers/nullManager", "managers/simulationManager/simulationManager", "managers/uiManager/uiManager"], function (require, exports, ambienceManager_1, debugManager_1, nullManager_1, simulationManager_1, uiManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiManager", ["require", "exports", "commons/stEnums", "gameScene/infoBook", "master/master"], function (require, exports, stEnums_5, infoBook_1, master_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIManager {
        ...
        init() {
            ...
            this._m_debugManager = master.getManager(stEnums_5.ST_MANAGER_ID.kDebugManager);
            return;
        }
        update(_dt) {
            ...
            if (this.m_target !== undefined) {
                ...
                this._m_debugManager.drawCircle(sprite.x, sprite.y, size, 3, stEnums_5.ST_COLOR_ID.kGreen);
                this._m_debugManager.drawCircle(sprite.x, sprite.y, size * 1.1, 1.5, stEnums_5.ST_COLOR_ID.kGreen, 0.4);
            }
            if (this.m_focusedActor !== undefined) {
                ...
                const h = sprite.displayHeight;
                const size = (w > h ? w : h) * 0.6;
                this._m_debugManager.drawCircle(sprite.x, sprite.y, size, 3, stEnums_5.ST_COLOR_ID.kOrange);
                this._m_debugManager.drawCircle(sprite.x, sprite.y, size * 1.1, 1.5, stEnums_5.ST_COLOR_ID.kOrange, 0.4);
            }
            return;
        }
        receive(_id, _msg) {
        ...
        getID() {
            return stEnums_5.ST_MANAGER_ID.kUIManager;
        }
        onPrepare() {
            return;
        }
...
define("scenes/preload", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_6, master_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Preload extends Phaser.Scene {
        ...
        onLoadComplete() {
            ...
            const uiManager = master.getManager(stEnums_6.ST_MANAGER_ID.kUIManager);
...
define("managers/uiManager/uiComboBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabelBox", "managers/uiManager/uiObject"], function (require, exports, stEnums_7, uiLabelBox_1, uiObject_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIComboBox extends uiObject_3.UIObject {
        ...
        _onOptionUp(_uiLabel, _args) {
            ...
            labelBox.setBoxTint(stEnums_7.ST_COLOR_ID.kSkyBlueNeon);
...
define("factories/tiledMapFactory", ["require", "exports", "commons/stEnums", "commons/stPoint", "commons/stRectangle", "gameScene/motionImage", "managers/uiManager/uiButtonImg", "managers/uiManager/uiComboBox", "managers/uiManager/uiLabel", "managers/uiManager/uiMenuButton", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "master/master"], function (require, exports, stEnums_8, stPoint_1, stRectangle_1, motionImage_1, uiButtonImg_1, uiComboBox_1, uiLabel_1, uiMenuButton_1, uiSlider_1, uiSpeedometer_1, master_4) {
    ...
    class TiledMapFactory {
        static CreateMotionImage(_object, _scene) {
            ...
            const ambience = master.getManager(stEnums_8.ST_MANAGER_ID.kAmbienceManager);
...
define("managers/uiManager/uiGroup", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIGroup = void 0;
    class UIGroup extends uiObject_8.UIObject {
        constructor() {
            super();
            this._isEnable = true;
            this._m_aObjects = new Array();
...
define("scenes/mainMenu", ["require", "exports", "commons/stEnums", "gameScene/mapScene", "managers/uiManager/uiGroup", "master/master"], function (require, exports, stEnums_9, mapScene_1, uiGroup_1, master_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MainMenu = void 0;
    class MainMenu extends Phaser.Scene {
        create() {
            this._m_ambienceManager = master_5.Master.GetInstance().getManager(stEnums_9.ST_MANAGER_ID.kAmbienceManager);
...
define("components/cmpforceController", ["require", "exports", "commons/stEnums", "master/master", "components/actorInitState"], function (require, exports, stEnums_10, master_6, actorInitState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpForceController {
        constructor() {
            ...
            this._m_simulationManager = master.getManager(stEnums_10.ST_MANAGER_ID.kSimManager);
            this._m_actor = null;
        ...
        init(_actor) {
            ...
            this._m_debugManager = this._m_master.getManager(stEnums_10.ST_MANAGER_ID.kDebugManager);
            this._m_actor = _actor;
            const simulationManager = this._m_simulationManager;
            if (simulationManager.getState() === stEnums_10.ST_SIM_SATE.kRunning) {
        ...
        update(_actor) {
            ...
            this._m_actor.sendMessage(stEnums_10.ST_MESSAGE_ID.kMove, actualVelocityStepped);
            direction.copy(actualVelocity);
            direction.normalize();
            this._m_actor.sendMessage(stEnums_10.ST_MESSAGE_ID.kSetAngle, direction.angle());
            if (this._m_debug) {
                this.updateDebug(dt);
            }
            return;
        ...
        updateDebug(_dt) {
            ...
            let actualVelocity = this._m_actualVelocity;
            debugManager.drawLine(sprite.x, sprite.y, sprite.x + actualVelocity.x, sprite.y + actualVelocity.y, 3, stEnums_10.ST_COLOR_ID.kGreen);
            return;
        }
        receive(_id, _obj) {
            switch (_id) {
                case stEnums_10.ST_MESSAGE_ID.kSetMass:
                    this.setMass(_obj);
                    return;
                case stEnums_10.ST_MESSAGE_ID.kSetSpeed:
                    this.setSpeed(_obj);
                    return;
                case stEnums_10.ST_MESSAGE_ID.kSetMaxSpeed:
        ...
        getID() {
            return stEnums_10.ST_COMPONENT_ID.kForceController;
        }
        ...
        setMaxSpeed(_maxSpeed) {
            ...
            if (this._m_simulationManager.getState() === stEnums_10.ST_SIM_SATE.kStopped) {
...
define("components/cmpInteractiveActor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_11, master_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class cmpInteractiveActor {
        constructor() {
            ...
            this._m_uiManager = master.getManager(stEnums_11.ST_MANAGER_ID.kUIManager);
            return;
        }
        init(_actor) {
            this._m_self = _actor;
        ...
        getID() {
            return stEnums_11.ST_COMPONENT_ID.kInteractiveActor;
        }
        selectActor() {
        ...
        dragStart() {
            this._m_uiManager.setTarget(this._m_self);
            this._m_self.sendMessage(stEnums_11.ST_MESSAGE_ID.kSetAlpha, 0.5);
            return;
        }
        dragEnd() {
            this._m_self.sendMessage(stEnums_11.ST_MESSAGE_ID.kSetAlpha, 1.0);
            return;
        }
        dragActor(_pointer, _dragX, _dragY) {
            if (this._m_simulationManager.getState() === stEnums_11.ST_SIM_SATE.kStopped) {
                this._m_self.sendMessage(stEnums_11.ST_MESSAGE_ID.kSetPosition, this._m_moveVector.set(_dragX, _dragY));
            }
            return;
        }
        destroy() {
...
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_12, debugManager_2, master_8, forceInitState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SeekForce {
        init(_self, _target, _force, _controller) {
            ...
            this._m_debugManager = master.getManager(stEnums_12.ST_MANAGER_ID.kDebugManager);
            return;
        }
        ...
        updateDebug(_dt) {
            ...
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_12.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_12.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_12.ST_STEER_FORCE.kSeek;
        }
        destroy() {
...
define("components/cmpShipPropulsor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_13, master_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpShipPropulsor {
        ...
        update(_actor) {
            const forceController = _actor.getComponent(stEnums_13.ST_COMPONENT_ID.kForceController);
        ...
        getID() {
            return stEnums_13.ST_COMPONENT_ID.kShipPropulsor;
        }
        destroy() {
...
define("components/cmpSpriteController", ["require", "exports", "commons/stEnums", "master/master", "components/actorInitState"], function (require, exports, stEnums_14, master_10, actorInitState_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpSpriteController {
        init(_actor) {
            ...
            this._m_simulationManager = master.getManager(stEnums_14.ST_MANAGER_ID.kSimManager);
        ...
        receive(_id, _obj) {
            switch (_id) {
                case stEnums_14.ST_MESSAGE_ID.kMove:
                    {
                        let v2 = _obj;
                        this.move(v2.x, v2.y);
                    }
                    return;
                case stEnums_14.ST_MESSAGE_ID.kSetPosition:
                    {
                        let v2 = _obj;
                        this.setPosition(v2.x, v2.y);
                    }
                    if (this._m_simulationManager.getState() === stEnums_14.ST_SIM_SATE.kStopped) {
                        this._m_actorInitState.m_initPosition = _obj;
                    }
                    return;
                case stEnums_14.ST_MESSAGE_ID.kSetScale:
                    {
                        let v2 = _obj;
                        this.setScale(v2.x, v2.y);
                    }
                    return;
                case stEnums_14.ST_MESSAGE_ID.kSetAngle:
                    this._m_sprite.setAngle(Phaser.Math.RadToDeg(_obj));
                    return;
                case stEnums_14.ST_MESSAGE_ID.kSetAlpha:
                    this.setAlpha(_obj);
                    return;
                case stEnums_14.ST_MESSAGE_ID.kPlayAnimation:
        ...
        getID() {
            return stEnums_14.ST_COMPONENT_ID.kSpriteController;
        }
        destroy() {
...
define("factories/shipFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpShipPropulsor", "components/cmpSpriteController"], function (require, exports, baseActor_1, stEnums_15, cmpforceController_1, cmpInteractiveActor_1, cmpShipPropulsor_1, cmpSpriteController_1) {
    ...
    class ShipFactory {
        static CreateBlueShip(_scene, _UniqueName) {
            ...
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetMaxSpeed, 500);
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            let canvas = _scene.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetMass, 1);
            return shipActor;
        }
...
define("managers/uiManager/uiBox/uiBox", ["require", "exports", "managers/uiManager/uiObject", "managers/uiManager/uiBox/states/uiHorizontalBox", "managers/uiManager/uiBox/states/uiVerticalBox"], function (require, exports, uiObject_9, uiHorizontalBox_1, uiVerticalBox_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIBox = void 0;
    class UIBox extends uiObject_9.UIObject {
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/forceInitState"], function (require, exports, master_11, debugManager_3, stEnums_16, forceInitState_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ArrivalForce {
        init(_self, _target, _slowingRadius, _force, _controller) {
            ...
            this._m_simulationManager = master.getManager(stEnums_16.ST_MANAGER_ID.kSimManager);
            this._m_arrivalInitState = new forceInitState_2.ForceInitState();
            this._m_debugManager = master_11.Master.GetInstance().getManager(stEnums_16.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            ...
            let target = this._m_target;
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_3.DebugManager.FORCE_LINE_WIDTH, stEnums_16.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_3.DebugManager.FORCE_LINE_WIDTH, stEnums_16.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(target.x, target.y, this._m_slowingRadius, debugManager_3.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_16.ST_COLOR_ID.kPurple);
        ...
        getType() {
            return stEnums_16.ST_STEER_FORCE.kArrive;
        }
        getInitMaxMagnitude() {
        ...
        setMaxMagnitude(_magnitude) {
            if (this._m_simulationManager.getState() === stEnums_16.ST_SIM_SATE.kStopped) {
...
define("managers/uiManager/uiControllers/UIForceArrival", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_17, uiBox_1, uiLabel_2, uiSlider_2, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceArrival extends UIForce_1.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_17.ST_COLOR_ID.kGold);
            box.add(title);
            this._m_labelForce = uiLabel_2.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_labelForce.setTint(stEnums_17.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_2.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_17.ST_COLOR_ID.kSkyBlueNeon);
        ...
        setTarget(_force) {
            ...
            if (arrivalForce !== undefined) {
                if (_force.getType() !== stEnums_17.ST_STEER_FORCE.kArrive) {
...
define("steeringBehavior/forceEvade", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_18, debugManager_4, master_12, forceInitState_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class EvadeForce {
        init(_self, _target, _maxForceMagnitude) {
            ...
            this._m_controller = _self.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            this._m_targetController = _target.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            const master = master_12.Master.GetInstance();
            this._m_simulationManager = master.getManager(stEnums_18.ST_MANAGER_ID.kSimManager);
            ...
            this._m_debugManager = master_12.Master.GetInstance().getManager(stEnums_18.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_4.DebugManager.FORCE_LINE_WIDTH, stEnums_18.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_4.DebugManager.FORCE_LINE_WIDTH, stEnums_18.ST_COLOR_ID.kRed);
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, debugManager_4.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_18.ST_COLOR_ID.kOrange);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_18.ST_STEER_FORCE.kEvade;
        }
        getInitMaxMagnitude() {
        ...
        setMaxMagnitude(_maxMagnitude) {
            if (this._m_simulationManager.getState() === stEnums_18.ST_SIM_SATE.kStopped) {
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_19, debugManager_5, master_13, forceInitState_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_5.DebugManager.FORCE_LINE_WIDTH, stEnums_19.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_5.DebugManager.FORCE_LINE_WIDTH, stEnums_19.ST_COLOR_ID.kRed);
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, debugManager_5.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_19.ST_COLOR_ID.kOrange);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_19.ST_STEER_FORCE.kPursue;
        }
        getInitMaxMagnitude() {
...
define("managers/uiManager/uiControllers/UIForceEvade", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_20, uiBox_2, uiLabel_3, uiSlider_3, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceEvade extends UIForce_2.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_20.ST_COLOR_ID.kGold);
            box.add(title);
            this._m_labelForce = uiLabel_3.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_labelForce.setTint(stEnums_20.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_3.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_20.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_maxMagnitude);
        ...
        setTarget(_force) {
            ...
            if (evadeForce !== undefined) {
                if (_force.getType() !== stEnums_20.ST_STEER_FORCE.kEvade) {
...
define("managers/uiManager/uiControllers/UIForcePursuit", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_21, uiBox_3, uiLabel_4, uiSlider_4, UIForce_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForcePursuit extends UIForce_3.UIForce {
        ...
        setTarget(_force) {
            ...
            if (pursuitForce !== undefined) {
                if (_force.getType() !== stEnums_21.ST_STEER_FORCE.kPursue) {
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/forceInitState"], function (require, exports, master_14, debugManager_6, stEnums_22, forceInitState_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_simulationManager = master.getManager(stEnums_22.ST_MANAGER_ID.kSimManager);
            this._m_obstacleAvoidanceInitState = new forceInitState_5.ForceInitState();
            this._m_debugManager = master_14.Master.GetInstance().getManager(stEnums_22.ST_MANAGER_ID.kDebugManager);
        }
        setController(_controller) {
            this._m_controller = _controller;
            return;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, debugManager_6.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_22.ST_COLOR_ID.kPurple);
        }
        onDebugEnable() {
        }
        onDebugDisable() {
        ...
        getType() {
            return stEnums_22.ST_STEER_FORCE.kObstacleAvoidance;
        }
        setInitMaxMagnitude() {
            this._m_forceMagnitude = this.getInitMaxMagnitude();
            return;
        ...
        setMaxMagnitude(_magnitude) {
            if (this._m_simulationManager.getState() === stEnums_22.ST_SIM_SATE.kStopped) {
...
define("managers/uiManager/uiControllers/UIForceObstacleAvoidance", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_23, uiBox_4, uiLabel_5, uiSlider_5, UIForce_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceObstacleAvoidance extends UIForce_4.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_23.ST_COLOR_ID.kGold);
            box.add(title);
            this._m_labelForce = uiLabel_5.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_labelForce.setTint(stEnums_23.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_5.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_23.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_maxMagnitude);
        ...
        setTarget(_force) {
            ...
            if (arrivalForce !== undefined) {
                if (_force.getType() !== stEnums_23.ST_STEER_FORCE.kObstacleAvoidance) {
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_24, uiBox_5, uiLabel_6, uiSlider_6, UIForce_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceSeek extends UIForce_5.UIForce {
        ...
        setTarget(_force) {
            this._m_seek = _force;
            if (this._m_seek !== undefined) {
                if (_force.getType() !== stEnums_24.ST_STEER_FORCE.kSeek) {
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/forceInitState"], function (require, exports, master_15, debugManager_7, stEnums_25, forceInitState_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        init(_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_simulationManager = master.getManager(stEnums_25.ST_MANAGER_ID.kSimManager);
            this._m_wanderInitState = new forceInitState_6.ForceInitState();
            this._m_debugManager = master_15.Master.GetInstance().getManager(stEnums_25.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_25.ST_COLOR_ID.kPurple);
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_25.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_25.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, debugManager_7.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_25.ST_COLOR_ID.kOrange);
            let displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_25.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_25.ST_STEER_FORCE.kWander;
        }
        setInitMaxMagnitude() {
            this._m_forceMagnitude = this.getInitMaxMagnitude();
            return;
        ...
        setMaxMagnitude(_magnitude) {
            if (this._m_simulationManager.getState() === stEnums_25.ST_SIM_SATE.kStopped) {
...
define("managers/uiManager/uiControllers/UIForceWander", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_26, uiBox_6, uiLabel_7, uiSlider_7, UIForce_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceWander extends UIForce_6.UIForce {
        constructor(_scene) {
            ...
            this._m_labelForce.setTint(stEnums_26.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_7.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_26.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_maxMagnitude);
        ...
        setTarget(_force) {
            ...
            if (arrivalForce !== undefined) {
                if (_force.getType() !== stEnums_26.ST_STEER_FORCE.kWander) {
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "steeringBehavior/forceSeek", "master/master", "steeringBehavior/followPathInitState"], function (require, exports, stEnums_27, debugManager_8, forceSeek_1, master_16, followPathInitState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        init(_self, _force, _radius, _looping) {
            ...
            this._m_simulationManager = master.getManager(stEnums_27.ST_MANAGER_ID.kSimManager);
        ...
        updateDebug(_dt) {
            ...
            const forceToPath = this._m_forceToPath;
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + actualVelocity.x + forceToPath.x, self.y + actualVelocity.y + forceToPath.y, debugManager_8.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kYellow);
            this._m_debugManager.drawCircle(self.x, self.y, this._m_radius, debugManager_8.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_27.ST_COLOR_ID.kWhite);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        getType() {
            return stEnums_27.ST_STEER_FORCE.kFollowPath;
        }
        setInitMaxMagnitude() {
            this._m_seek.setInitMaxMagnitude();
            return;
        ...
        setForceToPathScale(_scale) {
            if (this._m_simulationManager.getState() === stEnums_27.ST_SIM_SATE.kStopped) {
...
define("managers/uiManager/uiControllers/UIForceFollowPath", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_28, uiBox_7, uiLabel_8, uiSlider_8, UIForce_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceFollowPath extends UIForce_7.UIForce {
        constructor(_scene) {
            ...
            this._m_labelForce.setTint(stEnums_28.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_8.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_28.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_maxMagnitude);
            ...
            visionLabel.setTint(stEnums_28.ST_COLOR_ID.kSkyBlueNeon);
            ...
            forcePathLabel.setTint(stEnums_28.ST_COLOR_ID.kSkyBlueNeon);
        ...
        setTarget(_force) {
            ...
            if (this._m_followPath !== undefined) {
                if (_force.getType() !== stEnums_28.ST_STEER_FORCE.kFollowPath) {
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_29, debugManager_9, master_17, forceInitState_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ForceConstant {
        init(_self, _forceDirection, _forceMagnitude, _isRelative, _controller) {
            ...
            this._m_simulationManager = master.getManager(stEnums_29.ST_MANAGER_ID.kSimManager);
            this._m_constantInitState = new forceInitState_8.ForceInitState();
            this._m_debugManager = master.getManager(stEnums_29.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setInitMaxMagnitude() {
        ...
        setMaxMagnitude(_magnitude) {
            if (this._m_simulationManager.getState() === stEnums_29.ST_SIM_SATE.kStopped) {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_9.DebugManager.FORCE_LINE_WIDTH, stEnums_29.ST_COLOR_ID.kOrange);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_9.DebugManager.FORCE_LINE_WIDTH, stEnums_29.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_29.ST_STEER_FORCE.kConstant;
        }
        setRelative() {
...
define("managers/uiManager/uiControllers/UIForceConstant", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_30, uiBox_8, uiLabel_9, uiSlider_9, UIForce_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceConstant extends UIForce_8.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_30.ST_COLOR_ID.kGold);
            this._m_title = title;
            box.add(title);
            this._m_labelForce = uiLabel_9.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_labelForce.setTint(stEnums_30.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_9.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_30.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_maxMagnitude);
        ...
        setTarget(_force) {
            ...
            if (this._m_force !== undefined) {
                if (_force.getType() !== stEnums_30.ST_STEER_FORCE.kConstant) {
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_31, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FleeForce extends forceSeek_2.SeekForce {
        ...
        getType() {
            return stEnums_31.ST_STEER_FORCE.kFlee;
        }
    }
    exports.FleeForce = FleeForce;
});
define("managers/uiManager/uiControllers/UIForceFlee", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_32, uiBox_9, uiLabel_10, uiSlider_10, UIForce_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceFlee extends UIForce_9.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_32.ST_COLOR_ID.kGold);
            this._m_title = title;
            box.add(title);
            this._m_labelForce = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_labelForce.setTint(stEnums_32.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_32.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_maxMagnitude);
            this._m_forceSlider = new uiSlider_10.UISlider(0, 0, _scene, 1, 300);
        ...
        setTarget(_force) {
            this._m_flee = _force;
            if (this._m_flee !== undefined) {
                if (_force.getType() !== stEnums_32.ST_STEER_FORCE.kFlee) {
...
define("managers/uiManager/uiImage", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIImage = void 0;
    class UIImage extends uiObject_10.UIObject {
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceEvade", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceObstacleAvoidance", "managers/uiManager/uiControllers/UIForceSeek", "managers/uiManager/uiControllers/UIForceWander", "managers/uiManager/uiControllers/UIForceFollowPath", "managers/uiManager/uiControllers/UIForceConstant", "managers/uiManager/uiControllers/UIForceFlee", "managers/uiManager/uiGroup", "managers/uiManager/uiImage", "listeners/mxListener", "listeners/mxListenerManager"], function (require, exports, stEnums_33, uiBox_10, uiComboBox_2, uiLabel_11, UIController_1, UIForceArrival_1, UIForceEvade_1, UIForcePursuit_1, UIForceObstacleAvoidance_1, UIForceSeek_1, UIForceWander_1, UIForceFollowPath_1, UIForceConstant_1, UIForceFlee_1, uiGroup_2, uiImage_1, mxListener_3, mxListenerManager_3) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_uiScene, _scene) {
            ...
            selectForce.setTint(stEnums_33.ST_COLOR_ID.kSkyBlueNeon);
            ...
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kSeek, new UIForceSeek_1.UIForceSeek(_scene));
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kFlee, new UIForceFlee_1.UIForceFlee(_scene));
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kArrive, new UIForceArrival_1.UIForceArrival(_scene));
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kPursue, new UIForcePursuit_1.UIForcePursuit(_scene));
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kEvade, new UIForceEvade_1.UIForceEvade(_scene));
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kWander, new UIForceWander_1.UIForceWander(_scene));
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kObstacleAvoidance, new UIForceObstacleAvoidance_1.UIForceObstacleAvoidance(_scene));
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kFollowPath, new UIForceFollowPath_1.UIForceFollowPath(_scene));
            this._addUIForce(stEnums_33.ST_STEER_FORCE.kConstant, new UIForceConstant_1.UIForceConstant(_scene));
            this.setTarget(undefined);
            return;
        }
        update() {
        ...
        setTarget(_actor) {
            ...
            const forceController = _actor.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiGroup", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_35, master_19, uiGroup_4, UIController_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UISimulationController extends UIController_3.UIController {
        ...
        static CreateSimControlBox(_mapScene) {
            ...
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_35.ST_MANAGER_ID.kSimManager);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_35.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_35.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_35.ST_SIM_SATE.kPaused) {
                this.m_master.resumeSimulation();
            }
            return;
        }
        _onSimulationStop() {
            if (this._m_simulationManager.getState() !== stEnums_35.ST_SIM_SATE.kStopped) {
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forceSeek"], function (require, exports, stEnums_36, shipFactory_1, uiSceneFactory_1, mapScene_4, master_21, forceConstant_1, forceSeek_3) {
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            const targetFController = targetActor.getComponent(stEnums_36.ST_COMPONENT_ID.kForceController);
            ...
            targetActor.sendMessage(stEnums_36.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_36.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_36.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_36.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            let seek = new forceSeek_3.SeekForce();
            seek.init(blueShip.getWrappedInstance(), targetActor.getWrappedInstance(), 125);
            let forceControl = blueShip.getComponent(stEnums_36.ST_COMPONENT_ID.kForceController);
            forceControl.addForce('seek_1', seek);
            const ambienceMng = master.getManager(stEnums_36.ST_MANAGER_ID.kAmbienceManager);
        ...
        _openSceneInfo() {
            ...
            const uiManger = master.getManager(stEnums_36.ST_MANAGER_ID.kUIManager);
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_37, shipFactory_2, uiSceneFactory_2, master_22, forceArrival_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnArrival extends Phaser.Scene {
        create() {
            ...
            shipActor.sendMessage(stEnums_37.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_37.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_37.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_2.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_37.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            ...
            let shipController = shipActor.getComponent(stEnums_37.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_38, shipFactory_3, uiSceneFactory_3, master_23, forceWander_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnWander extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 50);
...
define("scenes/sims/sceneEvade", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "managers/uiManager/uiButtonImg", "master/master", "steeringBehavior/forceEvade", "steeringBehavior/forceSeek"], function (require, exports, stEnums_39, shipFactory_4, uiSceneFactory_4, uiButtonImg_2, master_24, forceEvade_1, forceSeek_4) {
    ...
    class SceneEvade extends Phaser.Scene {
        create() {
            ...
            targetActor.sendMessage(stEnums_39.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_40, shipFactory_5, uiSceneFactory_5, master_25, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            ...
            obstacleActor0.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            let shipController = shipActor.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
            let obstacle0Controller = obstacleActor0.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
            let obstacle1Controller = obstacleActor1.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
            let obstacle2Controller = obstacleActor2.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
            let obstacle3Controller = obstacleActor3.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
            let obstacle4Controller = obstacleActor4.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
            let obstacle5Controller = obstacleActor5.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
            let obstacle6Controller = obstacleActor6.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
            let obstacle7Controller = obstacleActor7.getComponent(stEnums_40.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_41, shipFactory_6, uiSceneFactory_6, master_26, forceFlee_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_6.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
...
define("scenes/sims/scenePursuit", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forcePursue"], function (require, exports, stEnums_42, shipFactory_7, uiSceneFactory_7, master_27, forceConstant_2, forcePursue_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScenePursuit extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(targetActor);
            const targetFController = targetActor.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            const constantForce = new forceConstant_2.ForceConstant();
            constantForce.init(targetActor.getWrappedInstance(), new Phaser.Math.Vector2(0.4, 0.85), 300, true);
            targetFController.addForce("constant", constantForce);
            targetActor.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            ...
            simManager.addActor(blueShip);
            const blueFController = blueShip.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
...
define("factories/ambienceFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpSpriteController"], function (require, exports, baseActor_2, stEnums_43, cmpforceController_2, cmpInteractiveActor_2, cmpSpriteController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class AmbienceFactory {
        static CreateSatellite(_x, _y, _scene, _name) {
            ...
            actor.init();
            actor.sendMessage(stEnums_43.ST_MESSAGE_ID.kPlayAnimation, "satellite_a");
            actor.sendMessage(stEnums_43.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(_x, _y));
            actor.sendMessage(stEnums_43.ST_MESSAGE_ID.kSetMass, 1);
            return actor;
        }
    }
    exports.AmbienceFactory = AmbienceFactory;
});
define("scenes/sims/sceneFollowPath", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_44, ambienceFactory_1, shipFactory_8, uiSceneFactory_8, master_28, forceFollowPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SceneFollowPath extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            const simManager = master.getManager(stEnums_44.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            ...
            const blueShipFController = blueShip.getComponent(stEnums_44.ST_COMPONENT_ID.kForceController);
            blueShipFController.addForce("Follow Path", followPath);
            const uiManager = master.getManager(stEnums_44.ST_MANAGER_ID.kUIManager);
...
define("tutorialManager/tutorialManager", ["require", "exports", "commons/stEnums", "tutorialManager/tutState/tutState"], function (require, exports, stEnums_45, tutState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class TutorialManager {
        ...
        init() {
            const uiManger = this.m_master.getManager(stEnums_45.ST_MANAGER_ID.kUIManager);
...
define("tutorialManager/tutState/sttTutDebug", ["require", "exports", "commons/stEnums", "tutorialManager/tutState/tutState"], function (require, exports, stEnums_46, tutState_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SttTutDebug extends tutState_2.TutState {
        ...
        onEnter() {
            ...
            const simManager = this._m_manager.m_master.getManager(stEnums_46.ST_MANAGER_ID.kSimManager);
...
define("tutorialManager/tutState/sttTutForceMng", ["require", "exports", "commons/stEnums", "tutorialManager/tutState/tutState"], function (require, exports, stEnums_47, tutState_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SttTutForceMng extends tutState_3.TutState {
        ...
        onEnter() {
            ...
            this._m_activated_time = undefined;
            this._m_dispatched = false;
            const uiManager = this._m_manager.m_master.getManager(stEnums_47.ST_MANAGER_ID.kUIManager);
...
define("tutorialManager/tutState/sttTutIntro", ["require", "exports", "commons/stEnums", "tutorialManager/tutState/tutState"], function (require, exports, stEnums_48, tutState_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SttTutIntro extends tutState_4.TutState {
        onEnter() {
            ...
            this._m_activated_time = undefined;
            this._m_dispatched = false;
            const simManager = this._m_manager.m_master.getManager(stEnums_48.ST_MANAGER_ID.kSimManager);
...
define("scenes/sims/sceneTutorial", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceConstant", "tutorialManager/tutorialManager", "tutorialManager/tutState/sttTutDebug", "tutorialManager/tutState/sttTutForceMng", "tutorialManager/tutState/sttTutIntro", "tutorialManager/tutState/sttTutSelectDrag"], function (require, exports, stEnums_49, shipFactory_9, uiSceneFactory_9, mapScene_5, master_29, forceConstant_3, tutorialManager_1, sttTutDebug_1, sttTutForceMng_1, sttTutIntro_1, sttTutSelectDrag_1) {
    ...
    class ScnTutorial extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            const ambienceMap = mapScene_5.MapScene.CreateFromTiledMap("ambience_01", this);
            ambienceMap.clear();
            ambienceMap.destroy();
            let simManager = master.getManager(stEnums_49.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            const nexus = shipFactory_9.ShipFactory.CreateBlueShip(this, "ISS Nexus");
            simManager.addActor(nexus);
            const targetFController = nexus.getComponent(stEnums_49.ST_COMPONENT_ID.kForceController);
            ...
            targetFController.addForce("constant", constantForce);
            nexus.sendMessage(stEnums_49.ST_MESSAGE_ID.kSetMass, 3.0);
            nexus.sendMessage(stEnums_49.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            nexus.sendMessage(stEnums_49.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            nexus.sendMessage(stEnums_49.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.6));
            const scarletMist = shipFactory_9.ShipFactory.CreateRedShip(this, "Scarlet Mist");
            simManager.addActor(scarletMist);
            const scarletForceController = scarletMist.getComponent(stEnums_49.ST_COMPONENT_ID.kForceController);
            ...
            scarletMist.sendMessage(stEnums_49.ST_MESSAGE_ID.kSetMass, 3.0);
            scarletMist.sendMessage(stEnums_49.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            scarletMist.sendMessage(stEnums_49.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            scarletMist.sendMessage(stEnums_49.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.7, height * 0.6));
            const ambienceMng = master.getManager(stEnums_49.ST_MANAGER_ID.kAmbienceManager);
            ambienceMng.createStarDust(this);
            const uiManager = master.getManager(stEnums_49.ST_MANAGER_ID.kUIManager);
...
define("managers/uiManager/uiButton", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabel", "managers/uiManager/uiObject"], function (require, exports, stEnums_50, uiLabel_12, uiObject_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIButton = void 0;
    class UIButton extends uiObject_12.UIObject {
        constructor(_x, _y, _scene, _frame, _label, _buttonTint, _labelTint, _labelSize) {
            ...
            this._m_buttonTint = stEnums_50.ST_COLOR_ID.kWhite;
            ...
            let labeltint = stEnums_50.ST_COLOR_ID.kWhite;
...
define("managers/uiManager/uiSwitch", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UISwitch = void 0;
    class UISwitch extends uiObject_13.UIObject {
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_51.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_51.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_51.ST_BUTTON.kNo);
                return;
            }, messageBox);
