...
define("scenes/preload", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_7, master_2) {
    ...
    class Preload extends Phaser.Scene {
        preload() {
            ...
            loader.atlas('seek_book', "images/seek_book/seek_book.png", "images/seek_book/seek_book.js");
            loader.atlas('flee_book', "images/flee_book/flee_book.png", "images/flee_book/flee_book.js");
            loader.atlas('arrive_book', "images/arrive_book/arrive_book.png", "images/arrive_book/arrive_book.js");
            loader.atlas('pursuit_book', "images/pursuit_book/pursuit_book.png", "images/pursuit_book/pursuit_book.js");
            loader.atlas('evade_book', "images/evade_book/evade_book.png", "images/evade_book/evade_book.js");
            loader.atlas('wander_book', "images/wander_book/wander_book.png", "images/wander_book/wander_book.js");
            loader.atlas('avoidance_book', "images/avoidance_book/avoidance_book.png", "images/avoidance_book/avoidance_book.js");
            loader.atlas('path_book', "images/path_book/path_book.png", "images/path_book/path_book.js");
...
define("components/cmpSpriteController", ["require", "exports", "commons/stEnums", "master/master", "components/actorInitState"], function (require, exports, stEnums_13, master_8, actorInitState_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpSpriteController {
        ...
        receive(_id, _obj) {
            switch (_id) {
                case stEnums_13.ST_MESSAGE_ID.kMove:
                    {
                        let v2 = _obj;
                        this.move(v2.x, v2.y);
                    }
                    return;
                case stEnums_13.ST_MESSAGE_ID.kSetPosition:
                    {
                        let v2 = _obj;
                    ...
                    return;
                case stEnums_13.ST_MESSAGE_ID.kSetScale:
                    {
                        let v2 = _obj;
                        this.setScale(v2.x, v2.y);
                    }
                    return;
                case stEnums_13.ST_MESSAGE_ID.kSetAngle:
                    this._m_sprite.setAngle(Phaser.Math.RadToDeg(_obj));
                    return;
                case stEnums_13.ST_MESSAGE_ID.kSetAlpha:
                    this.setAlpha(_obj);
                    return;
                case stEnums_13.ST_MESSAGE_ID.kPlayAnimation:
        ...
        getID() {
            return stEnums_13.ST_COMPONENT_ID.kSpriteController;
        }
        destroy() {
...
define("factories/ambienceFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpSpriteController"], function (require, exports, baseActor_1, stEnums_14, cmpforceController_1, cmpInteractiveActor_1, cmpSpriteController_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class AmbienceFactory {
        static CreateSatellite(_x, _y, _scene, _name) {
            ...
            let actor = baseActor_1.BaseActor.Create(sprite, _name);
            actor.addComponent(new cmpSpriteController_1.CmpSpriteController());
            actor.addComponent(new cmpforceController_1.CmpForceController());
            actor.addComponent(new cmpInteractiveActor_1.cmpInteractiveActor());
            actor.init();
            actor.sendMessage(stEnums_14.ST_MESSAGE_ID.kPlayAnimation, "satellite_a");
            actor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(_x, _y));
            actor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetMass, 1);
            return actor;
        }
    }
...
define("steeringBehavior/forceInitState", ["require", "exports"], function (require, exports) {
    ...
    class ForceInitState {
        constructor() {
            this.m_initMaxMagnitude = 0;
        }
    }
    exports.ForceInitState = ForceInitState;
});
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_15, debugManager_2, master_9, forceInitState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SeekForce {
        init(_self, _target, _force, _controller) {
            ...
            this._m_debugManager = master.getManager(stEnums_15.ST_MANAGER_ID.kDebugManager);
            return;
        }
        ...
        updateDebug(_dt) {
            ...
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_15.ST_COLOR_ID.kOrange);
            let actualVelocity = this._m_controller.getVelocity();
            const pX = self.x + actualVelocity.x;
            const pY = self.y + actualVelocity.y;
            this._m_debugManager.drawLine(pX, pY, pX + this._m_seekForce.x, pY + this._m_seekForce.y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_15.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_15.ST_STEER_FORCE.kSeek;
        }
        destroy() {
...
define("components/cmpShipPropulsor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_16, master_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpShipPropulsor {
        ...
        update(_actor) {
            const forceController = _actor.getComponent(stEnums_16.ST_COMPONENT_ID.kForceController);
        ...
        getID() {
            return stEnums_16.ST_COMPONENT_ID.kShipPropulsor;
        }
        destroy() {
...
define("factories/shipFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpShipPropulsor", "components/cmpSpriteController"], function (require, exports, baseActor_2, stEnums_17, cmpforceController_2, cmpInteractiveActor_2, cmpShipPropulsor_1, cmpSpriteController_2) {
    ...
    class ShipFactory {
        static CreateBlueShip(_scene, _UniqueName) {
            ...
            let shipActor = baseActor_2.BaseActor.Create(shipSprite, _UniqueName);
            ...
            shipActor.addComponent(new cmpInteractiveActor_2.cmpInteractiveActor());
            shipActor.addComponent(shipPropulsor);
            shipActor.init();
            shipPropulsor.setAnimation("blueBackFire");
            shipActor.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetMaxSpeed, 500);
            shipActor.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            let canvas = _scene.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            shipActor.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            shipActor.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetMass, 1);
            return shipActor;
        }
        static CreateYellowShip(_scene, _UniqueName) {
            let shipSprite = _scene.add.sprite(0, 0, 'game_art', 'yellowShip.png');
            let shipActor = baseActor_2.BaseActor.Create(shipSprite, _UniqueName);
            let shipPropulsor = new cmpShipPropulsor_1.CmpShipPropulsor();
            shipActor.addComponent(new cmpSpriteController_2.CmpSpriteController());
            shipActor.addComponent(new cmpforceController_2.CmpForceController());
...
define("steeringBehavior/arrivalInitState", ["require", "exports", "steeringBehavior/forceInitState"], function (require, exports, forceInitState_2) {
    ...
    class ArrivalInitState extends forceInitState_2.ForceInitState {
        constructor() {
            super(...arguments);
            this.m_initArrivalRadius = 0;
        }
    }
    exports.ArrivalInitState = ArrivalInitState;
});
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/arrivalInitState"], function (require, exports, master_11, debugManager_3, stEnums_18, arrivalInitState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ArrivalForce {
        init(_self, _target, _arrivalRadius, _force, _controller) {
            ...
            this._m_debugManager = master_11.Master.GetInstance().getManager(stEnums_18.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            ...
            let target = this._m_target;
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_3.DebugManager.FORCE_LINE_WIDTH, stEnums_18.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_3.DebugManager.FORCE_LINE_WIDTH, stEnums_18.ST_COLOR_ID.kOrange);
            debugManager.drawCircle(target.x, target.y, this._m_arrivalRadius, debugManager_3.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_18.ST_COLOR_ID.kSkyBlueNeon);
        ...
        getType() {
            return stEnums_18.ST_STEER_FORCE.kArrive;
        }
        getInitMaxMagnitude() {
...
define("managers/uiManager/uiControllers/UIForceArrival", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_19, uiBox_1, uiLabel_2, uiSlider_2, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceArrival extends UIForce_1.UIForce {
        constructor(_scene) {
            ...
            this._m_labelForce.setTint(stEnums_19.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_2.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_19.ST_COLOR_ID.kSkyBlueNeon);
            ...
            arrivalLabel.setTint(stEnums_19.ST_COLOR_ID.kSkyBlueNeon);
        ...
        setTarget(_force) {
            ...
            if (arrivalForce !== undefined) {
                if (_force.getType() !== stEnums_19.ST_STEER_FORCE.kArrive) {
...
define("steeringBehavior/forceEvade", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_20, debugManager_4, master_12, forceInitState_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class EvadeForce {
        init(_self, _target, _maxForceMagnitude) {
            ...
            this._m_debugManager = master_12.Master.GetInstance().getManager(stEnums_20.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_4.DebugManager.FORCE_LINE_WIDTH, stEnums_20.ST_COLOR_ID.kOrange);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_4.DebugManager.FORCE_LINE_WIDTH, stEnums_20.ST_COLOR_ID.kRed);
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, debugManager_4.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_20.ST_COLOR_ID.kSkyBlueNeon);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_20.ST_STEER_FORCE.kEvade;
        }
        getInitMaxMagnitude() {
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_21, debugManager_5, master_13, forceInitState_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        init(_self, _target, _maxForceMagnitude) {
            this._m_self = _self.getWrappedInstance();
            this._m_target = _target.getWrappedInstance();
            this._m_controller = _self.getComponent(stEnums_21.ST_COMPONENT_ID.kForceController);
            this._m_targetController = _target.getComponent(stEnums_21.ST_COMPONENT_ID.kForceController);
            this._m_maxForceMagnitude = _maxForceMagnitude;
            this._m_desireVelocity = new Phaser.Math.Vector2();
            this._m_targetPosition = new Phaser.Math.Vector2();
            this._m_selfPosition = new Phaser.Math.Vector2();
            ...
            this._m_simulationManager = master.getManager(stEnums_21.ST_MANAGER_ID.kSimManager);
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_5.DebugManager.FORCE_LINE_WIDTH, stEnums_21.ST_COLOR_ID.kOrange);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_5.DebugManager.FORCE_LINE_WIDTH, stEnums_21.ST_COLOR_ID.kRed);
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, debugManager_5.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_21.ST_COLOR_ID.kSkyBlueNeon);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_21.ST_STEER_FORCE.kPursue;
        }
        getInitMaxMagnitude() {
        ...
        setMaxMagnitude(_maxMagnitude) {
            if (this._m_simulationManager.getState() === stEnums_21.ST_SIM_SATE.kStopped) {
...
define("managers/uiManager/uiControllers/UIForceEvade", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_22, uiBox_2, uiLabel_3, uiSlider_3, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceEvade extends UIForce_2.UIForce {
        ...
        setTarget(_force) {
            ...
            if (evadeForce !== undefined) {
                if (_force.getType() !== stEnums_22.ST_STEER_FORCE.kEvade) {
...
define("managers/uiManager/uiControllers/UIForcePursuit", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_23, uiBox_3, uiLabel_4, uiSlider_4, UIForce_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForcePursuit extends UIForce_3.UIForce {
        ...
        setTarget(_force) {
            ...
            if (pursuitForce !== undefined) {
                if (_force.getType() !== stEnums_23.ST_STEER_FORCE.kPursue) {
...
define("steeringBehavior/obstacleAvoidanceInitState", ["require", "exports", "steeringBehavior/forceInitState"], function (require, exports, forceInitState_5) {
    ...
    class ObstacleAvoidanceInitState extends forceInitState_5.ForceInitState {
        constructor() {
            super(...arguments);
            this.m_initAvoidanceRadius = 0;
        }
    }
    exports.ObstacleAvoidanceInitState = ObstacleAvoidanceInitState;
});
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/obstacleAvoidanceInitState"], function (require, exports, master_14, debugManager_6, stEnums_24, obstacleAvoidanceInitState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_simulationManager = master.getManager(stEnums_24.ST_MANAGER_ID.kSimManager);
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            let distanceToObstacle = new Phaser.Math.Vector2(0.0, 0.0);
            let desiredVelocity = new Phaser.Math.Vector2(0.0, 0.0);
            this._m_obstaclesArray.forEach(obstacle => {
                let distance = distanceToObstacle.set(sprite.x - obstacle.x, sprite.y - obstacle.y).length();
            ...
            this._m_debugManager.drawLine(sprite.x, sprite.y, sprite.x + desiredVelocity.x, sprite.y + desiredVelocity.y, debugManager_6.DebugManager.FORCE_LINE_WIDTH, stEnums_24.ST_COLOR_ID.kOrange);
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, desiredVelocity.x + sprite.x, desiredVelocity.y + sprite.y, debugManager_6.DebugManager.FORCE_LINE_WIDTH, stEnums_24.ST_COLOR_ID.kRed);
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, debugManager_6.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_24.ST_COLOR_ID.kSkyBlueNeon);
        }
        onDebugEnable() {
        }
        onDebugDisable() {
        ...
        setMaxMagnitude(_magnitude) {
            if (this._m_simulationManager.getState() === stEnums_24.ST_SIM_SATE.kStopped) {
...
define("managers/uiManager/uiControllers/UIForceObstacleAvoidance", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_25, uiBox_4, uiLabel_5, uiSlider_5, UIForce_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceObstacleAvoidance extends UIForce_4.UIForce {
        constructor(_scene) {
            ...
            avoidanceLabel.setTint(stEnums_25.ST_COLOR_ID.kSkyBlueNeon);
        ...
        setTarget(_force) {
            ...
            if (avoidanceForce !== undefined) {
                if (_force.getType() !== stEnums_25.ST_STEER_FORCE.kObstacleAvoidance) {
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_26, uiBox_5, uiLabel_6, uiSlider_6, UIForce_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceSeek extends UIForce_5.UIForce {
        ...
        setTarget(_force) {
            this._m_seek = _force;
            if (this._m_seek !== undefined) {
                if (_force.getType() !== stEnums_26.ST_STEER_FORCE.kSeek) {
...
define("steeringBehavior/wanderInitState", ["require", "exports", "steeringBehavior/forceInitState"], function (require, exports, forceInitState_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.WanderInitState = void 0;
    class WanderInitState extends forceInitState_6.ForceInitState {
        constructor() {
            super(...arguments);
            this.m_initTargetDistance = 0;
            this.m_initCircleRadius = 0;
            this.m_initDisplacementAngle = 0;
            this.m_initAngleChange = 0;
        }
    }
    exports.WanderInitState = WanderInitState;
});
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/wanderInitState"], function (require, exports, master_15, debugManager_7, stEnums_27, wanderInitState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        init(_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_wanderInitState = new wanderInitState_1.WanderInitState();
            ...
            this._m_debugManager = master_15.Master.GetInstance().getManager(stEnums_27.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            ...
            let sprite = this._m_self;
            let controller = this._m_controller;
            let circleCenter = new Phaser.Math.Vector2(Math.cos(sprite.rotation), Math.sin(sprite.rotation));
            circleCenter.scale(this._m_targetDistance);
            debugManager.drawLine(sprite.x, sprite.y, circleCenter.x + sprite.x, circleCenter.y + sprite.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kPurple);
            ...
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, circleCenter.x + sprite.x + displacement.x, circleCenter.y + sprite.y + displacement.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, circleCenter.x + sprite.x + displacement.x, circleCenter.y + sprite.y + displacement.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kOrange);
            debugManager.drawCircle(circleCenter.x + sprite.x, circleCenter.y + sprite.y, this._m_circleRadius, debugManager_7.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_27.ST_COLOR_ID.kSkyBlueNeon);
            debugManager.drawLine(circleCenter.x + sprite.x, circleCenter.y + sprite.y, circleCenter.x + sprite.x + displacement.x, circleCenter.y + sprite.y + displacement.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kYellow);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_27.ST_STEER_FORCE.kWander;
        }
        setInitMaxMagnitude() {
            this._m_forceMagnitude = this.getInitMaxMagnitude();
            return;
        ...
        setDisplacementAngle(_displacementAngle) {
            if (this._m_simulationManager.getState() === stEnums_27.ST_SIM_SATE.kStopped) {
                this._m_wanderInitState.m_initDisplacementAngle = _displacementAngle;
            }
            this._m_displacementAngle = _displacementAngle;
...
define("managers/uiManager/uiControllers/UIForceWander", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_28, uiBox_6, uiLabel_7, uiSlider_7, UIForce_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceWander extends UIForce_6.UIForce {
        constructor(_scene) {
            ...
            box.add(this._m_forceSlider);
            this._m_targetDistanceLabel = uiLabel_7.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_targetDistanceLabel.setTint(stEnums_28.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_targetDistanceLabel);
            this._m_targetDistanceSlider = new uiSlider_7.UISlider(0, 0, _scene, 10, 200);
            this._m_targetDistanceSlider.subscribe("valueChanged", "UIForceWander", function (_sender, _args) {
                const slider = _sender;
            ...
            this._m_circleRadiusLabel = uiLabel_7.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_circleRadiusLabel.setTint(stEnums_28.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_circleRadiusLabel);
            this._m_circleRadiusSlider = new uiSlider_7.UISlider(0, 0, _scene, 10, 200);
            this._m_circleRadiusSlider.subscribe("valueChanged", "UIForceWander", function (_sender, _args) {
                const slider = _sender;
            ...
            this._m_displacementAngleLabel = uiLabel_7.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_displacementAngleLabel.setTint(stEnums_28.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_displacementAngleLabel);
            this._m_displacementAngleSlider = new uiSlider_7.UISlider(0, 0, _scene, 0, 360);
            this._m_displacementAngleSlider.subscribe("valueChanged", "UIForceWander", function (_sender, _args) {
                const slider = _sender;
            ...
            this._m_angleChangeLabel = uiLabel_7.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_angleChangeLabel.setTint(stEnums_28.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_angleChangeLabel);
            this._m_angleChangeSlider = new uiSlider_7.UISlider(0, 0, _scene, 0, 360);
            this._m_angleChangeSlider.subscribe("valueChanged", "UIForceWander", function (_sender, _args) {
                const slider = _sender;
        ...
        setTarget(_force) {
            const wanderForce = _force;
            this._m_wander = wanderForce;
            if (wanderForce !== undefined) {
                if (_force.getType() !== stEnums_28.ST_STEER_FORCE.kWander) {
...
define("steeringBehavior/followPathInitState", ["require", "exports", "steeringBehavior/forceInitState"], function (require, exports, forceInitState_7) {
    ...
    class FollowPathInitState extends forceInitState_7.ForceInitState {
        constructor() {
            super(...arguments);
            this.m_initForceToPathScale = 0;
            this.m_initVisionRadius = 0;
        }
    }
    exports.FollowPathInitState = FollowPathInitState;
});
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "steeringBehavior/forceSeek", "master/master", "steeringBehavior/followPathInitState"], function (require, exports, stEnums_29, debugManager_8, forceSeek_1, master_16, followPathInitState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        ...
        updateDebug(_dt) {
            ...
            while (nextNode !== firstNode && nextNode !== undefined) {
                ...
                this._m_debugManager.drawLine(activeSpr.x, activeSpr.y, nextSpr.x, nextSpr.y, debugManager_8.DebugManager.FORCE_LINE_WIDTH, stEnums_29.ST_COLOR_ID.kWhite);
                activeNode = nextNode;
                nextNode = activeNode.getNext();
            }
            this._m_debugManager.drawLine(activeNode.getWrappedInstance().x, activeNode.getWrappedInstance().y, this._m_startNode.getWrappedInstance().x, this._m_startNode.getWrappedInstance().y, debugManager_8.DebugManager.FORCE_LINE_WIDTH, stEnums_29.ST_COLOR_ID.kWhite);
            this._m_seek.updateDebug(_dt);
            const self = this._m_self.getWrappedInstance();
            const actualVelocity = this._m_controller.getVelocity();
            const forceToPath = this._m_forceToPath;
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + actualVelocity.x + forceToPath.x, self.y + actualVelocity.y + forceToPath.y, debugManager_8.DebugManager.FORCE_LINE_WIDTH, stEnums_29.ST_COLOR_ID.kYellow);
            this._m_debugManager.drawCircle(self.x, self.y, this._m_radius, debugManager_8.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_29.ST_COLOR_ID.kWhite);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        getType() {
            return stEnums_29.ST_STEER_FORCE.kFollowPath;
        }
        setInitMaxMagnitude() {
...
define("managers/uiManager/uiControllers/UIForceFollowPath", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_30, uiBox_7, uiLabel_8, uiSlider_8, UIForce_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceFollowPath extends UIForce_7.UIForce {
        constructor(_scene) {
            ...
            visionLabel.setTint(stEnums_30.ST_COLOR_ID.kSkyBlueNeon);
            ...
            forcePathLabel.setTint(stEnums_30.ST_COLOR_ID.kSkyBlueNeon);
            this._m_forceToPathLabel = forcePathLabel;
            box.add(forcePathLabel);
            this._m_forceToPathSlider = new uiSlider_8.UISlider(0, 0, _scene, 1, 100);
        ...
        setTarget(_force) {
            ...
            if (this._m_followPath !== undefined) {
                if (_force.getType() !== stEnums_30.ST_STEER_FORCE.kFollowPath) {
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceInitState"], function (require, exports, stEnums_31, debugManager_9, master_17, forceInitState_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ForceConstant {
        init(_self, _forceDirection, _forceMagnitude, _isRelative, _controller) {
            ...
            this._m_simulationManager = master.getManager(stEnums_31.ST_MANAGER_ID.kSimManager);
            ...
            this._m_debugManager = master.getManager(stEnums_31.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setInitMaxMagnitude() {
        ...
        setMaxMagnitude(_magnitude) {
            if (this._m_simulationManager.getState() === stEnums_31.ST_SIM_SATE.kStopped) {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_9.DebugManager.FORCE_LINE_WIDTH, stEnums_31.ST_COLOR_ID.kOrange);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, debugManager_9.DebugManager.FORCE_LINE_WIDTH, stEnums_31.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_31.ST_STEER_FORCE.kConstant;
        }
        setRelative() {
...
define("managers/uiManager/uiControllers/UIForceConstant", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_32, uiBox_8, uiLabel_9, uiSlider_9, UIForce_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceConstant extends UIForce_8.UIForce {
        ...
        setTarget(_force) {
            ...
            if (this._m_force !== undefined) {
                if (_force.getType() !== stEnums_32.ST_STEER_FORCE.kConstant) {
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_33, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FleeForce extends forceSeek_2.SeekForce {
        ...
        getType() {
            return stEnums_33.ST_STEER_FORCE.kFlee;
        }
    }
    exports.FleeForce = FleeForce;
});
define("managers/uiManager/uiControllers/UIForceFlee", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_34, uiBox_9, uiLabel_10, uiSlider_10, UIForce_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceFlee extends UIForce_9.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_34.ST_COLOR_ID.kGold);
            this._m_title = title;
            box.add(title);
            this._m_labelForce = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_labelForce.setTint(stEnums_34.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_labelForce);
            this._m_maxMagnitude = uiLabel_10.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._m_maxMagnitude.setTint(stEnums_34.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._m_maxMagnitude);
        ...
        setTarget(_force) {
            this._m_flee = _force;
            if (this._m_flee !== undefined) {
                if (_force.getType() !== stEnums_34.ST_STEER_FORCE.kFlee) {
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceEvade", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceObstacleAvoidance", "managers/uiManager/uiControllers/UIForceSeek", "managers/uiManager/uiControllers/UIForceWander", "managers/uiManager/uiControllers/UIForceFollowPath", "managers/uiManager/uiControllers/UIForceConstant", "managers/uiManager/uiControllers/UIForceFlee", "managers/uiManager/uiGroup", "managers/uiManager/uiImage", "listeners/mxListener", "listeners/mxListenerManager"], function (require, exports, stEnums_35, uiBox_10, uiComboBox_2, uiLabel_11, UIController_1, UIForceArrival_1, UIForceEvade_1, UIForcePursuit_1, UIForceObstacleAvoidance_1, UIForceSeek_1, UIForceWander_1, UIForceFollowPath_1, UIForceConstant_1, UIForceFlee_1, uiGroup_2, uiImage_1, mxListener_3, mxListenerManager_3) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_uiScene, _scene) {
            ...
            selectForce.setTint(stEnums_35.ST_COLOR_ID.kSkyBlueNeon);
            ...
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kSeek, new UIForceSeek_1.UIForceSeek(_scene));
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kFlee, new UIForceFlee_1.UIForceFlee(_scene));
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kArrive, new UIForceArrival_1.UIForceArrival(_scene));
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kPursue, new UIForcePursuit_1.UIForcePursuit(_scene));
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kEvade, new UIForceEvade_1.UIForceEvade(_scene));
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kWander, new UIForceWander_1.UIForceWander(_scene));
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kObstacleAvoidance, new UIForceObstacleAvoidance_1.UIForceObstacleAvoidance(_scene));
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kFollowPath, new UIForceFollowPath_1.UIForceFollowPath(_scene));
            this._addUIForce(stEnums_35.ST_STEER_FORCE.kConstant, new UIForceConstant_1.UIForceConstant(_scene));
            this.setTarget(undefined);
            return;
        }
        update() {
        ...
        setTarget(_actor) {
            ...
            const forceController = _actor.getComponent(stEnums_35.ST_COMPONENT_ID.kForceController);
    ...
    class UIInfoBox extends UIController_2.UIController {
        constructor(_scene, _sceneMap) {
            ...
            this._m_close.subscribe("buttonReleased", "infoBox", function (_sender, _args) {
                this._m_audioManager.playClip(stEnums_36.ST_AUDIO_CLIP.kNegativeB);
                this.close();
                return;
            }, this);
            ...
            this._m_audioManager = master.getManager(stEnums_36.ST_MANAGER_ID.kAudioManager);
            return;
        }
        open() {
            this._m_group.setActive(true);
            ...
            this._displayPage();
            this._m_audioManager.playClip(stEnums_36.ST_AUDIO_CLIP.kOpenBook);
            return;
        }
        close() {
            this._m_group.setActive(false);
        ...
        nextPage() {
            if (this._m_book !== undefined) {
                if (this._m_book.nextPage()) {
                    this._displayPage();
                    this._m_audioManager.playClip(stEnums_36.ST_AUDIO_CLIP.kPositiveC);
                }
                else {
                    this._m_audioManager.playClip(stEnums_36.ST_AUDIO_CLIP.kNegativeA);
                    this.close();
                }
            }
            return;
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiGroup", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_37, master_19, uiGroup_4, UIController_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UISimulationController extends UIController_3.UIController {
        ...
        static CreateSimControlBox(_mapScene) {
            ...
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_37.ST_MANAGER_ID.kSimManager);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_37.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_37.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_37.ST_SIM_SATE.kPaused) {
                this.m_master.resumeSimulation();
            }
            return;
        }
        _onSimulationStop() {
            if (this._m_simulationManager.getState() !== stEnums_37.ST_SIM_SATE.kStopped) {
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceFollowPath", "steeringBehavior/forceSeek"], function (require, exports, stEnums_38, ambienceFactory_1, shipFactory_1, uiSceneFactory_1, mapScene_4, master_21, forceFollowPath_1, forceSeek_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            const nexus = shipFactory_1.ShipFactory.CreateBlueShip(this, "ISS Nexus");
            simManager.addActor(nexus);
            nexus.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.6));
            nexus.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMass, 3.17);
            ...
            for (let i = 0; i < 3; ++i) {
                const node = ambienceFactory_1.AmbienceFactory.CreateSatellite(x + (Math.sin(t * i) * 200), y + (Math.cos(t * i) * 200), this, "Satellite_" + i.toString());
            ...
            const scarletMist = shipFactory_1.ShipFactory.CreateRedShip(this, "Scarlet Mist");
            simManager.addActor(scarletMist);
            const targetFController = scarletMist.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            scarletMist.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMass, 3.0);
            scarletMist.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 203);
            scarletMist.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.7, height * 0.6));
            const followPath = new forceFollowPath_1.FollowPathForce();
            followPath.init(scarletMist, 2214, 24, true);
            followPath.setForceToPathScale(14);
            followPath.setStartNode(startNode);
            const rhapsodyFController = scarletMist.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            rhapsodyFController.addForce("Follow Path", followPath);
            let seek = new forceSeek_3.SeekForce();
            seek.init(nexus.getWrappedInstance(), scarletMist.getWrappedInstance(), 1940);
            let forceControl = nexus.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
        ...
        _openSceneInfo() {
            ...
            const uiManger = master.getManager(stEnums_38.ST_MANAGER_ID.kUIManager);
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_39, shipFactory_2, uiSceneFactory_2, mapScene_5, master_22, forceArrival_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnArrival extends Phaser.Scene {
        create() {
            ...
            shipActor.sendMessage(stEnums_39.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_39.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_39.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_2.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_39.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            ...
            uiSceneFactory_2.SceneUIFactory.CreateSimulationUIScene("simulation_ui", this, uiManager, this._openSceneInfo, this);
        ...
        _openSceneInfo() {
            const master = this._m_master;
            master.pauseSimulation();
            const uiManger = master.getManager(stEnums_39.ST_MANAGER_ID.kUIManager);
            const infoBox = uiManger.getUIController("infoBox");
            infoBox.setBook("arrive");
            infoBox.open();
            return;
        }
    }
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_40, shipFactory_3, uiSceneFactory_3, mapScene_6, master_23, forceWander_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnWander extends Phaser.Scene {
        create() {
            ...
            uiSceneFactory_3.SceneUIFactory.CreateSimulationUIScene("simulation_ui", this, uiManager, this._openSceneInfo, this);
            uiManager.setTarget(shipActor);
            this._openSceneInfo();
            this._m_master.stopSimulation();
            return;
        ...
        _openSceneInfo() {
            const master = this._m_master;
            master.pauseSimulation();
            const uiManger = master.getManager(stEnums_40.ST_MANAGER_ID.kUIManager);
            const infoBox = uiManger.getUIController("infoBox");
...
define("scenes/sims/sceneEvade", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "managers/uiManager/uiButtonImg", "master/master", "steeringBehavior/forceEvade", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_41, ambienceFactory_2, shipFactory_4, uiSceneFactory_4, mapScene_7, uiButtonImg_2, master_24, forceEvade_1, forceFollowPath_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SceneEvade extends Phaser.Scene {
        create() {
            ...
            for (let i = 0; i < 4; ++i) {
                const node = ambienceFactory_2.AmbienceFactory.CreateSatellite(x + (Math.sin(t * i) * 200), y + (Math.cos(t * i) * 200), this, "Satellite_" + i.toString());
                if (prevNode === undefined) {
                    startNode = node;
                    prevNode = node;
                }
            ...
            const rhapsody = shipFactory_4.ShipFactory.CreateYellowShip(this, "SSE Rhapsody");
            simManager.addActor(rhapsody);
            rhapsody.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetMass, 2.84);
            rhapsody.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetMaxSpeed, 170);
            rhapsody.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.6, height * 0.85));
            const followPath = new forceFollowPath_2.FollowPathForce();
            followPath.init(rhapsody, 2214, 24, true);
            followPath.setForceToPathScale(14);
            followPath.setStartNode(startNode);
            const rhapsodyFController = rhapsody.getComponent(stEnums_41.ST_COMPONENT_ID.kForceController);
            rhapsodyFController.addForce("Follow Path", followPath);
            const nexus = shipFactory_4.ShipFactory.CreateBlueShip(this, "ISS Nexus");
            simManager.addActor(nexus);
            nexus.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetMass, 3.12);
            nexus.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetMaxSpeed, 116);
            nexus.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.6, height * 0.65));
            const blueFController = nexus.getComponent(stEnums_41.ST_COMPONENT_ID.kForceController);
            const evadeForce = new forceEvade_1.EvadeForce();
            evadeForce.init(nexus, rhapsody, 1700);
            ...
            uiSceneFactory_4.SceneUIFactory.CreateSimulationUIScene("simulation_ui", this, uiManager, this._openSceneInfo, this);
            uiManager.setTarget(nexus);
            this._openSceneInfo();
            this._m_master.stopSimulation();
            return;
        ...
        _openSceneInfo() {
            const master = this._m_master;
            master.pauseSimulation();
            const uiManger = master.getManager(stEnums_41.ST_MANAGER_ID.kUIManager);
            const infoBox = uiManger.getUIController("infoBox");
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_42, shipFactory_5, uiSceneFactory_5, mapScene_8, master_25, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            shipActor.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(x, y));
            const t = (Phaser.Math.PI2 / 10);
            let obstaclesArray = new Array();
            for (let i = 0; i < 10; i++) {
                const obstacle = shipFactory_5.ShipFactory.CreateRedShip(this, 'obstacle' + i.toString());
                simManager.addActor(obstacle);
                obstacle.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetMaxSpeed, 25);
                obstacle.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(x + (Math.sin(t * i) * 150), y + (Math.cos(t * i) * 150)));
                obstaclesArray.push(obstacle.getWrappedInstance());
                const obstacleWander = new forceWander_2.WanderForce();
                obstacleWander.init(obstacle.getWrappedInstance(), 50, 25, 5, 45, 100);
                const obstacleController = obstacle.getComponent(stEnums_42.ST_COMPONENT_ID.kForceController);
            ...
            uiSceneFactory_5.SceneUIFactory.CreateSimulationUIScene("simulation_ui", this, uiManager, this._openSceneInfo, this);
            uiManager.setTarget(shipActor);
            this._openSceneInfo();
            this._m_master.stopSimulation();
            return;
        ...
        _openSceneInfo() {
            const master = this._m_master;
            master.pauseSimulation();
            const uiManger = master.getManager(stEnums_42.ST_MANAGER_ID.kUIManager);
            const infoBox = uiManger.getUIController("infoBox");
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_43, shipFactory_6, uiSceneFactory_6, mapScene_9, master_26, forceFlee_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_43.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_43.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_43.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.45));
            let targetActor = shipFactory_6.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_43.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_43.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.65));
            let flee = new forceFlee_1.FleeForce();
            flee.init(shipActor.getWrappedInstance(), targetActor.getWrappedInstance(), 100);
            let shipController = shipActor.getComponent(stEnums_43.ST_COMPONENT_ID.kForceController);
            ...
            uiSceneFactory_6.SceneUIFactory.CreateSimulationUIScene("simulation_ui", this, uiManager, this._openSceneInfo, this);
            uiManager.setTarget(shipActor);
            this._openSceneInfo();
            this._m_master.stopSimulation();
            return;
        ...
        _openSceneInfo() {
            const master = this._m_master;
            master.pauseSimulation();
            const uiManger = master.getManager(stEnums_43.ST_MANAGER_ID.kUIManager);
            const infoBox = uiManger.getUIController("infoBox");
...
define("scenes/sims/scenePursuit", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceFollowPath", "steeringBehavior/forcePursue"], function (require, exports, stEnums_44, ambienceFactory_3, shipFactory_7, uiSceneFactory_7, mapScene_10, master_27, forceFollowPath_3, forcePursue_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScenePursuit extends Phaser.Scene {
        create() {
            ...
            ambienceMap.clear();
            ambienceMap.destroy();
            let simManager = master.getManager(stEnums_44.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            const x = canvas.width * 0.6;
            ...
            const t = (Phaser.Math.PI2 / 4);
            for (let i = 0; i < 4; ++i) {
                const node = ambienceFactory_3.AmbienceFactory.CreateSatellite(x + (Math.sin(t * i) * 200), y + (Math.cos(t * i) * 200), this, "Satellite_" + i.toString());
                if (prevNode === undefined) {
                    startNode = node;
                    prevNode = node;
                }
            ...
            const rhapsody = shipFactory_7.ShipFactory.CreateYellowShip(this, "SSE Rhapsody");
            simManager.addActor(rhapsody);
            rhapsody.sendMessage(stEnums_44.ST_MESSAGE_ID.kSetMass, 2.84);
            rhapsody.sendMessage(stEnums_44.ST_MESSAGE_ID.kSetMaxSpeed, 200);
            rhapsody.sendMessage(stEnums_44.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.6, height * 0.6));
            const followPath = new forceFollowPath_3.FollowPathForce();
            followPath.init(rhapsody, 2214, 24, true);
            followPath.setForceToPathScale(14);
            followPath.setStartNode(startNode);
            const rhapsodyFController = rhapsody.getComponent(stEnums_44.ST_COMPONENT_ID.kForceController);
            rhapsodyFController.addForce("Follow Path", followPath);
            const nexus = shipFactory_7.ShipFactory.CreateBlueShip(this, "ISS Nexus");
            simManager.addActor(nexus);
            nexus.sendMessage(stEnums_44.ST_MESSAGE_ID.kSetMass, 3.12);
            const blueFController = nexus.getComponent(stEnums_44.ST_COMPONENT_ID.kForceController);
            const pursuitForce = new forcePursue_1.PursueForce();
            pursuitForce.init(nexus, rhapsody, 1704);
            blueFController.addForce("pursuit", pursuitForce);
            const ambienceMng = master.getManager(stEnums_44.ST_MANAGER_ID.kAmbienceManager);
            ambienceMng.createStarDust(this);
            const debugManager = master.getManager(stEnums_44.ST_MANAGER_ID.kDebugManager);
            debugManager.prepareDebugManager(this);
            const uiManager = master.getManager(stEnums_44.ST_MANAGER_ID.kUIManager);
            uiSceneFactory_7.SceneUIFactory.CreateSimulationUIScene("simulation_ui", this, uiManager, this._openSceneInfo, this);
            uiManager.setTarget(nexus);
            this._openSceneInfo();
            this._m_master.stopSimulation();
            return;
        ...
        _openSceneInfo() {
            const master = this._m_master;
            master.pauseSimulation();
            const uiManger = master.getManager(stEnums_44.ST_MANAGER_ID.kUIManager);
            const infoBox = uiManger.getUIController("infoBox");
...
define("scenes/sims/sceneFollowPath", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_45, ambienceFactory_4, shipFactory_8, uiSceneFactory_8, mapScene_11, master_28, forceFollowPath_4) {
    ...
    class SceneFollowPath extends Phaser.Scene {
        create() {
            ...
            let canvas = this.game.canvas;
            const nexus = shipFactory_8.ShipFactory.CreateBlueShip(this, "ISS Nexus");
            simManager.addActor(nexus);
            nexus.sendMessage(stEnums_45.ST_MESSAGE_ID.kSetMass, 2.9);
            nexus.sendMessage(stEnums_45.ST_MESSAGE_ID.kSetMaxSpeed, 216);
            const x = canvas.width * 0.6;
            const y = canvas.height * 0.65;
            let startNode = undefined;
            let prevNode = undefined;
            const t = (Phaser.Math.PI2 / 10);
            for (let i = 0; i < 10; ++i) {
                const node = ambienceFactory_4.AmbienceFactory.CreateSatellite(x + (Math.sin(t * i) * 200), y + (Math.cos(t * i) * 200), this, "Satellite_" + i.toString());
                if (prevNode === undefined) {
                    startNode = node;
                    prevNode = node;
                }
            ...
            const followPath = new forceFollowPath_4.FollowPathForce();
            followPath.init(nexus, 1352, 15, true);
            followPath.setForceToPathScale(14);
            followPath.setStartNode(startNode);
            const blueShipFController = nexus.getComponent(stEnums_45.ST_COMPONENT_ID.kForceController);
            ...
            uiSceneFactory_8.SceneUIFactory.CreateSimulationUIScene("simulation_ui", this, uiManager, this._openSceneInfo, this);
            uiManager.setTarget(nexus);
            this._openSceneInfo();
            this._m_master.stopSimulation();
            return;
        ...
        _openSceneInfo() {
            const master = this._m_master;
            master.pauseSimulation();
            const uiManger = master.getManager(stEnums_45.ST_MANAGER_ID.kUIManager);
            const infoBox = uiManger.getUIController("infoBox");
...
define("scenes/sims/sceneTutorial", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceConstant", "tutorialManager/tutorialManager", "tutorialManager/tutState/sttTutDebug", "tutorialManager/tutState/sttTutForceMng", "tutorialManager/tutState/sttTutIntro", "tutorialManager/tutState/sttTutSelectDrag"], function (require, exports, stEnums_50, shipFactory_9, uiSceneFactory_9, mapScene_12, master_29, forceConstant_1, tutorialManager_1, sttTutDebug_1, sttTutForceMng_1, sttTutIntro_1, sttTutSelectDrag_1) {
    ...
    class ScnTutorial extends Phaser.Scene {
        create() {
            ...
            const scarletConstantForce = new forceConstant_1.ForceConstant();
