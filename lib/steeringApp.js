...
define("scenes/preload", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_6, master_2) {
    ...
    class Preload extends Phaser.Scene {
        preload() {
            ...
            this.load.image("bg_space_01", "images/bg_space_01.png");
            this.load.atlas('game_art', "images/game_art/game_art.png", "images/game_art/game_art.js");
            this.load.atlas('menu_art', "images/game_menu/menu_art.png", "images/game_menu/menu_art.js");
            ...
            this.load.tilemapTiledJSON("info_box", "tiledMaps/info_box.json");
            this.load.tilemapTiledJSON("main_menu", "tiledMaps/main_menu.json");
            this.load.text("infoBox", "infoBox/infoBox.json");
...
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master"], function (require, exports, stEnums_12, debugManager_2, master_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SeekForce {
        init(_self, _target, _force, _controller) {
            ...
            let master = master_8.Master.GetInstance();
...
define("components/cmpSpriteController", ["require", "exports", "commons/stEnums", "master/master", "components/actorInitState"], function (require, exports, stEnums_14, master_10, actorInitState_2) {
    ...
    class CmpSpriteController {
            ...
            switch (_id) {
                ...
                case stEnums_14.ST_MESSAGE_ID.kSetPosition:
                    ...
                    if (this._m_simulationManager.getState() === stEnums_14.ST_SIM_SATE.kStopped) {
                        this._m_actorInitState._m_initPosition = _obj;
                    }
                    return;
        ...
        onSimulationStop() {
            this.setPosition(this._m_actorInitState._m_initPosition.x, this._m_actorInitState._m_initPosition.y);
            return;
        }
        onDebugEnable() {
            return;
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums"], function (require, exports, master_11, debugManager_3, stEnums_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceArrival", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_17, uiBox_1, uiLabel_2, uiSlider_2, UIForce_1) {
    ...
    class UIForceArrival extends UIForce_1.UIForce {
        constructor(_scene) {
            ...
            box.setPadding(0);
            this._m_box = box;
            const title = uiLabel_2.UILabel.CreateStyleA(0, 0, _scene, "Arrive Force", 25);
...
define("steeringBehavior/forceEvade", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master"], function (require, exports, stEnums_18, debugManager_4, master_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master"], function (require, exports, stEnums_19, debugManager_5, master_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceEvade", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_20, uiBox_2, uiLabel_3, uiSlider_3, UIForce_2) {
    ...
    class UIForceEvade extends UIForce_2.UIForce {
        constructor(_scene) {
            ...
            box.setPadding(0);
            this._m_box = box;
            const title = uiLabel_3.UILabel.CreateStyleA(0, 0, _scene, "Evade Force", 25);
...
define("managers/uiManager/uiControllers/UIForcePursuit", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_21, uiBox_3, uiLabel_4, uiSlider_4, UIForce_3) {
    ...
    class UIForcePursuit extends UIForce_3.UIForce {
        constructor(_scene) {
            ...
            box.setPadding(0);
            this._m_box = box;
            const title = uiLabel_4.UILabel.CreateStyleA(0, 0, _scene, "Pursuit Force", 25);
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums"], function (require, exports, master_14, debugManager_6, stEnums_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceObstacleAvoidance", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_23, uiBox_4, uiLabel_5, uiSlider_5, UIForce_4) {
    ...
    class UIForceObstacleAvoidance extends UIForce_4.UIForce {
        constructor(_scene) {
            ...
            box.setPadding(0);
            this._m_box = box;
            const title = uiLabel_5.UILabel.CreateStyleA(0, 0, _scene, "Obstacle Avoidance Force", 20);
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_24, uiBox_5, uiLabel_6, uiSlider_6, UIForce_5) {
    ...
    class UIForceSeek extends UIForce_5.UIForce {
        constructor(_scene) {
            ...
            box.setPadding(0);
            this._m_box = box;
            const title = uiLabel_6.UILabel.CreateStyleA(0, 0, _scene, "Seek Force", 25);
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums"], function (require, exports, master_15, debugManager_7, stEnums_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceWander", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_26, uiBox_6, uiLabel_7, uiSlider_7, UIForce_6) {
    ...
    class UIForceWander extends UIForce_6.UIForce {
        constructor(_scene) {
            ...
            box.setPadding(0);
            this._m_box = box;
            const title = uiLabel_7.UILabel.CreateStyleA(0, 0, _scene, "Wander Force", 25);
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "steeringBehavior/forceSeek", "master/master"], function (require, exports, stEnums_27, debugManager_8, forceSeek_1, master_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceFollowPath", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_28, uiBox_7, uiLabel_8, uiSlider_8, UIForce_7) {
    ...
    class UIForceFollowPath extends UIForce_7.UIForce {
        constructor(_scene) {
            ...
            box.setPadding(0);
            this._m_box = box;
            const title = uiLabel_8.UILabel.CreateStyleA(0, 0, _scene, "Follow Path", 25);
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master"], function (require, exports, stEnums_29, debugManager_9, master_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceConstant", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_30, uiBox_8, uiLabel_9, uiSlider_9, UIForce_8) {
    ...
    class UIForceConstant extends UIForce_8.UIForce {
        constructor(_scene) {
            ...
            box.setPadding(0);
            this._m_box = box;
            const title = uiLabel_9.UILabel.CreateStyleA(0, 0, _scene, "Constant Force", 25);
...
define("managers/uiManager/uiControllers/UIForceFlee", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_32, uiBox_9, uiLabel_10, uiSlider_10, UIForce_9) {
    ...
    class UIForceFlee extends UIForce_9.UIForce {
        constructor(_scene) {
            ...
            this._m_box = box;
            const title = uiLabel_10.UILabel.CreateStyleA(0, 0, _scene, "Flee Force", 25);
...
define("gameScene/parallaxImage", ["require", "exports", "master/master"], function (require, exports, master_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiButton", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabel", "managers/uiManager/uiObject"], function (require, exports, stEnums_45, uiLabel_12, uiObject_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIButton extends uiObject_12.UIObject {
        constructor(_x, _y, _scene, _frame, _label, _buttonTint, _labelTint, _labelSize) {
            ...
            this._m_buttonTint = stEnums_45.ST_COLOR_ID.kWhite;
            ...
            let labeltint = stEnums_45.ST_COLOR_ID.kWhite;
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_46.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_46.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_46.ST_BUTTON.kNo);
                return;
            }, messageBox);
