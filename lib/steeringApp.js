    ...
    var UIBox = (function (_super) {
        ...
        UIBox.prototype._orderVertical = function () {
            ...
            for (var i = 0; i < size; ++i) {
                ...
                object.setPosition(position.x + objWidth * object.getAnchorX(), position.y + objHeight * object.getAnchorY());
...
define("managers/uiManager/uiLabel", ["require", "exports", "commons/stEnums", "managers/uiManager/uiObject"], function (require, exports, stEnums_7, uiObject_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UILabel = (function (_super) {
        ...
        function UILabel(_x, _y, _scene, _text, _type, _tint) {
            ...
            if (_type === undefined) {
                ...
                switch (_type) {
                    case stEnums_7.ST_TEXT_TYPE.H1:
                        font_key = "supercomputer";
                        font_size = 36;
                        break;
                    case stEnums_7.ST_TEXT_TYPE.H2:
                        font_key = "odin_rounded";
                        font_size = 28;
                        break;
                    case stEnums_7.ST_TEXT_TYPE.Normal:
                        font_key = "odin_rounded";
                        font_size = 20;
                        break;
                    default:
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_9, uiBox_1, uiLabel_1, uiSlider_1, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIForceSeek = (function (_super) {
        ...
        function UIForceSeek(_scene, _force) {
            ...
            _this._m_box = box;
            _this._m_title = new uiLabel_1.UILabel(0, 0, _scene, "Seek Force", stEnums_9.ST_TEXT_TYPE.H2);
            box.add(_this._m_title);
            _this._m_force = new uiLabel_1.UILabel(0, 0, _scene, "#", stEnums_9.ST_TEXT_TYPE.Normal);
            box.add(_this._m_force);
            _this._m_maxMagnitude = new uiLabel_1.UILabel(0, 0, _scene, "#", stEnums_9.ST_TEXT_TYPE.Normal);
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceFactory"], function (require, exports, stEnums_11, uiBox_2, uiLabel_2, uiSlider_2, UIController_1, UIForceFactory_1) {
    ...
    var UIForceController = (function (_super) {
        ...
        function UIForceController(_x, _y, _scene, _target) {
            ...
            _this._ui_box = box;
            _this._ui_actorName = new uiLabel_2.UILabel(0, 0, _scene, "#", stEnums_11.ST_TEXT_TYPE.H2);
            box.add(_this._ui_actorName);
            _this._ui_actualSpeed = new uiLabel_2.UILabel(0, 0, _scene, "#", stEnums_11.ST_TEXT_TYPE.Normal);
            box.add(_this._ui_actualSpeed);
            _this._ui_maxSpeed = new uiLabel_2.UILabel(0, 0, _scene, "#", stEnums_11.ST_TEXT_TYPE.Normal);
            ...
            _this._ui_mass = new uiLabel_2.UILabel(0, 0, _scene, "#", stEnums_11.ST_TEXT_TYPE.Normal);
...
define("scenes/sims/sceneWander", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceWander"], function (require, exports, baseActor_5, stEnums_20, cmpforceController_5, cmpSpriteController_5, master_12, forceWander_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
