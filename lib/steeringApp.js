...
define("steeringBehavior/forceWander", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/mainMenu", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceSeek", "steeringBehavior/forceArrival", "steeringBehavior/forceWander"], function (require, exports, baseActor_1, stEnums_5, cmpforceController_1, cmpSpriteController_1, master_3, forceSeek_1, forceArrival_1, forceWander_1) {
    ...
    var MainMenu = (function (_super) {
        ...
        MainMenu.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetMaxSpeed, 100);
            ...
            shipActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetMass, 10);
            ...
            targetActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.15));
            ...
            arrival.init(shipSprite, targetSprite, 200, 100);
            wander.init(shipSprite, 250, 10, 5, 1, 100);
