...
define("managers/nullManager", ["require", "exports", "commons/stEnums"], function (require, exports, stEnums_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var NullManager = (function () {
        ...
        NullManager.prototype.getID = function () {
            ...
            return stEnums_1.ST_MANAGER_ID.kUndefined;
        };
...
define("managers/simulationManager/simulationManager", ["require", "exports", "commons/stEnums"], function (require, exports, stEnums_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var SimulationManager = (function () {
        ...
        SimulationManager.prototype.getID = function () {
            return stEnums_2.ST_MANAGER_ID.kSimManager;
        };
...
define("master/master", ["require", "exports", "managers/nullManager", "managers/simulationManager/simulationManager"], function (require, exports, nullManager_1, simulationManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("components/cmpforceController", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_3, master_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var CmpForceController = (function () {
        ...
        CmpForceController.prototype.update = function (_actor) {
            ...
            force.scale(dt);
            this._m_actor.sendMessage(stEnums_3.ST_MESSAGE_ID.kMove, force);
            force.normalize();
            this._m_direction.setTo(force.x, force.y);
            this._m_actor.sendMessage(stEnums_3.ST_MESSAGE_ID.kSetAngle, this._m_direction.angle());
            return;
        };
        CmpForceController.prototype.receive = function (_id, _obj) {
            switch (_id) {
                case stEnums_3.ST_MESSAGE_ID.kSetMass:
                    this.setMass(_obj);
                    return;
                case stEnums_3.ST_MESSAGE_ID.kSetSpeed:
                    this.setSpeed(_obj);
                    return;
                case stEnums_3.ST_MESSAGE_ID.kSetMaxSpeed:
        ...
        CmpForceController.prototype.getID = function () {
            return stEnums_3.ST_COMPONENT_ID.kForceController;
        };
...
define("components/cmpSpriteController", ["require", "exports", "commons/stEnums"], function (require, exports, stEnums_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var CmpSpriteController = (function () {
        ...
        CmpSpriteController.prototype.receive = function (_id, _obj) {
            switch (_id) {
                case stEnums_4.ST_MESSAGE_ID.kMove:
                    {
                        var v2 = _obj;
                        this.move(v2.x, v2.y);
                    }
                    return;
                case stEnums_4.ST_MESSAGE_ID.kSetPosition:
                    {
                        var v2 = _obj;
                        this.setPosition(v2.x, v2.y);
                    }
                    return;
                case stEnums_4.ST_MESSAGE_ID.kSetScale:
                    {
                        var v2 = _obj;
                        this.setScale(v2.x, v2.y);
                    }
                    return;
                case stEnums_4.ST_MESSAGE_ID.kSetAngle:
        ...
        CmpSpriteController.prototype.getID = function () {
            return stEnums_4.ST_COMPONENT_ID.kSpriteController;
        };
...
define("scenes/mainMenu", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_1, stEnums_5, cmpforceController_1, cmpSpriteController_1, master_3, forceSeek_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var MainMenu = (function (_super) {
        ...
        MainMenu.prototype.create = function () {
            ...
            var simManager = master.getManager(stEnums_5.ST_MANAGER_ID.kSimManager);
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetMaxSpeed, 1000);
            shipActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            shipActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            shipActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetMass, 100);
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            targetActor.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            var seek = new forceSeek_1.SeekForce();
            seek.init(shipSprite, targetSprite, 1000);
            var forceControl = shipActor.getComponent(stEnums_5.ST_COMPONENT_ID.kForceController);
        ...
        MainMenu.prototype.update = function (_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_5.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            return;
        };
        return MainMenu;
    }(Phaser.Scene));
