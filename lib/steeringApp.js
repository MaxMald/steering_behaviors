...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_16, master_5, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var FollowPathForce = (function () {
        ...
        FollowPathForce.prototype.init = function (_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_5.Master.GetInstance().getManager(stEnums_16.ST_MANAGER_ID.kDebugManager);
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_17, master_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var PursueForce = (function () {
        ...
        PursueForce.prototype.init = function (_self, _target, _force, _predictionSteps, _targetForceCtrl, _controller) {
            ...
            this._m_debugManager = master_6.Master.GetInstance().getManager(stEnums_17.ST_MANAGER_ID.kDebugManager);
            return;
        };
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_7, stEnums_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var WanderForce = (function () {
        ...
        WanderForce.prototype.init = function (_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_7.Master.GetInstance().getManager(stEnums_18.ST_MANAGER_ID.kDebugManager);
            return;
        };
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_9, stEnums_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_13, stEnums_24) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ObstacleAvoidanceForce = (function () {
        ...
        ObstacleAvoidanceForce.prototype.init = function (_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_13.Master.GetInstance().getManager(stEnums_24.ST_MANAGER_ID.kDebugManager);
        };
