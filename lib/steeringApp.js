...
define("managers/uiManager/uiManager", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_5, master_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiButton", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabel", "managers/uiManager/uiObject"], function (require, exports, stEnums_6, uiLabel_1, uiObject_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIButton extends uiObject_3.UIObject {
        constructor(_x, _y, _scene, _frame, _label, _buttonTint, _labelTint, _labelSize) {
            ...
            this._m_buttonTint = stEnums_6.ST_COLOR_ID.kWhite;
            ...
            let labeltint = stEnums_6.ST_COLOR_ID.kWhite;
...
define("scenes/mainMenu", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton"], function (require, exports, stEnums_7, uiBox_1, uiButton_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class MainMenu extends Phaser.Scene {
        create() {
            ...
            const seek = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Seek", stEnums_7.ST_COLOR_ID.kWhite);
            seek.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneSeek');
                return;
            }, this);
            box.add(seek);
            const flee = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Flee", stEnums_7.ST_COLOR_ID.kWhite);
            flee.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneFlee');
                return;
            }, this);
            box.add(flee);
            const arrival = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Arrival", stEnums_7.ST_COLOR_ID.kWhite);
            arrival.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneArrival');
                return;
            }, this);
            box.add(arrival);
            const pursuit = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Pursuit", stEnums_7.ST_COLOR_ID.kWhite);
            pursuit.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('scenePursuit');
                return;
            }, this);
            box.add(pursuit);
            const evade = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Evade", stEnums_7.ST_COLOR_ID.kWhite);
            evade.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneEvade');
                return;
            }, this);
            box.add(evade);
            const wander = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Wander", stEnums_7.ST_COLOR_ID.kWhite);
            wander.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneWander');
                return;
            }, this);
            box.add(wander);
            const followPath = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Follow Path", stEnums_7.ST_COLOR_ID.kWhite);
            followPath.subscribe("buttonReleased", "MainMenu", function (_sender, _args) {
                this.scene.start('sceneFollowPath');
                return;
            }, this);
            box.add(followPath);
            const oAvoidance = uiButton_1.UIButton.CreateColorButton(0, 0, this, "Obstacle Avoidance", stEnums_7.ST_COLOR_ID.kWhite);
...
define("components/cmpforceController", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_8, master_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpForceController {
        ...
        init(_actor) {
            ...
            const simulationManager = this._m_master.getManager(stEnums_8.ST_MANAGER_ID.kSimManager);
            if (simulationManager.getState() === stEnums_8.ST_SIM_SATE.kRunning) {
        ...
        update(_actor) {
            ...
            this._m_actor.sendMessage(stEnums_8.ST_MESSAGE_ID.kMove, actualVelocityStepped);
            direction.copy(actualVelocity);
            direction.normalize();
            this._m_actor.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetAngle, direction.angle());
            if (this._m_debug) {
                this.updateDebug(dt);
            }
            return;
        ...
        updateDebug(_dt) {
            ...
            let actualVelocity = this._m_actualVelocity;
            debugManager.drawLine(sprite.x, sprite.y, sprite.x + actualVelocity.x, sprite.y + actualVelocity.y, 3, stEnums_8.ST_COLOR_ID.kGreen);
            return;
        }
        receive(_id, _obj) {
            switch (_id) {
                case stEnums_8.ST_MESSAGE_ID.kSetMass:
                    this.setMass(_obj);
                    return;
                case stEnums_8.ST_MESSAGE_ID.kSetSpeed:
                    this.setSpeed(_obj);
                    return;
                case stEnums_8.ST_MESSAGE_ID.kSetMaxSpeed:
        ...
        getID() {
            return stEnums_8.ST_COMPONENT_ID.kForceController;
        }
...
define("components/cmpInteractiveActor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_9, master_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class cmpInteractiveActor {
        constructor() {
            ...
            this._m_simulationManager = master.getManager(stEnums_9.ST_MANAGER_ID.kSimManager);
            this._m_uiManager = master.getManager(stEnums_9.ST_MANAGER_ID.kUIManager);
            return;
        }
        init(_actor) {
            this._m_self = _actor;
        ...
        getID() {
            return stEnums_9.ST_COMPONENT_ID.kInteractiveActor;
        }
        selectActor() {
        ...
        dragStart() {
            this._m_uiManager.setTarget(this._m_self);
            this._m_self.sendMessage(stEnums_9.ST_MESSAGE_ID.kSetAlpha, 0.5);
            return;
        }
        dragEnd() {
            this._m_self.sendMessage(stEnums_9.ST_MESSAGE_ID.kSetAlpha, 1.0);
            return;
        }
        dragActor(_pointer, _dragX, _dragY) {
            if (this._m_simulationManager.getState() === stEnums_9.ST_SIM_SATE.kStopped) {
                this._m_self.sendMessage(stEnums_9.ST_MESSAGE_ID.kSetPosition, this._m_moveVector.set(_dragX, _dragY));
            }
            return;
        }
        destroy() {
...
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_10, master_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SeekForce {
        init(_self, _target, _force, _controller) {
            ...
            this._m_debugManager = master.getManager(stEnums_10.ST_MANAGER_ID.kDebugManager);
            return;
        }
        ...
        updateDebug(_dt) {
            ...
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_10.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_10.ST_STEER_FORCE.kSeek;
        }
        destroy() {
...
define("components/cmpShipPropulsor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_11, master_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpShipPropulsor {
        ...
        update(_actor) {
            const forceController = _actor.getComponent(stEnums_11.ST_COMPONENT_ID.kForceController);
        ...
        getID() {
            return stEnums_11.ST_COMPONENT_ID.kShipPropulsor;
        }
        destroy() {
...
define("components/cmpSpriteController", ["require", "exports", "commons/stEnums"], function (require, exports, stEnums_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpSpriteController {
        ...
        receive(_id, _obj) {
            switch (_id) {
                case stEnums_12.ST_MESSAGE_ID.kMove:
                    {
                        let v2 = _obj;
                        this.move(v2.x, v2.y);
                    }
                    return;
                case stEnums_12.ST_MESSAGE_ID.kSetPosition:
                    {
                        let v2 = _obj;
                        this.setPosition(v2.x, v2.y);
                    }
                    return;
                case stEnums_12.ST_MESSAGE_ID.kSetScale:
                    {
                        let v2 = _obj;
                        this.setScale(v2.x, v2.y);
                    }
                    return;
                case stEnums_12.ST_MESSAGE_ID.kSetAngle:
                    this._m_sprite.setAngle(Phaser.Math.RadToDeg(_obj));
                    return;
                case stEnums_12.ST_MESSAGE_ID.kSetAlpha:
                    this.setAlpha(_obj);
                    return;
                case stEnums_12.ST_MESSAGE_ID.kPlayAnimation:
        ...
        getID() {
            return stEnums_12.ST_COMPONENT_ID.kSpriteController;
        }
        destroy() {
...
define("factories/shipFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpShipPropulsor", "components/cmpSpriteController"], function (require, exports, baseActor_1, stEnums_13, cmpforceController_1, cmpInteractiveActor_1, cmpShipPropulsor_1, cmpSpriteController_1) {
    ...
    class ShipFactory {
        static CreateBlueShip(_scene, _UniqueName) {
            ...
            shipActor.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetMaxSpeed, 500);
            shipActor.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            let canvas = _scene.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            shipActor.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            shipActor.sendMessage(stEnums_13.ST_MESSAGE_ID.kSetMass, 1);
            return shipActor;
        }
...
define("managers/uiManager/uiComboBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabelBox", "managers/uiManager/uiObject"], function (require, exports, stEnums_14, uiLabelBox_1, uiObject_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIComboBox extends uiObject_6.UIObject {
        ...
        _onOptionDown(_uiLabel, _args) {
            ...
            labelBox.setBoxTint(stEnums_14.ST_COLOR_ID.kBlack);
            labelBox.setTextTint(stEnums_14.ST_COLOR_ID.kWhite);
            return;
        }
        _onOptionUp(_uiLabel, _args) {
            const labelBox = _uiLabel;
            this.setSelection(labelBox.getText());
            labelBox.setBoxTint(stEnums_14.ST_COLOR_ID.kSkyBlueNeon);
            labelBox.setTextTint(stEnums_14.ST_COLOR_ID.kBlack);
            this.closeCombo();
            return;
        }
...
define("managers/uiManager/uiSpeedometer", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UISpeedometer = void 0;
    class UISpeedometer extends uiObject_8.UIObject {
        constructor(_x, _y, _scene) {
            super();
...
define("factories/tiledMapFactory", ["require", "exports", "commons/stEnums", "commons/stPoint", "commons/stRectangle", "gameScene/motionImage", "managers/uiManager/uiButtonImg", "managers/uiManager/uiComboBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "master/master"], function (require, exports, stEnums_15, stPoint_1, stRectangle_1, motionImage_1, uiButtonImg_1, uiComboBox_1, uiLabel_2, uiSlider_1, uiSpeedometer_1, master_7) {
    ...
    class TiledMapFactory {
        static CreateMotionImage(_object, _scene) {
            ...
            const ambience = master.getManager(stEnums_15.ST_MANAGER_ID.kAmbienceManager);
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_8, stEnums_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ArrivalForce {
        ...
        updateDebug(_dt) {
            ...
            let target = this._m_target;
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_16.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_16.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(target.x, target.y, this._m_slowingRadius, 2, stEnums_16.ST_COLOR_ID.kPurple);
...
define("managers/uiManager/uiControllers/UIForceArrival", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_17, uiBox_2, uiLabel_3, uiSlider_2, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceEvade", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_18, master_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class EvadeForce {
        init(_self, _target, _maxForceMagnitude) {
            ...
            this._m_debugManager = master_9.Master.GetInstance().getManager(stEnums_18.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_18.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_18.ST_COLOR_ID.kRed);
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, 5, stEnums_18.ST_COLOR_ID.kOrange);
            return;
        }
        onDebugEnable() {
            return;
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_19, master_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        init(_self, _target, _maxForceMagnitude) {
            ...
            this._m_targetVelocity = new Phaser.Math.Vector2();
            this._m_steerForce = new Phaser.Math.Vector2();
            this._m_debugManager = master_10.Master.GetInstance().getManager(stEnums_19.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_19.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_19.ST_COLOR_ID.kRed);
            this._m_debugManager.drawCircle(this._m_targetPosition.x, this._m_targetPosition.y, 5, 5, stEnums_19.ST_COLOR_ID.kOrange);
            return;
        }
        onDebugEnable() {
            return;
...
define("managers/uiManager/uiControllers/UIForceEvade", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_20, uiBox_3, uiLabel_4, uiSlider_3, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForcePursuit", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_21, uiBox_4, uiLabel_5, uiSlider_4, UIForce_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_11, stEnums_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_11.Master.GetInstance().getManager(stEnums_22.ST_MANAGER_ID.kDebugManager);
        }
        setController(_controller) {
            this._m_controller = _controller;
            return;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, 2, stEnums_22.ST_COLOR_ID.kPurple);
        }
        onDebugEnable() {
        }
        onDebugDisable() {
...
define("managers/uiManager/uiControllers/UIForceObstacleAvoidance", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_23, uiBox_5, uiLabel_6, uiSlider_5, UIForce_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_24, uiBox_6, uiLabel_7, uiSlider_6, UIForce_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_12, stEnums_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        init(_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_12.Master.GetInstance().getManager(stEnums_25.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_25.ST_COLOR_ID.kPurple);
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_25.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_25.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_25.ST_COLOR_ID.kBlack);
            let displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_25.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
...
define("managers/uiManager/uiControllers/UIForceWander", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_26, uiBox_7, uiLabel_8, uiSlider_7, UIForce_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek", "master/master"], function (require, exports, stEnums_27, forceSeek_1, master_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        ...
        updateDebug(_dt) {
            ...
            const forceToPath = this._m_forceToPath;
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + actualVelocity.x + forceToPath.x, self.y + actualVelocity.y + forceToPath.y, 2, stEnums_27.ST_COLOR_ID.kYellow);
            this._m_debugManager.drawCircle(self.x, self.y, this._m_radius, 1, stEnums_27.ST_COLOR_ID.kWhite);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
...
define("managers/uiManager/uiControllers/UIForceFollowPath", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_28, uiBox_8, uiLabel_9, uiSlider_8, UIForce_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceConstant", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_29, master_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ForceConstant {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_29.ST_COLOR_ID.kBlack);
            let actualVelocity = this._m_controller.getVelocity();
            this._m_debugManager.drawLine(self.x + actualVelocity.x, self.y + actualVelocity.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_29.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
...
define("managers/uiManager/uiControllers/UIForceConstant", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_30, uiBox_9, uiLabel_10, uiSlider_9, UIForce_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceEvade", "managers/uiManager/uiControllers/UIForcePursuit", "managers/uiManager/uiControllers/UIForceObstacleAvoidance", "managers/uiManager/uiControllers/UIForceSeek", "managers/uiManager/uiControllers/UIForceWander", "managers/uiManager/uiControllers/UIForceFollowPath", "managers/uiManager/uiControllers/UIForceConstant", "managers/uiManager/uiGroup"], function (require, exports, stEnums_31, uiBox_10, UIController_1, UIForceArrival_1, UIForceEvade_1, UIForcePursuit_1, UIForceObstacleAvoidance_1, UIForceSeek_1, UIForceWander_1, UIForceFollowPath_1, UIForceConstant_1, uiGroup_1) {
    ...
    class UIForceController extends UIController_1.UIController {
        constructor(_uiScene, _scene) {
            super();
            const group = new uiGroup_1.UIGroup();
            ...
            const comboBox = _uiScene.getObject("forceComboBox");
            ...
            this._ui_box = uiBox_10.UIBox.CreateBorderBox(forceArea.x, forceArea.y, _scene);
            const hUIForce = new Map();
            this._m_aUIForce = hUIForce;
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kSeek, new UIForceSeek_1.UIForceSeek(_scene));
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kArrive, new UIForceArrival_1.UIForceArrival(_scene));
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kPursue, new UIForcePursuit_1.UIForcePursuit(_scene));
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kEvade, new UIForceEvade_1.UIForceEvade(_scene));
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kWander, new UIForceWander_1.UIForceWander(_scene));
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kObstacleAvoidance, new UIForceObstacleAvoidance_1.UIForceObstacleAvoidance(_scene));
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kFollowPath, new UIForceFollowPath_1.UIForceFollowPath(_scene));
            this._addUIForce(stEnums_31.ST_STEER_FORCE.kConstant, new UIForceConstant_1.UIForceConstant(_scene));
            this.setTarget(undefined);
            return;
        }
        update() {
        ...
        setTarget(_actor) {
            ...
            const forceController = _actor.getComponent(stEnums_31.ST_COMPONENT_ID.kForceController);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiGroup", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_32, master_15, uiGroup_2, UIController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UISimulationController extends UIController_2.UIController {
        constructor() {
            super();
            this._m_group = new uiGroup_2.UIGroup();
            return;
        }
        static CreateSimControlBox(_mapScene) {
            const simControlBox = new UISimulationController();
            simControlBox.m_master = master_15.Master.GetInstance();
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_32.ST_MANAGER_ID.kSimManager);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_32.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_32.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_32.ST_SIM_SATE.kPaused) {
                this.m_master.resumeSimulation();
            }
            return;
        }
        _onSimulationStop() {
            if (this._m_simulationManager.getState() !== stEnums_32.ST_SIM_SATE.kStopped) {
...
define("factories/uiSceneFactory", ["require", "exports", "gameScene/mapScene", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UISimulationController", "master/master"], function (require, exports, mapScene_1, UIForceController_1, UISimulationController_1, master_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/sceneSeek", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forceSeek"], function (require, exports, stEnums_33, shipFactory_1, uiSceneFactory_1, mapScene_2, master_17, forceConstant_1, forceSeek_2) {
    ...
    class ScnSeek extends Phaser.Scene {
        create() {
            ...
            const targetFController = targetActor.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            ...
            targetActor.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_33.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            ...
            let forceControl = blueShip.getComponent(stEnums_33.ST_COMPONENT_ID.kForceController);
            forceControl.addForce('seek_1', seek);
            const ambienceMng = master.getManager(stEnums_33.ST_MANAGER_ID.kAmbienceManager);
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_34, shipFactory_2, uiSceneFactory_2, master_18, forceArrival_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnArrival extends Phaser.Scene {
        create() {
            ...
            shipActor.sendMessage(stEnums_34.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_34.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_34.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_2.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_34.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_34.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_35, shipFactory_3, uiSceneFactory_3, master_19, forceWander_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnWander extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_35.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            let wander = new forceWander_1.WanderForce();
            wander.init(shipActor.getWrappedInstance(), 75, 25, 5, 45, 100);
            let shipController = shipActor.getComponent(stEnums_35.ST_COMPONENT_ID.kForceController);
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_11, uiLabel_11, UIController_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIDialogBox extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title) {
            ...
            this._m_box = box;
            const title = uiLabel_11.UILabel.CreateH1(0, 0, _scene, _title);
            this._m_title = title;
            box.add(title);
            box.setCenterAlignment();
            return;
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_36.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_36.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_36.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("scenes/sims/sceneEvade", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceEvade", "steeringBehavior/forceSeek"], function (require, exports, stEnums_37, shipFactory_4, uiSceneFactory_4, master_20, forceEvade_1, forceSeek_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SceneEvade extends Phaser.Scene {
        create() {
            ...
            targetActor.sendMessage(stEnums_37.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            const blueShip = shipFactory_4.ShipFactory.CreateBlueShip(this, "Blue Ship");
            simManager.addActor(blueShip);
            const blueFController = blueShip.getComponent(stEnums_37.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_38, shipFactory_5, uiSceneFactory_5, master_21, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            obstacleActor0.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_38.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            let obstacle0Controller = obstacleActor0.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            let obstacle1Controller = obstacleActor1.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            let obstacle2Controller = obstacleActor2.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            let obstacle3Controller = obstacleActor3.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            let obstacle4Controller = obstacleActor4.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            let obstacle5Controller = obstacleActor5.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            let obstacle6Controller = obstacleActor6.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
            let obstacle7Controller = obstacleActor7.getComponent(stEnums_38.ST_COMPONENT_ID.kForceController);
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_39, forceSeek_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FleeForce extends forceSeek_4.SeekForce {
        ...
        getType() {
            return stEnums_39.ST_STEER_FORCE.kFlee;
        }
    }
    exports.FleeForce = FleeForce;
});
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_40, shipFactory_6, uiSceneFactory_6, master_22, forceFlee_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_6.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_40.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
...
define("scenes/sims/scenePursuit", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceConstant", "steeringBehavior/forcePursue"], function (require, exports, stEnums_41, shipFactory_7, uiSceneFactory_7, master_23, forceConstant_2, forcePursue_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("factories/ambienceFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpInteractiveActor", "components/cmpSpriteController"], function (require, exports, baseActor_2, stEnums_42, cmpforceController_2, cmpInteractiveActor_2, cmpSpriteController_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class AmbienceFactory {
        static CreateSatellite(_x, _y, _scene, _name) {
            ...
            actor.init();
            actor.sendMessage(stEnums_42.ST_MESSAGE_ID.kPlayAnimation, "satellite_a");
            actor.sendMessage(stEnums_42.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(_x, _y));
            return actor;
        }
    }
    exports.AmbienceFactory = AmbienceFactory;
});
define("scenes/sims/sceneFollowPath", ["require", "exports", "commons/stEnums", "factories/ambienceFactory", "factories/shipFactory", "factories/uiSceneFactory", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_43, ambienceFactory_1, shipFactory_8, uiSceneFactory_8, master_24, forceFollowPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SceneFollowPath extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            const simManager = master.getManager(stEnums_43.ST_MANAGER_ID.kSimManager);
            ...
            const blueShipFController = blueShip.getComponent(stEnums_43.ST_COMPONENT_ID.kForceController);
...
define("gameScene/parallaxImage", ["require", "exports", "master/master"], function (require, exports, master_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
