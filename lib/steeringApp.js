...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_42, shipFactory_6, uiSceneFactory_6, mapScene_6, master_26, forceFlee_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            master.onSceneCreate(this);
            master.onSimulationSceneCreate(this);
            const ambienceMap = mapScene_6.MapScene.CreateFromTiledMap("ambience_02", this);
            ambienceMap.clear();
            ambienceMap.destroy();
...
define("scenes/sims/sceneTutorial", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceConstant", "tutorialManager/tutorialManager", "tutorialManager/tutState/sttTutDebug", "tutorialManager/tutState/sttTutForceMng", "tutorialManager/tutState/sttTutIntro", "tutorialManager/tutState/sttTutSelectDrag"], function (require, exports, stEnums_50, shipFactory_9, uiSceneFactory_9, mapScene_7, master_29, forceConstant_3, tutorialManager_1, sttTutDebug_1, sttTutForceMng_1, sttTutIntro_1, sttTutSelectDrag_1) {
    ...
    class ScnTutorial extends Phaser.Scene {
        create() {
            ...
            master.onSceneCreate(this);
            master.onSimulationSceneCreate(this);
            const ambienceMap = mapScene_7.MapScene.CreateFromTiledMap("ambience_01", this);
            ambienceMap.clear();
            ambienceMap.destroy();
