...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "managers/debugManager/debugManager", "commons/stEnums", "steeringBehavior/wanderInitState"], function (require, exports, master_15, debugManager_7, stEnums_27, wanderInitState_1) {
    ...
    class WanderForce {
        ...
        updateDebug(_dt) {
            ...
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, debugManager_7.DebugManager.FORCE_LINE_WIDTH, stEnums_27.ST_COLOR_ID.kOrange);
...
define("scenes/sims/sceneEvade", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "managers/uiManager/uiButtonImg", "master/master", "steeringBehavior/forceEvade", "steeringBehavior/forceSeek"], function (require, exports, stEnums_41, shipFactory_4, uiSceneFactory_4, mapScene_7, uiButtonImg_2, master_24, forceEvade_1, forceSeek_4) {
    ...
    class SceneEvade extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(targetActor);
            const targetFController = targetActor.getComponent(stEnums_41.ST_COMPONENT_ID.kForceController);
            targetActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_41.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            const blueShip = shipFactory_4.ShipFactory.CreateBlueShip(this, "Blue Ship");
            simManager.addActor(blueShip);
            const blueFController = blueShip.getComponent(stEnums_41.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_43, shipFactory_6, uiSceneFactory_6, mapScene_9, master_26, forceFlee_1) {
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            shipActor.sendMessage(stEnums_43.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
