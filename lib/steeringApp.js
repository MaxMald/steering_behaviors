...
define("managers/simulationManager/simulationManager", ["require", "exports", "commons/stEnums"], function (require, exports, stEnums_3) {
    ...
    var SimulationManager = (function () {
        ...
        SimulationManager.prototype.getState = function () {
...
define("components/cmpforceController", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_5, master_2) {
    ...
    var CmpForceController = (function () {
        ...
        CmpForceController.prototype.init = function (_actor) {
            ...
            var simulationManager = this._m_master.getManager(stEnums_5.ST_MANAGER_ID.kSimManager);
...
define("managers/uiManager/uiButton", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabel", "managers/uiManager/uiObject"], function (require, exports, stEnums_7, uiLabel_2, uiObject_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIButton = (function (_super) {
        ...
        function UIButton(_x, _y, _scene, _frame, _label, _buttonTint, _labelTint, _labelSize) {
            ...
            _this._m_buttonTint = stEnums_7.ST_COLOR_ID.kWhite;
            ...
            var labeltint = stEnums_7.ST_COLOR_ID.kWhite;
        ...
        UIButton.CreateThemeButton = function (_x, _y, _scene, _label) {
            var button = new UIButton(_x, _y, _scene, "themeButton_idle.png", _label);
            button.setPadding(10);
            return button;
        };
        UIButton.CreateColorButton = function (_x, _y, _scene, _label, _buttonTint) {
            var button = new UIButton(_x, _y, _scene, "colorButton_idle.png", _label, _buttonTint);
            button.setPadding(10);
            return button;
        };
...
define("managers/uiManager/uiButtonImg", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_4) {
    ...
    var UIButtonImg = (function (_super) {
        ...
        UIButtonImg.CreateComboButtonImg = function (_x, _y, _scene) {
            var button = new UIButtonImg(_x, _y, _scene, "combo_but_normal.png", "combo_but_hover.png", "combo_but_press.png");
            return button;
        };
        UIButtonImg.CreateDebugButtonImg = function (_x, _y, _scene) {
            var button = new UIButtonImg(_x, _y, _scene, "debug_idle.png", "debug_hover.png", "debug_press.png");
            return button;
        };
        UIButtonImg.CreateHomeButtonImg = function (_x, _y, _scene) {
            var button = new UIButtonImg(_x, _y, _scene, "home_idle.png", "home_hover.png", "home_press.png");
            return button;
        };
        UIButtonImg.CreateInfoButtonImg = function (_x, _y, _scene) {
            var button = new UIButtonImg(_x, _y, _scene, "info_idle.png", "info_hover.png", "info_press.png");
            return button;
        };
        UIButtonImg.CreateYesButtonImg = function (_x, _y, _scene) {
            var button = new UIButtonImg(_x, _y, _scene, "yes_idle.png", "yes_hover.png", "yes_press.png");
            return button;
        };
        UIButtonImg.CreateNoButtonImg = function (_x, _y, _scene) {
            var button = new UIButtonImg(_x, _y, _scene, "no_idle.png", "no_hover.png", "no_press.png");
            return button;
        };
...
define("managers/uiManager/uiComboBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabelBox", "managers/uiManager/uiObject"], function (require, exports, stEnums_8, uiLabelBox_1, uiObject_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiSpeedometer", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_9) {
    ...
    var UISpeedometer = (function (_super) {
        __extends(UISpeedometer, _super);
        function UISpeedometer(_x, _y, _scene) {
            var _this = _super.call(this) || this;
            _this._m_bg = _scene.add.image(0, 0, "game_art", "velocimetro_bg.png");
            var pointer = _scene.add.image(0, 0, "game_art", "velocimetro_pointer.png");
            pointer.setOrigin(0.07, 0.5);
            _this._m_pointer = pointer;
            _this._updatePointer();
            _this._m_fg = _scene.add.image(36, 0, "game_art", "velocimetro_fg.png");
            _this.setPosition(_x, _y);
            return _this;
        }
        UISpeedometer.prototype.getWidth = function () {
            return this._m_bg.width;
        };
        UISpeedometer.prototype.getHeight = function () {
            return this._m_bg.height;
        };
        UISpeedometer.prototype.getX = function () {
            return this._m_bg.x;
        };
        UISpeedometer.prototype.getY = function () {
            return this._m_bg.y;
        };
        UISpeedometer.prototype.getZ = function () {
            return this._m_bg.depth;
        };
        UISpeedometer.prototype.setZ = function (_z) {
            this._m_bg.setDepth(_z);
            return;
        };
        UISpeedometer.prototype.move = function (_x, _y) {
            this._m_bg.x += _x;
            this._m_bg.y += _y;
            this._m_fg.x += _x;
            this._m_fg.y += _y;
        ...
        UISpeedometer.prototype.setPosition = function (_x, _y) {
            var x = _x - this._m_bg.x;
            var y = _y - this._m_bg.y;
            this.move(x, y);
            return;
        };
        UISpeedometer.prototype.setAnchor = function (_x, _y) {
            this._m_bg.setOrigin(_x, _y);
            this._updatePointer();
            return;
        };
        UISpeedometer.prototype.getAnchorX = function () {
            return this._m_bg.originX;
        };
        UISpeedometer.prototype.getAnchorY = function () {
            return this._m_bg.originY;
        };
        UISpeedometer.prototype.enable = function () {
            this._m_bg.setActive(true);
            this._m_bg.setVisible(true);
        ...
        UISpeedometer.prototype.disable = function () {
            this._m_bg.setActive(false);
            this._m_bg.setVisible(false);
        ...
        UISpeedometer.prototype.updatePointerAngle = function (_angle) {
            this._m_pointer.setAngle(_angle);
            return;
        };
        UISpeedometer.prototype.destroy = function () {
            this._m_bg.destroy();
            this._m_pointer.destroy();
            _super.prototype.destroy.call(this);
            return;
        };
        UISpeedometer.prototype._updatePointer = function () {
            var bg = this._m_bg;
            var x = bg.x - (bg.width * bg.originX) + (bg.width * 0.5);
            var y = bg.y - (bg.height * bg.originY) + (bg.height * 0.79);
            this._m_pointer.setPosition(x, y);
            return;
        };
        return UISpeedometer;
    }(uiObject_9.UIObject));
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_10, uiBox_2, uiLabel_3, uiSlider_1, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIForceSeek = (function (_super) {
        ...
        function UIForceSeek(_scene, _force) {
            ...
            var title = uiLabel_3.UILabel.CreateStyleA(0, 0, _scene, "Seek Force", 25);
            title.setTint(stEnums_10.ST_COLOR_ID.kGold);
            _this._m_title = title;
            box.add(title);
...
define("managers/uiManager/uiControllers/UIForceFactory", ["require", "exports", "commons/stEnums", "managers/uiManager/uiControllers/UIForceSeek"], function (require, exports, stEnums_11, UIForceSeek_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIForceFactory = (function () {
        function UIForceFactory() {
            ...
            aFactories.set(stEnums_11.ST_STEER_FORCE.kSeek, this.createUIForceSeek);
            return;
        }
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceFactory"], function (require, exports, stEnums_12, uiBox_3, uiComboBox_1, uiImage_1, uiLabel_4, uiSlider_2, uiSpeedometer_1, UIController_2, UIForceFactory_1) {
    ...
    var UIForceController = (function (_super) {
        ...
        function UIForceController(_x, _y, _scene, _target) {
            ...
            var speedometer = new uiSpeedometer_1.UISpeedometer(0, 0, _scene);
            _this._ui_speedometer = speedometer;
            box.add(speedometer);
            _this._ui_actualSpeed = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "#");
            _this._ui_actualSpeed.setTint(stEnums_12.ST_COLOR_ID.kSkyBlueNeon);
            box.add(_this._ui_actualSpeed);
            _this._ui_maxSpeed = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "#");
            _this._ui_maxSpeed.setTint(stEnums_12.ST_COLOR_ID.kSkyBlueNeon);
            ...
            _this._ui_mass.setTint(stEnums_12.ST_COLOR_ID.kSkyBlueNeon);
            ...
            var steerTitle = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "Steer Force", 25);
            box.add(steerTitle);
            box.add(new uiImage_1.UIImage(0, 0, _scene, "game_art", "separator_a.png"));
            steerTitle.setTint(stEnums_12.ST_COLOR_ID.kGold);
            var selectForce = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "Select Steer Force");
        ...
        UIForceController.prototype.setTarget = function (_actor) {
            ...
            var forceController = _actor.getComponent(stEnums_12.ST_COMPONENT_ID.kForceController);
        ...
        UIForceController.prototype._updateSpeedometer = function () {
            var forceController = this._m_forceController;
            if (forceController !== undefined) {
                var t = forceController.getSpeed() / forceController.getMaxSpeed();
...
define("managers/uiManager/uiControllers/UIMessageBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButton", "managers/uiManager/uiButtonImg", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIDialogBox"], function (require, exports, stEnums_13, uiBox_4, uiButton_1, uiButtonImg_1, uiText_1, UIDialogBox_1) {
    ...
    var UIMessageBox = (function (_super) {
        ...
        UIMessageBox.CreateAccept = function (_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            var accept = uiButton_1.UIButton.CreateThemeButton(_x, _y, _scene, "Accept");
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_13.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        UIMessageBox.CreateYesNo = function (_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            var butYes = uiButtonImg_1.UIButtonImg.CreateYesButtonImg(_x, _y, _scene);
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_13.ST_BUTTON.kYes);
                return;
            }, messageBox);
            buttonsBox.add(butYes);
            var butNo = uiButtonImg_1.UIButtonImg.CreateNoButtonImg(_x, _y, _scene);
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_13.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_14, master_4, uiBox_5, uiButtonImg_2, uiImage_2, uiLabel_5, UIController_3) {
    ...
    var UISimulationController = (function (_super) {
        ...
        function UISimulationController(_x, _y, _scene, _title, _target) {
            ...
            _this._m_boxTitle = uiLabel_5.UILabel.CreateStyleA(0, 0, _scene, _this._ui_boxTitle, 32);
            _this._m_boxTitle.setTint(stEnums_14.ST_COLOR_ID.kGold);
        ...
        UISimulationController.CreateSimControlBox = function (_x, _y, _scene) {
            ...
            simControlBox.m_master = master_4.Master.GetInstance();
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_14.ST_MANAGER_ID.kSimManager);
            ...
            var stopButton = uiButtonImg_2.UIButtonImg.CreateStopButtonImg(0, 0, _scene);
            ...
            var playButton = uiButtonImg_2.UIButtonImg.CreatePlayButtonImg(0, 0, _scene);
            ...
            var pauseButton = uiButtonImg_2.UIButtonImg.CreatePauseButtonImg(0, 0, _scene);
        ...
        UISimulationController.prototype.destroy = function () {
        ...
        UISimulationController.prototype._onSimulationPause = function () {
            if (this._m_simulationManager.getState() === stEnums_14.ST_SIM_SATE.kRunning) {
                this.m_master.pauseSimulation();
            }
            return;
        };
        UISimulationController.prototype._onSimulationPlay = function () {
            var state = this._m_simulationManager.getState();
            if (state === stEnums_14.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_14.ST_SIM_SATE.kPaused) {
                this.m_master.resumeSimulation();
            }
            return;
        };
        UISimulationController.prototype._onSimulationStop = function () {
...
define("scenes/sims/devMax", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_1, stEnums_15, cmpforceController_1, cmpSpriteController_1, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_5, forceSeek_1) {
    ...
    var ScnDevMax = (function (_super) {
        ...
        ScnDevMax.prototype.create = function () {
            ...
            var simManager = master.getManager(stEnums_15.ST_MANAGER_ID.kSimManager);
            var shipSprite = this.add.sprite(0, 0, 'game_art', 'blueShip.png');
            ...
            var targetSprite = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            var seek = new forceSeek_1.SeekForce();
            seek.init(shipSprite, targetSprite, 125);
            var forceControl = shipActor.getComponent(stEnums_15.ST_COMPONENT_ID.kForceController);
            ...
            var uiManager = master.getManager(stEnums_15.ST_MANAGER_ID.kUIManager);
        ...
        ScnDevMax.prototype.update = function (_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            return;
        };
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_16, master_6, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var FollowPathForce = (function () {
        ...
        FollowPathForce.prototype.init = function (_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_6.Master.GetInstance().getManager(stEnums_16.ST_MANAGER_ID.kDebugManager);
        ...
        FollowPathForce.prototype.updateDebug = function (_dt) {
            ...
            var radius = this.m_radius;
            for (var i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, 3, stEnums_16.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, 3, stEnums_16.ST_COLOR_ID.kPurple);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, 3, stEnums_16.ST_COLOR_ID.kPurple);
                }
            }
            return;
        };
        ...
        FollowPathForce.prototype.getType = function () {
            return stEnums_16.ST_STEER_FORCE.kFollowPath;
        };
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_17, master_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var PursueForce = (function () {
        ...
        PursueForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawLine(this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, this._m_v2_actualVelocity.x + pos.x, this._m_v2_actualVelocity.y + pos.y, 3, stEnums_17.ST_COLOR_ID.kRed);
            debugManager.drawLine(pos.x, pos.y, this._m_v2_forceMagnitude.x + pos.x, this._m_v2_forceMagnitude.y + pos.y, 3, stEnums_17.ST_COLOR_ID.kBlue);
            debugManager.drawLine(pos.x, pos.y, this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, 3, stEnums_17.ST_COLOR_ID.kBlack);
            var target = this._m_target;
            debugManager.drawCircle(target.x + this._m_targetDir.x, target.y + this._m_targetDir.y, 5, 2, stEnums_17.ST_COLOR_ID.kYellow);
            return;
        };
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_8, stEnums_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var WanderForce = (function () {
        ...
        WanderForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_18.ST_COLOR_ID.kPurple);
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_18.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_18.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_18.ST_COLOR_ID.kBlack);
            var displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_18.ST_COLOR_ID.kRed);
            return;
        };
        ...
        WanderForce.prototype.getType = function () {
            return stEnums_18.ST_STEER_FORCE.kWander;
        };
...
define("scenes/sims/devSumano", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, baseActor_2, stEnums_19, cmpforceController_2, cmpSpriteController_2, master_9, forceFollowPath_1) {
    ...
    var ScnDevSumano = (function (_super) {
        ...
        ScnDevSumano.prototype.create = function () {
            ...
            var shipSprtP0 = this.add.sprite(0, 0, 'game_art', 'blueShip.png');
            var fleeSprt0 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            ...
            fleeActor0.init();
            pursueActor0.init();
            pursueActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 100);
            fleeActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMaxSpeed, 80);
            pursueActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            fleeActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            pursueActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.45));
            fleeActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.55));
            fleeActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 75);
            pursueActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetMass, 75);
            var forceControlP = pursueActor0.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var forceControlF = fleeActor0.getComponent(stEnums_19.ST_COMPONENT_ID.kForceController);
            var pathSprt0 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var pathSprt1 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var pathSprt2 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var pathSprt3 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var pathSprt4 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var pathSprt5 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var pathSprt6 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var pathSprt7 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            ...
            pathActor6.init();
            pathActor7.init();
            pathActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor1.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor2.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor3.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor4.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor5.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor6.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor7.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor0.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.1));
            pathActor1.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.33, height * 0.5));
            pathActor2.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.9));
            pathActor3.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            pathActor4.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.8));
            pathActor5.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.9));
            pathActor6.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.1));
            pathActor7.sendMessage(stEnums_19.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.33));
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_10, stEnums_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ArrivalForce = (function () {
        ...
        ArrivalForce.prototype.updateDebug = function (_dt) {
            ...
            var sprite = this._m_self;
            var target = this._m_target;
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_20.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_20.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(target.x, target.y, this._m_slowingRadius, 2, stEnums_20.ST_COLOR_ID.kPurple);
        ...
        ArrivalForce.prototype.getType = function () {
            return stEnums_20.ST_STEER_FORCE.kArrive;
        };
...
define("scenes/sims/devAlex", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceArrival", "steeringBehavior/forceWander"], function (require, exports, baseActor_3, stEnums_21, cmpforceController_3, cmpSpriteController_3, master_11, forceArrival_1, forceWander_1) {
    ...
    var ScnDevAlex = (function (_super) {
        ...
        ScnDevAlex.prototype.create = function () {
            ...
            var master = this._m_master;
            master.onSimulationSceneCreate(this);
            var simManager = master.getManager(stEnums_21.ST_MANAGER_ID.kSimManager);
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            shipActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            shipActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetMass, 1);
            this._m_target_center = new Phaser.Math.Vector2(width * 0.5, height * 0.25);
            this._m_target_position = new Phaser.Math.Vector2();
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            targetActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetMass, 1);
            targetActor.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            ...
            var shipControl = shipActor.getComponent(stEnums_21.ST_COMPONENT_ID.kForceController);
            var targetControl = targetActor.getComponent(stEnums_21.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneArrival", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiButton", "master/master", "steeringBehavior/forceArrival"], function (require, exports, baseActor_4, stEnums_22, cmpforceController_4, cmpSpriteController_4, uiButton_2, master_12, forceArrival_2) {
    ...
    var ScnArrival = (function (_super) {
        ...
        ScnArrival.prototype.create = function () {
            ...
            var width = canvas.width;
            var height = canvas.height;
            var mainMenuButton = uiButton_2.UIButton.CreateThemeButton(width * 0.1, height * 0.9, this, 'Main menu');
            ...
            shipActor.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            ...
            targetActor.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetMass, 1);
...
define("scenes/sims/sceneWander", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiButton", "master/master", "steeringBehavior/forceWander"], function (require, exports, baseActor_5, stEnums_23, cmpforceController_5, cmpSpriteController_5, uiButton_3, master_13, forceWander_2) {
    ...
    var ScnWander = (function (_super) {
        ...
        ScnWander.prototype.create = function () {
            ...
            var master = this._m_master;
            master.onSimulationSceneCreate(this);
            var simManager = master.getManager(stEnums_23.ST_MANAGER_ID.kSimManager);
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            ...
            shipActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            shipActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetMass, 1);
            shipActor.sendMessage(stEnums_23.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            var wander = new forceWander_2.WanderForce();
            wander.init(shipSprite, 75, 25, 5, 45, 100);
            var shipController = shipActor.getComponent(stEnums_23.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiButton", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, baseActor_6, stEnums_25, cmpforceController_6, cmpSpriteController_6, uiButton_4, master_15, forceObstacleAvoidance_1, forceWander_3) {
    ...
    var ScnObstacleAvoidance = (function (_super) {
        ...
        ScnObstacleAvoidance.prototype.create = function () {
            ...
            var master = this._m_master;
            master.onSimulationSceneCreate(this);
            var simManager = master.getManager(stEnums_25.ST_MANAGER_ID.kSimManager);
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            ...
            shipActor.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            shipActor.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            shipActor.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            var obstacleSprite0 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var obstacleSprite1 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var obstacleSprite2 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var obstacleSprite3 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var obstacleSprite4 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var obstacleSprite5 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var obstacleSprite6 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            var obstacleSprite7 = this.add.sprite(0, 0, 'game_art', 'redShip.png');
            ...
            obstacleActor0.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            obstacleActor1.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            obstacleActor2.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            obstacleActor3.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            obstacleActor4.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            obstacleActor5.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            obstacleActor6.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            obstacleActor7.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            obstacleActor0.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor1.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor2.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor3.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor4.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor5.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor6.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor7.sendMessage(stEnums_25.ST_MESSAGE_ID.kSetMass, 1);
            ...
            var shipController = shipActor.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
            var obstacle0Controller = obstacleActor0.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
            var obstacle1Controller = obstacleActor1.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
            var obstacle2Controller = obstacleActor2.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
            var obstacle3Controller = obstacleActor3.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
            var obstacle4Controller = obstacleActor4.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
            var obstacle5Controller = obstacleActor5.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
            var obstacle6Controller = obstacleActor6.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
            var obstacle7Controller = obstacleActor7.getComponent(stEnums_25.ST_COMPONENT_ID.kForceController);
