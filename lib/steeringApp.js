...
define("managers/uiManager/uiImage", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiLabel", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiText", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("managers/uiManager/uiControllers/UIDialogBox", ["require", "exports", "managers/uiManager/uiBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiText", "managers/uiManager/uiControllers/UIController"], function (require, exports, uiBox_1, uiImage_1, uiLabel_1, uiText_1, UIController_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UIDialogBox = void 0;
    var UIDialogBox = (function (_super) {
        __extends(UIDialogBox, _super);
        function UIDialogBox(_x, _y, _scene, _title, _message, _imageTexture, _imageFrame) {
            var _this = _super.call(this) || this;
            ...
            box.add(title);
            var image = new uiImage_1.UIImage(0, 0, _scene, _imageTexture, _imageFrame);
            _this._m_image = image;
            box.add(image);
        ...
        UIDialogBox.prototype.setMessage = function (_msg) {
            this._m_message.setText(_msg);
            this._m_box.updateBox();
            return;
        };
        UIDialogBox.prototype.setImage = function (_texture, _frame) {
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "managers/uiManager/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, uiBox_2, uiLabel_2, uiSlider_1, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var UIForceSeek = (function (_super) {
        ...
        function UIForceSeek(_scene, _force) {
            ...
            _this._m_box = box;
            _this._m_title = uiLabel_2.UILabel.CreateH2(0, 0, _scene, "Seek Force");
            box.add(_this._m_title);
            _this._m_force = uiLabel_2.UILabel.CreateStyleB(0, 0, _scene, "#");
            box.add(_this._m_force);
            _this._m_maxMagnitude = uiLabel_2.UILabel.CreateStyleB(0, 0, _scene, "#");
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceFactory"], function (require, exports, stEnums_9, uiBox_3, uiLabel_3, uiSlider_2, UIController_2, UIForceFactory_1) {
    ...
    var UIForceController = (function (_super) {
        ...
        function UIForceController(_x, _y, _scene, _target) {
            ...
            _this._ui_box = box;
            _this._ui_actorName = uiLabel_3.UILabel.CreateH2(0, 0, _scene, "#");
            box.add(_this._ui_actorName);
            _this._ui_actualSpeed = uiLabel_3.UILabel.CreateStyleB(0, 0, _scene, "#");
            box.add(_this._ui_actualSpeed);
            _this._ui_maxSpeed = uiLabel_3.UILabel.CreateStyleB(0, 0, _scene, "#");
            ...
            _this._ui_mass = uiLabel_3.UILabel.CreateStyleB(0, 0, _scene, "#");
...
define("scenes/sims/devMax", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiControllers/UIDialogBox", "managers/uiManager/uiControllers/UIForceController", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_1, stEnums_10, cmpforceController_1, cmpSpriteController_1, UIDialogBox_1, UIForceController_1, master_4, forceSeek_1) {
    ...
    var ScnDevMax = (function (_super) {
        ...
        ScnDevMax.prototype.create = function () {
            ...
            var uiMessageBox = new UIDialogBox_1.UIDialogBox(400, 200, this, "Hello World", "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.", "game_art", "img_spaceShip.png");
