...
define("components/cmpShipPropulsor", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_6, master_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpShipPropulsor {
        ...
        update(_actor) {
            const forceController = _actor.getComponent(stEnums_6.ST_COMPONENT_ID.kForceController);
        ...
        getID() {
            return stEnums_6.ST_COMPONENT_ID.kShipPropulsor;
        }
        destroy() {
...
define("components/cmpSpriteController", ["require", "exports", "commons/stEnums"], function (require, exports, stEnums_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CmpSpriteController {
        ...
        receive(_id, _obj) {
            switch (_id) {
                case stEnums_7.ST_MESSAGE_ID.kMove:
                    {
                        let v2 = _obj;
                        this.move(v2.x, v2.y);
                    }
                    return;
                case stEnums_7.ST_MESSAGE_ID.kSetPosition:
                    {
                        let v2 = _obj;
                        this.setPosition(v2.x, v2.y);
                    }
                    return;
                case stEnums_7.ST_MESSAGE_ID.kSetScale:
                    {
                        let v2 = _obj;
                        this.setScale(v2.x, v2.y);
                    }
                    return;
                case stEnums_7.ST_MESSAGE_ID.kSetAngle:
        ...
        getID() {
            return stEnums_7.ST_COMPONENT_ID.kSpriteController;
        }
        destroy() {
...
define("factories/shipFactory", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpShipPropulsor", "components/cmpSpriteController"], function (require, exports, baseActor_1, stEnums_8, cmpforceController_1, cmpShipPropulsor_1, cmpSpriteController_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ShipFactory {
        static CreateBlueShip(_scene, _UniqueName) {
            ...
            shipActor.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetMaxSpeed, 500);
            shipActor.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            let canvas = _scene.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            shipActor.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            shipActor.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetMass, 1);
            return shipActor;
        }
...
define("managers/uiManager/uiButton", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabel", "managers/uiManager/uiObject"], function (require, exports, stEnums_9, uiLabel_2, uiObject_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIButton extends uiObject_3.UIObject {
        constructor(_x, _y, _scene, _frame, _label, _buttonTint, _labelTint, _labelSize) {
            ...
            this._m_buttonTint = stEnums_9.ST_COLOR_ID.kWhite;
            if (_buttonTint !== undefined) {
                this._m_buttonTint = _buttonTint;
            }
            button.setTint(this._m_buttonTint);
            button.setInteractive();
            const label = uiLabel_2.UILabel.CreateStyleB(_x, _y, _scene, _label, _labelSize);
            let labeltint = stEnums_9.ST_COLOR_ID.kWhite;
...
define("managers/uiManager/uiComboBox", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabelBox", "managers/uiManager/uiObject"], function (require, exports, stEnums_10, uiLabelBox_1, uiObject_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("steeringBehavior/forceSeek", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_11, master_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SeekForce {
        ...
        updateDebug(_dt) {
            let self = this._m_self;
            let desireVelocity = this._m_desireVelocity;
            this._m_debugManager.drawLine(self.x, self.y, self.x + desireVelocity.x, self.y + desireVelocity.y, 1, stEnums_11.ST_COLOR_ID.kBlack);
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_12, uiBox_2, uiLabel_3, uiSlider_1, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceSeek extends UIForce_1.UIForce {
        constructor(_scene, _force) {
            ...
            this._m_title = title;
            box.add(title);
            this._m_force = uiLabel_3.UILabel.CreateStyleB(0, 0, _scene, "#");
        ...
        setTarget(_force) {
            this._m_seek = _force;
            if (_force !== undefined) {
                if (_force.getType() !== stEnums_12.ST_STEER_FORCE.kSeek) {
...
define("managers/uiManager/uiControllers/UIForceFactory", ["require", "exports", "commons/stEnums", "managers/uiManager/uiControllers/UIForceSeek"], function (require, exports, stEnums_13, UIForceSeek_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceFactory {
        constructor() {
            ...
            aFactories.set(stEnums_13.ST_STEER_FORCE.kSeek, this.createUIForceSeek);
            return;
        }
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceSeek"], function (require, exports, stEnums_14, uiBox_3, uiComboBox_1, uiImage_1, uiLabel_4, uiSlider_2, uiSpeedometer_1, UIController_2, UIForceSeek_2) {
    ...
    class UIForceController extends UIController_2.UIController {
        constructor(_x, _y, _scene, _target) {
            ...
            this._addUIForce(stEnums_14.ST_STEER_FORCE.kSeek, new UIForceSeek_2.UIForceSeek(_scene, undefined));
        ...
        setTarget(_actor) {
            ...
            let aForces = forceController.getForces();
            const scene = this.m_master.getSimulationScene();
            if (aForces.size > 0) {
                const force = aForces.values().next().value;
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_15.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_15.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_15.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_16, master_5, uiBox_5, uiButtonImg_2, uiImage_2, uiLabel_5, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title, _target) {
            ...
            this._m_boxTitle.setTint(stEnums_16.ST_COLOR_ID.kGold);
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_16.ST_MANAGER_ID.kSimManager);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_16.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_16.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_16.ST_SIM_SATE.kPaused) {
...
define("scenes/sims/devMax", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpSpriteController", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_2, stEnums_17, cmpSpriteController_2, shipFactory_1, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_6, forceSeek_1) {
    ...
    class ScnDevMax extends Phaser.Scene {
        create() {
            ...
            let simManager = master.getManager(stEnums_17.ST_MANAGER_ID.kSimManager);
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let seek = new forceSeek_1.SeekForce();
            seek.init(this._m_ship.getWrappedInstance(), targetSprite, 125);
            let forceControl = this._m_ship.getComponent(stEnums_17.ST_COMPONENT_ID.kForceController);
            ...
            const uiManager = master.getManager(stEnums_17.ST_MANAGER_ID.kUIManager);
        ...
        update(_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_17.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            return;
        }
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_18, master_7, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        ...
        updateDebug(_dt) {
            ...
            let radius = this.m_radius;
            for (let i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, 3, stEnums_18.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, 3, stEnums_18.ST_COLOR_ID.kPurple);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, 3, stEnums_18.ST_COLOR_ID.kPurple);
                }
            }
            return;
        }
        ...
        getType() {
            return stEnums_18.ST_STEER_FORCE.kFollowPath;
        }
        destroy() {
            this._m_controller = null;
            this._m_debugManager = null;
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_19, master_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        ...
        updateDebug(_dt) {
            ...
            debugManager.drawLine(this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, this._m_v2_actualVelocity.x + pos.x, this._m_v2_actualVelocity.y + pos.y, 3, stEnums_19.ST_COLOR_ID.kRed);
            debugManager.drawLine(pos.x, pos.y, this._m_v2_forceMagnitude.x + pos.x, this._m_v2_forceMagnitude.y + pos.y, 3, stEnums_19.ST_COLOR_ID.kBlue);
            debugManager.drawLine(pos.x, pos.y, this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, 3, stEnums_19.ST_COLOR_ID.kBlack);
            let target = this._m_target;
            debugManager.drawCircle(target.x + this._m_targetDir.x, target.y + this._m_targetDir.y, 5, 2, stEnums_19.ST_COLOR_ID.kYellow);
            return;
        }
        onDebugEnable() {
            return;
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_9, stEnums_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        ...
        updateDebug(_dt) {
            ...
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_20.ST_COLOR_ID.kPurple);
            ...
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_20.ST_COLOR_ID.kBlack);
            let displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_20.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_20.ST_STEER_FORCE.kWander;
        }
        destroy() {
            this._m_controller = null;
...
define("scenes/sims/devSumano", ["require", "exports", "commons/stEnums", "factories/shipFactory", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_21, shipFactory_2, master_10, forceFollowPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnDevSumano extends Phaser.Scene {
        create() {
            ...
            master.onSimulationSceneCreate(this);
            let simManager = master.getManager(stEnums_21.ST_MANAGER_ID.kSimManager);
            ...
            pursueActor0.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetMaxSpeed, 100);
            fleeActor0.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetMaxSpeed, 80);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            pursueActor0.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.45));
            fleeActor0.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.55));
            let forceControlP = pursueActor0.getComponent(stEnums_21.ST_COMPONENT_ID.kForceController);
            let forceControlF = fleeActor0.getComponent(stEnums_21.ST_COMPONENT_ID.kForceController);
            ...
            pathActor0.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor1.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor2.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor3.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor4.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor5.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor6.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor7.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor0.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.1));
            pathActor1.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.33, height * 0.5));
            pathActor2.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.9));
            pathActor3.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            pathActor4.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.8));
            pathActor5.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.9));
            pathActor6.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.1));
            pathActor7.sendMessage(stEnums_21.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.33));
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_11, stEnums_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ArrivalForce {
        ...
        updateDebug(_dt) {
            ...
            debugManager.drawCircle(target.x, target.y, this._m_slowingRadius, 2, stEnums_22.ST_COLOR_ID.kPurple);
        ...
        getType() {
            return stEnums_22.ST_STEER_FORCE.kArrive;
        }
        destroy() {
            this._m_controller = null;
...
define("scenes/sims/sceneArrival", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "master/master", "steeringBehavior/forceArrival"], function (require, exports, stEnums_23, shipFactory_3, uiButton_2, master_12, forceArrival_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_24, shipFactory_4, uiButton_3, master_13, forceWander_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
