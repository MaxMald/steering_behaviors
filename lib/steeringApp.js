...
define("scenes/mainMenu", ["require", "exports"], function (require, exports) {
    ...
    class MainMenu extends Phaser.Scene {
        create() {
            ...
            this._createButton(midWidth, 75, 'Max', this._onDevMax);
            this._createButton(midWidth, 225, 'Flee', this._onSceneFlee);
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_5, stEnums_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ArrivalForce {
        ...
        updateDebug(_dt) {
            ...
            let target = this._m_target;
            debugManager.drawLine(this._m_controller.getVelocity().x + sprite.x, this._m_controller.getVelocity().y + sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_11.ST_COLOR_ID.kRed);
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2_desiredVelocity.x + sprite.x, this._m_v2_desiredVelocity.y + sprite.y, 3, stEnums_11.ST_COLOR_ID.kBlack);
            debugManager.drawCircle(target.x, target.y, this._m_slowingRadius, 2, stEnums_11.ST_COLOR_ID.kPurple);
        ...
        getType() {
            return stEnums_11.ST_STEER_FORCE.kArrive;
        }
        getMaxMagnitude() {
...
define("managers/uiManager/uiControllers/UIForceArrival", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_12, uiBox_2, uiLabel_2, uiSlider_1, UIForce_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceArrival extends UIForce_1.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_12.ST_COLOR_ID.kGold);
            box.add(title);
        ...
        setTarget(_force) {
            ...
            if (arrivalForce !== undefined) {
                if (_force.getType() !== stEnums_12.ST_STEER_FORCE.kArrive) {
...
define("managers/uiManager/uiControllers/UIForceSeek", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiControllers/UIForce"], function (require, exports, stEnums_13, uiBox_3, uiLabel_3, uiSlider_2, UIForce_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIForceSeek extends UIForce_2.UIForce {
        constructor(_scene) {
            ...
            title.setTint(stEnums_13.ST_COLOR_ID.kGold);
            this._m_title = title;
            box.add(title);
        ...
        setTarget(_force) {
            this._m_seek = _force;
            if (this._m_seek !== undefined) {
                if (_force.getType() !== stEnums_13.ST_STEER_FORCE.kSeek) {
...
define("managers/uiManager/uiControllers/UIForceController", ["require", "exports", "commons/stEnums", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiComboBox", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSpeedometer", "managers/uiManager/uiControllers/UIController", "managers/uiManager/uiControllers/UIForceArrival", "managers/uiManager/uiControllers/UIForceSeek"], function (require, exports, stEnums_14, uiBox_4, uiComboBox_1, uiImage_1, uiLabel_4, uiSlider_3, uiSpeedometer_1, UIController_2, UIForceArrival_1, UIForceSeek_1) {
    ...
    class UIForceController extends UIController_2.UIController {
        constructor(_x, _y, _scene, _target) {
            ...
            actorName.setTint(stEnums_14.ST_COLOR_ID.kGold);
            box.add(actorName);
            ...
            this._ui_actualSpeed.setTint(stEnums_14.ST_COLOR_ID.kSkyBlueNeon);
            box.add(this._ui_actualSpeed);
            this._ui_maxSpeed = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "#");
            this._ui_maxSpeed.setTint(stEnums_14.ST_COLOR_ID.kSkyBlueNeon);
            ...
            this._ui_mass.setTint(stEnums_14.ST_COLOR_ID.kSkyBlueNeon);
            ...
            box.add(steerTitle);
            box.add(new uiImage_1.UIImage(0, 0, _scene, "game_art", "separator_a.png"));
            steerTitle.setTint(stEnums_14.ST_COLOR_ID.kGold);
            const selectForce = uiLabel_4.UILabel.CreateStyleB(0, 0, _scene, "Select Steer Force");
            selectForce.setTint(stEnums_14.ST_COLOR_ID.kSkyBlueNeon);
            box.add(selectForce);
            ...
            this._addUIForce(stEnums_14.ST_STEER_FORCE.kSeek, new UIForceSeek_1.UIForceSeek(_scene));
            this._addUIForce(stEnums_14.ST_STEER_FORCE.kArrive, new UIForceArrival_1.UIForceArrival(_scene));
            this.setTarget(undefined);
            return;
        }
        update() {
...
define("managers/uiManager/uiButton", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabel", "managers/uiManager/uiObject"], function (require, exports, stEnums_15, uiLabel_5, uiObject_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIButton extends uiObject_8.UIObject {
        constructor(_x, _y, _scene, _frame, _label, _buttonTint, _labelTint, _labelSize) {
            ...
            this._m_buttonTint = stEnums_15.ST_COLOR_ID.kWhite;
            if (_buttonTint !== undefined) {
                this._m_buttonTint = _buttonTint;
            }
            button.setTint(this._m_buttonTint);
            button.setInteractive();
            const label = uiLabel_5.UILabel.CreateStyleB(_x, _y, _scene, _label, _labelSize);
            let labeltint = stEnums_15.ST_COLOR_ID.kWhite;
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_16.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_16.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_16.ST_BUTTON.kNo);
                return;
            }, messageBox);
...
define("managers/uiManager/uiControllers/UISimulationController", ["require", "exports", "commons/stEnums", "master/master", "managers/uiManager/uiBox/uiBox", "managers/uiManager/uiButtonImg", "managers/uiManager/uiImage", "managers/uiManager/uiLabel", "managers/uiManager/uiControllers/UIController"], function (require, exports, stEnums_17, master_6, uiBox_6, uiButtonImg_2, uiImage_2, uiLabel_6, UIController_3) {
    ...
    class UISimulationController extends UIController_3.UIController {
        constructor(_x, _y, _scene, _title, _target) {
            ...
            this._m_boxTitle.setTint(stEnums_17.ST_COLOR_ID.kGold);
        ...
        static CreateSimControlBox(_x, _y, _scene) {
            ...
            simControlBox._m_simulationManager
                = simControlBox.m_master.getManager(stEnums_17.ST_MANAGER_ID.kSimManager);
        ...
        _onSimulationPause() {
            if (this._m_simulationManager.getState() === stEnums_17.ST_SIM_SATE.kRunning) {
        ...
        _onSimulationPlay() {
            ...
            if (state === stEnums_17.ST_SIM_SATE.kStopped) {
                this.m_master.startSimulation();
            }
            else if (state === stEnums_17.ST_SIM_SATE.kPaused) {
...
define("scenes/sims/devMax", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpSpriteController", "factories/shipFactory", "managers/uiManager/uiControllers/UIForceController", "managers/uiManager/uiControllers/UIMessageBox", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_2, stEnums_18, cmpSpriteController_2, shipFactory_1, UIForceController_1, UIMessageBox_1, UISimulationController_1, master_7, forceSeek_1) {
    ...
    class ScnDevMax extends Phaser.Scene {
        create() {
            ...
            let simManager = master.getManager(stEnums_18.ST_MANAGER_ID.kSimManager);
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            ...
            let forceControl = this._m_ship.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            ...
            const uiManager = master.getManager(stEnums_18.ST_MANAGER_ID.kUIManager);
        ...
        update(_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            return;
        }
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "managers/debugManager/debugManager", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_19, debugManager_2, master_8, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class FollowPathForce {
        init(_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_8.Master.GetInstance().getManager(stEnums_19.ST_MANAGER_ID.kDebugManager);
        ...
        updateDebug(_dt) {
            ...
            let radius = this.m_radius;
            for (let i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, debugManager_2.DebugManager.FORCE_CIRCLE_WIDTH, stEnums_19.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_19.ST_COLOR_ID.kBlue);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, debugManager_2.DebugManager.FORCE_LINE_WIDTH, stEnums_19.ST_COLOR_ID.kBlue);
                }
            }
            return;
        }
        ...
        getType() {
            return stEnums_19.ST_STEER_FORCE.kFollowPath;
        }
        getMaxMagnitude() {
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_20, master_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PursueForce {
        ...
        updateDebug(_dt) {
            ...
            debugManager.drawLine(this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, this._m_v2_actualVelocity.x + pos.x, this._m_v2_actualVelocity.y + pos.y, 3, stEnums_20.ST_COLOR_ID.kRed);
            debugManager.drawLine(pos.x, pos.y, this._m_v2_forceMagnitude.x + pos.x, this._m_v2_forceMagnitude.y + pos.y, 3, stEnums_20.ST_COLOR_ID.kBlue);
            debugManager.drawLine(pos.x, pos.y, this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, 3, stEnums_20.ST_COLOR_ID.kBlack);
            let target = this._m_target;
            debugManager.drawCircle(target.x + this._m_targetDir.x, target.y + this._m_targetDir.y, 5, 2, stEnums_20.ST_COLOR_ID.kYellow);
            return;
        }
        onDebugEnable() {
            return;
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_10, stEnums_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class WanderForce {
        init(_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_10.Master.GetInstance().getManager(stEnums_21.ST_MANAGER_ID.kDebugManager);
            return;
        }
        setController(_controller) {
            this._m_controller = _controller;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_21.ST_COLOR_ID.kPurple);
            ...
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_21.ST_COLOR_ID.kBlack);
            let displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_21.ST_COLOR_ID.kRed);
            return;
        }
        onDebugEnable() {
            return;
        ...
        getType() {
            return stEnums_21.ST_STEER_FORCE.kWander;
        }
        getMaxMagnitude() {
            return this._m_forceMagnitude;
        }
...
define("scenes/sims/devSumano", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, stEnums_22, shipFactory_2, UISimulationController_2, master_11, forceFollowPath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnDevSumano extends Phaser.Scene {
        create() {
            ...
            pursueActor0.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetMaxSpeed, 100);
            fleeActor0.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetMaxSpeed, 80);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            pursueActor0.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.45));
            fleeActor0.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.55));
            let forceControlP = pursueActor0.getComponent(stEnums_22.ST_COMPONENT_ID.kForceController);
            let forceControlF = fleeActor0.getComponent(stEnums_22.ST_COMPONENT_ID.kForceController);
            ...
            pathActor0.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor1.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor2.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor3.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor4.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor5.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor6.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor7.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor0.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.1));
            pathActor1.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.33, height * 0.5));
            pathActor2.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.9));
            pathActor3.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            pathActor4.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.8));
            pathActor5.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.9));
            pathActor6.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.1));
            pathActor7.sendMessage(stEnums_22.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.33));
...
define("scenes/sims/sceneWander", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceWander"], function (require, exports, stEnums_24, shipFactory_4, uiButton_3, UISimulationController_4, master_13, forceWander_1) {
    ...
    class ScnWander extends Phaser.Scene {
        create() {
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_24.ST_MESSAGE_ID.kSetMaxSpeed, 50);
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_14, stEnums_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ObstacleAvoidanceForce {
        init(_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_14.Master.GetInstance().getManager(stEnums_25.ST_MANAGER_ID.kDebugManager);
        }
        setController(_controller) {
            this._m_controller = _controller;
            return;
        ...
        updateDebug(_dt) {
            let debugManager = this._m_debugManager;
            let sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, 2, stEnums_25.ST_COLOR_ID.kPurple);
        }
        onDebugEnable() {
        }
        onDebugDisable() {
        ...
        getType() {
            return stEnums_25.ST_STEER_FORCE.kObstacleAvoidance;
        }
        getMaxMagnitude() {
            return this._m_forceMagnitude;
        }
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, stEnums_26, shipFactory_5, uiButton_4, UISimulationController_5, master_15, forceObstacleAvoidance_1, forceWander_2) {
    ...
    class ScnObstacleAvoidance extends Phaser.Scene {
        create() {
            ...
            let master = this._m_master;
            master.onSimulationSceneCreate(this);
            let simManager = master.getManager(stEnums_26.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            ...
            obstacleActor0.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_26.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            let shipController = shipActor.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            let obstacle0Controller = obstacleActor0.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            let obstacle1Controller = obstacleActor1.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            let obstacle2Controller = obstacleActor2.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            let obstacle3Controller = obstacleActor3.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            let obstacle4Controller = obstacleActor4.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            let obstacle5Controller = obstacleActor5.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            let obstacle6Controller = obstacleActor6.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            let obstacle7Controller = obstacleActor7.getComponent(stEnums_26.ST_COMPONENT_ID.kForceController);
            ...
            const uiManager = master.getManager(stEnums_26.ST_MANAGER_ID.kUIManager);
            uiManager.addUIController("mediaSimUI", uiSimController);
            uiManager.setTarget(shipActor);
            this._m_master.enableDebugging();
            return;
...
define("steeringBehavior/forceFlee", ["require", "exports", "commons/stEnums", "steeringBehavior/forceSeek"], function (require, exports, stEnums_27, forceSeek_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/sceneFlee", ["require", "exports", "commons/stEnums", "factories/shipFactory", "managers/uiManager/uiButton", "managers/uiManager/uiControllers/UISimulationController", "master/master", "steeringBehavior/forceFlee"], function (require, exports, stEnums_28, shipFactory_6, uiButton_5, UISimulationController_6, master_16, forceFlee_1) {
    ...
    class ScnFlee extends Phaser.Scene {
        create() {
            ...
            let width = canvas.width;
            let height = canvas.height;
            let mainMenuButton = uiButton_5.UIButton.CreateThemeButton(width * 0.1, height * 0.9, this, 'Main menu');
            mainMenuButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                master.onSimulationSceneDestroy(this);
                this.scene.start('main_menu');
            }, this);
            let debugButton = uiButton_5.UIButton.CreateColorButton(width * 0.9, height * 0.9, this, 'Debug Gizmos big text', 0x9000ff);
            debugButton.subscribe("buttonReleased", "button", function (_sender, _args) {
                const button = _sender;
                if (master.isDebugEnable()) {
                    master.disableDebugging();
            ...
            simManager.addActor(shipActor);
            shipActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            let targetActor = shipFactory_6.ShipFactory.CreateRedShip(this, "Red Ship");
            simManager.addActor(targetActor);
            targetActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_28.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            let flee = new forceFlee_1.FleeForce();
            flee.init(shipActor.getWrappedInstance(), targetActor.getWrappedInstance(), 100);
            let shipController = shipActor.getComponent(stEnums_28.ST_COMPONENT_ID.kForceController);
...
define("game_init", ["require", "exports", "phaser3-nineslice", "scenes/preload", "scenes/boot", "scenes/mainMenu", "scenes/sims/devMax", "scenes/sims/devSumano", "scenes/sims/sceneArrival", "scenes/sims/sceneWander", "scenes/sims/sceneObstacleAvoidance", "scenes/sims/sceneFlee"], function (require, exports, phaser3_nineslice_1, preload_1, boot_1, mainMenu_1, devMax_1, devSumano_1, sceneArrival_1, sceneWander_1, sceneObstacleAvoidance_1, sceneFlee_1) {
    "use strict";
    class GameInit {
        constructor() { }
        start() {
