...
define("commons/stEnums", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ST_TEXT_TYPE = exports.ST_COLOR_ID = exports.ST_MESSAGE_ID = exports.ST_COMPONENT_ID = exports.ST_MANAGER_ID = void 0;
...
define("components/cmpforceController", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_4, master_2) {
    ...
    var CmpForceController = (function () {
        ...
        CmpForceController.prototype.update = function (_actor) {
            ...
            this._m_actor.sendMessage(stEnums_4.ST_MESSAGE_ID.kMove, actualVelocityStepped);
            direction.copy(actualVelocity);
            direction.normalize();
            this._m_actor.sendMessage(stEnums_4.ST_MESSAGE_ID.kSetAngle, direction.angle());
            if (this._m_debug) {
                this.updateDebug(dt);
            }
            return;
        ...
        CmpForceController.prototype.updateDebug = function (_dt) {
            ...
            var actualVelocity = this._m_actualVelocity;
            debugManager.drawLine(sprite.x, sprite.y, sprite.x + actualVelocity.x, sprite.y + actualVelocity.y, 3, stEnums_4.ST_COLOR_ID.kGreen);
            return;
        };
...
define("managers/uiManager/uiBox", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_1) {
    ...
    var UIBox = (function (_super) {
        ...
        function UIBox(_x, _y, _scene) {
            var _this = _super.call(this) || this;
            var aObjects = new Array();
            _this._m_aObjects = aObjects;
            var contentSize = new Phaser.Geom.Point(65, 65);
        ...
        UIBox.prototype._updateBoxSize = function () {
            ...
            var size = this._m_aObjects.length;
            if (size > 1) {
        ...
        UIBox.prototype._orderVertical = function () {
            ...
            var position = new Phaser.Geom.Point(bg.x + this._m_paddingLeft, bg.y + this._m_paddingTop);
            for (var i = 0; i < size; ++i) {
                object = aObjects[i];
                var objWidth = object.getWidth();
                var objHeight = object.getHeight();
                object.setPosition(position.x + objWidth * 0.5, position.y + objHeight * 0.5);
...
define("managers/uiManager/uiLabel", ["require", "exports", "commons/stEnums", "managers/uiManager/uiObject"], function (require, exports, stEnums_6, uiObject_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UILabel = void 0;
    var UILabel = (function (_super) {
        __extends(UILabel, _super);
        function UILabel(_x, _y, _scene, _text, _type, _tint) {
            var _this = _super.call(this) || this;
            ...
            if (_type === undefined) {
                ...
                switch (_type) {
                    case stEnums_6.ST_TEXT_TYPE.H1:
                        font_key = "supercomputer";
                        font_size = 36;
                        break;
                    case stEnums_6.ST_TEXT_TYPE.H2:
                        font_key = "odin_rounded";
                        font_size = 24;
                        break;
                    case stEnums_6.ST_TEXT_TYPE.Normal:
                        font_key = "odin_rounded";
                        font_size = 16;
                        break;
                    default:
...
define("managers/uiManager/uiSlider", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_3) {
    ...
    var UISlider = (function (_super) {
        ...
        UISlider.prototype._updateData = function () {
            var x = this._m_bg.x;
            var bar = this._m_bar;
            var barMaxHalfWidth = bar.frame.width * 0.5;
...
define("managers/uiManager/uiSwitch", ["require", "exports", "managers/uiManager/uiObject"], function (require, exports, uiObject_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("scenes/sims/devMax", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "managers/uiManager/uiBox", "managers/uiManager/uiLabel", "managers/uiManager/uiSlider", "managers/uiManager/uiSwitch", "master/master", "steeringBehavior/forceSeek"], function (require, exports, baseActor_1, stEnums_8, cmpforceController_1, cmpSpriteController_1, uiBox_1, uiLabel_1, uiSlider_1, uiSwitch_1, master_4, forceSeek_1) {
    ...
    var ScnDevMax = (function (_super) {
        ...
        ScnDevMax.prototype.create = function () {
            ...
            var simManager = master.getManager(stEnums_8.ST_MANAGER_ID.kSimManager);
            ...
            shipActor.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            ...
            var toggleButton = new uiSwitch_1.UISwitch(width * 0.5, height * 0.5, this);
            ...
            var slider = new uiSlider_1.UISlider(width * 0.5, height * 0.5, this, 10, 50);
            slider.subscribe("valueChanged", "maxScene", this._onSliderChanged, this);
            var h1 = new uiLabel_1.UILabel(width, height, this, "Text: H1", stEnums_8.ST_TEXT_TYPE.H1, stEnums_8.ST_COLOR_ID.kBlack);
            var h2 = new uiLabel_1.UILabel(width, height, this, "Text: H2", stEnums_8.ST_TEXT_TYPE.H2, stEnums_8.ST_COLOR_ID.kBlue);
            var normalText = new uiLabel_1.UILabel(width, height, this, "Text: Normal", stEnums_8.ST_TEXT_TYPE.Normal, stEnums_8.ST_COLOR_ID.kRed);
            var box = new uiBox_1.UIBox(width * 0.5, height * 0.5, this);
            box.add(slider);
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            targetActor.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            var seek = new forceSeek_1.SeekForce();
            seek.init(shipSprite, targetSprite, 125);
            var forceControl = shipActor.getComponent(stEnums_8.ST_COMPONENT_ID.kForceController);
        ...
        ScnDevMax.prototype.update = function (_time, _delta) {
            ...
            this._m_target.sendMessage(stEnums_8.ST_MESSAGE_ID.kSetPosition, this._m_target_position);
            return;
        };
...
define("steeringBehavior/forceFollowPath", ["require", "exports", "commons/stEnums", "master/master", "steeringBehavior/forceSeek"], function (require, exports, stEnums_9, master_5, forceSeek_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var FollowPathForce = (function () {
        ...
        FollowPathForce.prototype.init = function (_self, _path, _force, _radius, _controller, _targetIndex, _looping) {
            ...
            this._m_controller = _controller;
            this._m_debugManager = master_5.Master.GetInstance().getManager(stEnums_9.ST_MANAGER_ID.kDebugManager);
        ...
        FollowPathForce.prototype.updateDebug = function (_dt) {
            ...
            var radius = this.m_radius;
            for (var i = 0; i < size; ++i) {
                debugManager.drawCircle(path[i].x, path[i].y, radius, 3, stEnums_9.ST_COLOR_ID.kPurple);
                if (i < size - 1) {
                    debugManager.drawLine(path[i].x, path[i].y, path[i + 1].x, path[i + 1].y, 3, stEnums_9.ST_COLOR_ID.kPurple);
                }
                else {
                    debugManager.drawLine(path[i].x, path[i].y, path[0].x, path[0].y, 3, stEnums_9.ST_COLOR_ID.kPurple);
                }
            }
            return;
        };
...
define("steeringBehavior/forcePursue", ["require", "exports", "commons/stEnums", "master/master"], function (require, exports, stEnums_10, master_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var PursueForce = (function () {
        ...
        PursueForce.prototype.init = function (_self, _target, _force, _predictionSteps, _targetForceCtrl, _controller) {
            ...
            this._m_debugManager = master_6.Master.GetInstance().getManager(stEnums_10.ST_MANAGER_ID.kDebugManager);
            return;
        };
        ...
        PursueForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawLine(this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, this._m_v2_actualVelocity.x + pos.x, this._m_v2_actualVelocity.y + pos.y, 3, stEnums_10.ST_COLOR_ID.kRed);
            debugManager.drawLine(pos.x, pos.y, this._m_v2_forceMagnitude.x + pos.x, this._m_v2_forceMagnitude.y + pos.y, 3, stEnums_10.ST_COLOR_ID.kBlue);
            debugManager.drawLine(pos.x, pos.y, this._m_targetDir.x + pos.x, this._m_targetDir.y + pos.y, 3, stEnums_10.ST_COLOR_ID.kBlack);
            var target = this._m_target;
            debugManager.drawCircle(target.x + this._m_targetDir.x, target.y + this._m_targetDir.y, 5, 2, stEnums_10.ST_COLOR_ID.kYellow);
            return;
        };
...
define("steeringBehavior/forceWander", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_7, stEnums_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var WanderForce = (function () {
        ...
        WanderForce.prototype.init = function (_self, _targetDistance, _circleRadius, _displacementAngle, _angleChange, _force, _controller) {
            ...
            this._m_debugManager = master_7.Master.GetInstance().getManager(stEnums_11.ST_MANAGER_ID.kDebugManager);
            return;
        };
        ...
        WanderForce.prototype.updateDebug = function (_dt) {
            ...
            debugManager.drawLine(sprite.x, sprite.y, this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, 3, stEnums_11.ST_COLOR_ID.kPurple);
            ...
            debugManager.drawCircle(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_circleRadius, 2, stEnums_11.ST_COLOR_ID.kBlack);
            var displacementVector = this._m_v2_displacement;
            debugManager.drawLine(this._m_v2p_circleCenter.x, this._m_v2p_circleCenter.y, this._m_v2p_circleCenter.x + displacementVector.x, this._m_v2p_circleCenter.y + displacementVector.y, 3, stEnums_11.ST_COLOR_ID.kRed);
            return;
        };
...
define("scenes/sims/devSumano", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceFollowPath"], function (require, exports, baseActor_2, stEnums_12, cmpforceController_2, cmpSpriteController_2, master_8, forceFollowPath_1) {
    ...
    var ScnDevSumano = (function (_super) {
        ...
        ScnDevSumano.prototype.create = function () {
            ...
            fleeActor0.init();
            pursueActor0.init();
            pursueActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetMaxSpeed, 100);
            fleeActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetMaxSpeed, 80);
            pursueActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.125, 0.125));
            fleeActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            pursueActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.45));
            fleeActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.55));
            fleeActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetMass, 75);
            pursueActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetMass, 75);
            var forceControlP = pursueActor0.getComponent(stEnums_12.ST_COMPONENT_ID.kForceController);
            var forceControlF = fleeActor0.getComponent(stEnums_12.ST_COMPONENT_ID.kForceController);
            ...
            pathActor6.init();
            pathActor7.init();
            pathActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor1.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor2.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor3.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor4.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor5.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor6.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor7.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.08, 0.08));
            pathActor0.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.1));
            pathActor1.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.33, height * 0.5));
            pathActor2.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.1, height * 0.9));
            pathActor3.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.75, height * 0.5));
            pathActor4.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.8));
            pathActor5.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.9));
            pathActor6.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.9, height * 0.1));
            pathActor7.sendMessage(stEnums_12.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.33));
...
define("steeringBehavior/forceArrival", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_9, stEnums_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ArrivalForce = (function () {
        ...
        ArrivalForce.prototype.init = function (_self, _target, _slowingRadius, _force, _controller) {
            ...
            this._m_debugManager = master_9.Master.GetInstance().getManager(stEnums_13.ST_MANAGER_ID.kDebugManager);
            return;
        };
...
define("scenes/sims/devAlex", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceArrival", "steeringBehavior/forceWander"], function (require, exports, baseActor_3, stEnums_14, cmpforceController_3, cmpSpriteController_3, master_10, forceArrival_1, forceWander_1) {
    ...
    var ScnDevAlex = (function (_super) {
        ...
        ScnDevAlex.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.2, 0.2));
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            targetActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetMass, 1);
            targetActor.sendMessage(stEnums_14.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            ...
            var shipControl = shipActor.getComponent(stEnums_14.ST_COMPONENT_ID.kForceController);
            var targetControl = targetActor.getComponent(stEnums_14.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneArrival", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceArrival"], function (require, exports, baseActor_4, stEnums_15, cmpforceController_4, cmpSpriteController_4, master_11, forceArrival_2) {
    ...
    var ScnArrival = (function (_super) {
        ...
        ScnArrival.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetSpeed, 75);
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetMaxSpeed, 75);
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetMass, 1);
            var canvas = this.game.canvas;
            var width = canvas.width;
            var height = canvas.height;
            shipActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.25));
            var targetSprite = this.add.sprite(0, 0, 'space_ship');
            ...
            targetActor.init();
            targetActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            targetActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            targetActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetMass, 1);
            targetActor.sendMessage(stEnums_15.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
            var arrival = new forceArrival_2.ArrivalForce();
            arrival.init(shipSprite, targetSprite, 100, 100);
            var shipController = shipActor.getComponent(stEnums_15.ST_COMPONENT_ID.kForceController);
...
define("scenes/sims/sceneWander", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceWander"], function (require, exports, baseActor_5, stEnums_16, cmpforceController_5, cmpSpriteController_5, master_12, forceWander_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ScnWander = (function (_super) {
        ...
        ScnWander.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_16.ST_MESSAGE_ID.kSetMaxSpeed, 50);
            shipActor.sendMessage(stEnums_16.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            ...
            var shipController = shipActor.getComponent(stEnums_16.ST_COMPONENT_ID.kForceController);
...
define("steeringBehavior/forceObstacleAvoidance", ["require", "exports", "master/master", "commons/stEnums"], function (require, exports, master_13, stEnums_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ObstacleAvoidanceForce = (function () {
        ...
        ObstacleAvoidanceForce.prototype.init = function (_self, _avoidanceRadius, _obstaclesArray, _force, _controller) {
            ...
            this._m_debugManager = master_13.Master.GetInstance().getManager(stEnums_17.ST_MANAGER_ID.kDebugManager);
        };
        ...
        ObstacleAvoidanceForce.prototype.updateDebug = function (_dt) {
            var debugManager = this._m_debugManager;
            var sprite = this._m_self;
            debugManager.drawCircle(sprite.x, sprite.y, this._m_avoidanceRadius, 2, stEnums_17.ST_COLOR_ID.kPurple);
        };
...
define("scenes/sims/sceneObstacleAvoidance", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "master/master", "steeringBehavior/forceObstacleAvoidance", "steeringBehavior/forceWander"], function (require, exports, baseActor_6, stEnums_18, cmpforceController_6, cmpSpriteController_6, master_14, forceObstacleAvoidance_1, forceWander_3) {
    ...
    var ScnObstacleAvoidance = (function (_super) {
        ...
        ScnObstacleAvoidance.prototype.create = function () {
            ...
            obstacleActor6.init();
            obstacleActor7.init();
            obstacleActor0.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor1.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor2.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor3.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor4.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor5.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor6.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor7.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMaxSpeed, 25);
            obstacleActor0.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor1.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor2.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor3.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor4.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor5.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor6.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor7.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.1, 0.1));
            obstacleActor0.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor1.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor2.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor3.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor4.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor5.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor6.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor7.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetMass, 1);
            obstacleActor0.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.35));
            obstacleActor1.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.35));
            obstacleActor2.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.45));
            obstacleActor3.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.45));
            obstacleActor4.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.35, height * 0.55));
            obstacleActor5.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.60, height * 0.55));
            obstacleActor6.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.45, height * 0.65));
            obstacleActor7.sendMessage(stEnums_18.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.55, height * 0.65));
            ...
            var obstacle0Controller = obstacleActor0.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            var obstacle1Controller = obstacleActor1.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            var obstacle2Controller = obstacleActor2.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            var obstacle3Controller = obstacleActor3.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            var obstacle4Controller = obstacleActor4.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            var obstacle5Controller = obstacleActor5.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            var obstacle6Controller = obstacleActor6.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
            var obstacle7Controller = obstacleActor7.getComponent(stEnums_18.ST_COMPONENT_ID.kForceController);
