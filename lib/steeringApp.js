...
define("commons/stEnums", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ST_MANAGER_ID = exports.ST_MESSAGE_ID = exports.ST_COMPONENT_ID = void 0;
    ...
    var CmpForceController = (function () {
        ...
        CmpForceController.prototype.update = function (_actor) {
            ...
            if (force.length() > speed) {
                force.normalize();
                force.setTo(force.x * speed, force.y * speed);
            }
            var dt = 0.001;
            force.setTo(force.x * dt, force.y * dt);
...
define("steeringBehavior/forceSeek", ["require", "exports"], function (require, exports) {
    ...
    var SeekForce = (function () {
        ...
        SeekForce.prototype.update = function (_dt) {
            ...
            var mass = controller.getMass();
            steerForce.set(steerForce.x / mass, steerForce.y / mass);
            steerForce.set(v2_A.x + steerForce.x, v2_A.y + steerForce.y);
            if (steerForce.length() > forceMagnitude) {
                steerForce.normalize();
                steerForce.set(steerForce.x * forceMagnitude, steerForce.y * forceMagnitude);
            }
...
define("scenes/mainMenu", ["require", "exports", "actors/baseActor", "commons/stEnums", "components/cmpforceController", "components/cmpSpriteController", "steeringBehavior/forceSeek"], function (require, exports, baseActor_1, stEnums_3, cmpforceController_1, cmpSpriteController_1, forceSeek_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var MainMenu = (function (_super) {
        ...
        MainMenu.prototype.create = function () {
            ...
            shipActor.init();
            shipActor.sendMessage(stEnums_3.ST_MESSAGE_ID.kSetSpeed, 1000);
