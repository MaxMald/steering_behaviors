...
define("scenes/sims/sceneTutorial", ["require", "exports", "commons/stEnums", "factories/shipFactory", "factories/uiSceneFactory", "gameScene/mapScene", "master/master", "steeringBehavior/forceConstant"], function (require, exports, stEnums_45, shipFactory_9, uiSceneFactory_9, mapScene_5, master_29, forceConstant_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ScnTutorial extends Phaser.Scene {
        create() {
            ...
            ambienceMap.clear();
            ambienceMap.destroy();
            let simManager = master.getManager(stEnums_45.ST_MANAGER_ID.kSimManager);
            let canvas = this.game.canvas;
            let width = canvas.width;
            let height = canvas.height;
            const targetActor = shipFactory_9.ShipFactory.CreateBlueShip(this, "Blue Ship");
            simManager.addActor(targetActor);
            const targetFController = targetActor.getComponent(stEnums_45.ST_COMPONENT_ID.kForceController);
            const constantForce = new forceConstant_3.ForceConstant();
            constantForce.init(targetActor.getWrappedInstance(), new Phaser.Math.Vector2(0.4, 0.85), 300, true);
            targetFController.addForce("constant", constantForce);
            targetActor.sendMessage(stEnums_45.ST_MESSAGE_ID.kSetMass, 3.0);
            targetActor.sendMessage(stEnums_45.ST_MESSAGE_ID.kSetMaxSpeed, 300);
            targetActor.sendMessage(stEnums_45.ST_MESSAGE_ID.kSetScale, new Phaser.Math.Vector2(0.5, 0.5));
            targetActor.sendMessage(stEnums_45.ST_MESSAGE_ID.kSetPosition, new Phaser.Math.Vector2(width * 0.5, height * 0.5));
...
define("managers/uiManager/uiButton", ["require", "exports", "commons/stEnums", "managers/uiManager/uiLabel", "managers/uiManager/uiObject"], function (require, exports, stEnums_46, uiLabel_12, uiObject_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UIButton extends uiObject_12.UIObject {
        constructor(_x, _y, _scene, _frame, _label, _buttonTint, _labelTint, _labelSize) {
            ...
            this._m_buttonTint = stEnums_46.ST_COLOR_ID.kWhite;
            ...
            let labeltint = stEnums_46.ST_COLOR_ID.kWhite;
    ...
    class UIMessageBox extends UIDialogBox_1.UIDialogBox {
        ...
        static CreateAccept(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            accept.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_47.ST_BUTTON.kAccept);
                return;
            }, messageBox);
        ...
        static CreateYesNo(_x, _y, _scene, _title, _message, _callback, _context) {
            ...
            butYes.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_47.ST_BUTTON.kYes);
                return;
            }, messageBox);
            ...
            butNo.subscribe("buttonReleased", "DialogBox", function (_sender, _args) {
                this.close();
                this._m_fn.call(this._m_context, stEnums_47.ST_BUTTON.kNo);
                return;
            }, messageBox);
